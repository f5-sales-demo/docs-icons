---
title: Carbon 图标
description: 'Carbon 图标精选参考 — 通过 Icon 组件可使用来自 IBM 设计语言的 2,582 个企业级图标。'
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) 提供来自 IBM 企业设计语言的 2,582 个简洁轮廓图标。使用 `@f5-sales-demo/icons-carbon` 中的 `Icon` 组件，通过名称渲染任意图标。
...
图标以内联 SVG 形式渲染，使用 `currentColor` — 可自动适配明暗模式。
...
如需查看完整的 2,582 个 Carbon 图标列表，请访问 [Iconify Carbon 浏览器](https://icon-sets.iconify.design/carbon/)。

---
title: Carbon 图标
description: 'Carbon 图标精选参考——来自 IBM 设计语言的 2,582 个企业级图标，可通过 Icon 组件使用。'
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) 提供 2,582 个简洁的描边图标，源自 IBM 的企业设计语言。使用来自 `@f5xc-salesdemos/icons-carbon` 的 `Icon` 组件，通过名称渲染任意图标。

---
title: Carbon 图标
description: 'Carbon Icons 精选参考 — 2,582 个来自 IBM 设计语言的企业级图标，可通过 Icon 组件使用。'
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) 提供了 2,582 个来自 IBM 企业设计语言的简洁线框图标。使用 `@f5xc-salesdemos/icons-carbon` 中的 `Icon` 组件，通过名称即可渲染任意图标。

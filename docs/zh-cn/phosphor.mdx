...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) 提供 9,161 个图标，支持灵活的字重选项 — regular、bold、duotone、fill、light 和 thin。使用 `@f5xc-salesdemos/icons-phosphor` 中的 `Icon` 组件，通过名称渲染任意图标。

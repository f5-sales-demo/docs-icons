---
title: Lucide 图标
description: 'Lucide 图标精选参考 — 通过 Icon 组件可使用 1,600 多个现代描边图标。'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) 提供约 1,600 个现代、风格一致的描边图标。使用 `@f5xc-salesdemos/icons-lucide` 中的 `Icon` 组件，可通过名称渲染任意图标。
...
如需查看约 1,600 个 Lucide 图标的完整列表，请访问 [lucide.dev/icons](https://lucide.dev/icons/)。

...
description: 'Material Design Icons 的精选参考 — 7,638 个填充和轮廓图标，可通过 Icon 组件使用。'
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) 提供 7,638 个图标，包含填充和轮廓变体，几乎涵盖所有使用场景。使用来自 `@f5-sales-demo/icons-mdi` 的 `Icon` 组件，通过名称渲染任意图标。
...
如需查看完整的 7,638 个 Material Design Icons 列表，请访问 [Iconify MDI 浏览器](https://icon-sets.iconify.design/mdi/)。

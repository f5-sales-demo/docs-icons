...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) 提供 7,638 个图标，包含填充和轮廓变体，几乎覆盖所有使用场景。使用 `@f5xc-salesdemos/icons-mdi` 中的 `Icon` 组件，通过名称即可渲染任意图标。
...
如需查看全部 7,638 个 Material Design Icons 的完整列表，请访问 [Iconify MDI 浏览器](https://icon-sets.iconify.design/mdi/)。

...
description: 'Material Design Icons 精选参考 — 通过 Icon 组件可使用 7,638 个填充和轮廓样式图标。'
sidebar:
...
图标以内联 SVG 形式渲染，使用 `currentColor` — 能够自动适配浅色和深色模式。
...
如需查看全部 7,638 个 Material Design 图标的完整列表，请访问 [Iconify MDI 浏览器](https://icon-sets.iconify.design/mdi/)。

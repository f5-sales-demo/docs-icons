---
title: Material Design 图标
description: 'Material Design Icons 精选参考 — 通过 Icon 组件可使用 7,638 个填充和轮廓图标。'
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) 提供了 7,638 个图标，包含填充和轮廓变体，几乎涵盖所有使用场景。使用 `@f5xc-salesdemos/icons-mdi` 中的 `Icon` 组件，通过名称即可渲染任意图标。

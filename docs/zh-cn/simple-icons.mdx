---
title: Simple Icons
description: '来自 Simple Icons 项目的 3,200+ 个品牌图标，涵盖知名公司、服务和技术。'
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons 提供 3,200+ 个免费 SVG 图标，涵盖知名品牌，包括网络供应商、云服务提供商、电信公司和技术服务。所有图标使用标准的 24x24 viewBox。
...
浏览全部 3,200+ 个图标：[Simple Icons 官网](https://simpleicons.org/) | [Iconify 浏览器](https://icon-sets.iconify.design/simple-icons/)

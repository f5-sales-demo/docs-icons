...
[AWS 架构图标](https://aws.amazon.com/architecture/icons/) 提供 885 个彩色服务图标，用于记录 AWS 基础设施。使用 `@f5-sales-demo/icons-aws` 中的 `Icon` 组件，通过名称渲染任意图标。默认尺寸为 48x48，支持按图标单独覆盖尺寸。

...
[AWS 架构图标](https://aws.amazon.com/architecture/icons/) 提供了 885 个彩色服务图标，用于记录 AWS 基础设施。使用 `@f5xc-salesdemos/icons-aws` 中的 `Icon` 组件，可以按名称渲染任意图标。默认大小为 48x48，支持按图标自定义大小。

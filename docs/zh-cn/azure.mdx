...
[Azure 架构图标](https://learn.microsoft.com/en-us/azure/architecture/icons/) 提供 606 个彩色服务图标，用于记录 Azure 基础设施。使用 `@f5xc-salesdemos/icons-azure` 中的 `Icon` 组件，通过名称渲染任意图标。默认尺寸为 18x18，带渐变填充。

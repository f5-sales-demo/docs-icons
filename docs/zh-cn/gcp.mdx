---
title: GCP 架构图标
description: GCP 架构图标精选参考 — 216 个彩色服务图标，用于云基础设施图表和文档。
sidebar:
  label: GCP
  order: 16
i18n:
...
[GCP 架构图标](https://cloud.google.com/icons) 提供 216 个彩色服务图标，用于记录 Google Cloud 基础设施。使用 `@f5-sales-demo/icons-gcp` 中的 `Icon` 组件，通过名称渲染任意图标。默认尺寸为 24x24，使用内联填充。
...
如需查看完整的 216 个 GCP 架构图标列表，请访问 [Google Cloud 架构图标](https://cloud.google.com/icons) 页面。

---
title: Tabler Icons
description: 'Tabler Icons 精选参考 — 6,034 个清晰的线条图标，具有一致的描边宽度，可通过 Icon 组件使用。'
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 提供 6,034 个清晰的线条图标，具有一致的 2px 描边宽度。使用 `@f5xc-salesdemos/icons-tabler` 中的 `Icon` 组件，通过名称渲染任意图标。
...
如需查看完整的 6,034 个 Tabler Icons 列表，请访问 [Iconify Tabler 浏览器](https://icon-sets.iconify.design/tabler/)。

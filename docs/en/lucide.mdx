...
[Lucide](https://lucide.dev/) provides ~1,600 modern, consistent stroke icons. Use the `Icon` component from `@f5-sales-demo/icons-lucide` to render any icon by name.

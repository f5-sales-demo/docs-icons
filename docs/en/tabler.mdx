...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) provides 6,034 crisp line icons with a consistent 2px stroke width. Use the `Icon` component from `@f5-sales-demo/icons-tabler` to render any icon by name.

...
description: Visual reference for all 672 HashiCorp Flight icons from @f5-sales-demo/icons-hashicorp-flight.
sidebar:
...
Complete visual reference for every icon in the [`@f5-sales-demo/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5-sales-demo/icons-hashicorp-flight) package. Icons are rendered via the `Icon` component and organized by category.

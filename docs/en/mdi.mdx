...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) provides 7,638 icons with filled and outlined variants covering virtually every use case. Use the `Icon` component from `@f5-sales-demo/icons-mdi` to render any icon by name.

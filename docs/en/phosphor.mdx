...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) provides 9,161 icons with flexible weight options — regular, bold, duotone, fill, light, and thin. Use the `Icon` component from `@f5-sales-demo/icons-phosphor` to render any icon by name.

...
[GCP Architecture Icons](https://cloud.google.com/icons) provides 216 color service icons for documenting Google Cloud infrastructure. Use the `Icon` component from `@f5-sales-demo/icons-gcp` to render any icon by name. Default size is 24x24 with inline fills.

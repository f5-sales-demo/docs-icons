...
title: F5 XC
description: >-
  @f5xc-salesdemos/icons-f5xc の F5 Distributed Cloud (XC)
...
[`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc) パッケージに含まれるすべてのアイコンの完全なビジュアルリファレンスです。これらの30種のアイコンは F5 Distributed Cloud サービスを表しており、Astro コンポーネント付きの Iconify JSON として利用できます。

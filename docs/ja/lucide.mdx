---
title: Lucide アイコン
description: 'Lucide アイコンの厳選リファレンス — Icon コンポーネントで利用可能な1,600以上のモダンなストロークアイコン。'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) は約1,600のモダンで統一感のあるストロークアイコンを提供します。`@f5xc-salesdemos/icons-lucide` の `Icon` コンポーネントを使用して、名前を指定するだけで任意のアイコンをレンダリングできます。
...
約1,600の Lucide アイコンの完全な一覧は、[lucide.dev/icons](https://lucide.dev/icons/) をご覧ください。

...
[Lucide](https://lucide.dev/) は約 1,600 のモダンで統一感のあるストロークアイコンを提供します。`@f5xc-salesdemos/icons-lucide` の `Icon` コンポーネントを使用して、名前を指定するだけで任意のアイコンをレンダリングできます。
...
約 1,600 の Lucide アイコンの完全なリストは、[lucide.dev/icons](https://lucide.dev/icons/) をご覧ください。

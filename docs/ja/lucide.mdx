---
title: Lucide アイコン
description: 'Lucide アイコンの厳選リファレンス — Icon コンポーネントで利用可能な 1,600 以上のモダンなストロークアイコン。'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) は約 1,600 のモダンで統一感のあるストロークアイコンを提供しています。`@f5xc-salesdemos/icons-lucide` の `Icon` コンポーネントを使用して、名前を指定するだけで任意のアイコンをレンダリングできます。
...
約 1,600 の Lucide アイコンの完全なリストについては、[lucide.dev/icons](https://lucide.dev/icons/) をご覧ください。

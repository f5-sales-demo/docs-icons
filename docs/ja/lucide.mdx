---
title: Lucide アイコン
description: 'Lucide アイコンのキュレーションリファレンス — Icon コンポーネントから利用可能な 1,600 以上のモダンなストロークアイコン。'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) は約 1,600 種のモダンで統一感のあるストロークアイコンを提供します。`@f5xc-salesdemos/icons-lucide` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングできます。
...
約 1,600 種の Lucide アイコンの完全なリストは、[lucide.dev/icons](https://lucide.dev/icons/) をご覧ください。

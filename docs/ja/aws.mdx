...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) は、AWSインフラストラクチャのドキュメント作成に使用できる885色のサービスアイコンを提供します。`@f5xc-salesdemos/icons-aws` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。デフォルトサイズは48x48で、アイコンごとにサイズを上書きできます。

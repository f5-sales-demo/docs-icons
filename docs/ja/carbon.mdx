...
title: Carbon アイコン
description: >-
  Carbon アイコンのキュレーション済みリファレンス — IBM のデザイン言語から提供される 2,582 個のエンタープライズグレードのアイコンを
  Icon コンポーネント経由で利用できます。
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) は、IBM のエンタープライズデザイン言語から提供される 2,582 個のクリーンなアウトラインアイコンです。`@f5-sales-demo/icons-carbon` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングできます。

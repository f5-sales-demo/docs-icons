...
title: Carbon アイコン
description: >-
  Carbon アイコンのキュレーションリファレンス — IBM のデザイン言語から提供される 2,582 点のエンタープライズグレードアイコンを Icon
  コンポーネント経由で利用できます。
sidebar:
  label: Carbon
  order: 7
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) は、IBM のエンタープライズデザイン言語から提供される 2,582 点のクリーンなアウトラインアイコンです。`@f5xc-salesdemos/icons-carbon` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。
...
アイコンは `currentColor` を使用してインライン SVG としてレンダリングされます — ライトモードとダークモードに自動的に適応します。
...
2,582 点の Carbon アイコンの完全なリストは、[Iconify Carbon エクスプローラー](https://icon-sets.iconify.design/carbon/) をご覧ください。

...
title: Carbon アイコン
description: >-
  Carbon Icons の厳選リファレンス — IBM のデザイン言語から提供される 2,582 個のエンタープライズグレードのアイコンを Icon
  コンポーネント経由で利用できます。
sidebar:
  label: Carbon
  order: 7
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) は、IBM のエンタープライズデザイン言語から 2,582 個のクリーンなアウトラインアイコンを提供します。`@f5xc-salesdemos/icons-carbon` の `Icon` コンポーネントを使用して、名前を指定して任意のアイコンをレンダリングできます。
...
2,582 個の Carbon Icons の完全なリストについては、[Iconify Carbon エクスプローラー](https://icon-sets.iconify.design/carbon/)をご覧ください。

...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) は、IBMのエンタープライズデザイン言語に基づく2,582個のクリーンなアウトラインアイコンを提供します。`@f5xc-salesdemos/icons-carbon` の `Icon` コンポーネントを使用して、名前を指定して任意のアイコンをレンダリングできます。
...
アイコンは `currentColor` を使用したインラインSVGとしてレンダリングされるため、ライトモードとダークモードに自動的に適応します。
...
Carbon Iconsの全2,582アイコンの一覧は、[Iconify Carbon エクスプローラー](https://icon-sets.iconify.design/carbon/)をご覧ください。

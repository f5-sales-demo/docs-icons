...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) は、IBM のエンタープライズデザイン言語から提供される 2,582 個のクリーンなアウトラインアイコンです。`@f5xc-salesdemos/icons-carbon` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングできます。

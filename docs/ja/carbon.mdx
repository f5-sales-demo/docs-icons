...
title: Carbon アイコン
description: >-
  Carbon アイコンの厳選リファレンス — IBM のデザイン言語から提供される 2,582 個のエンタープライズグレードアイコンを Icon
  コンポーネント経由で利用できます。
sidebar:
  label: Carbon
  order: 7
...
アイコンは `currentColor` を使用したインライン SVG としてレンダリングされるため、ライトモードとダークモードに自動的に対応します。
...
2,582 個の Carbon アイコンの完全なリストについては、[Iconify Carbon エクスプローラー](https://icon-sets.iconify.design/carbon/)をご覧ください。

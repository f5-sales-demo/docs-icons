---
title: Simple Icons
description: 'Simple Icons プロジェクトによる、人気企業・サービス・テクノロジーの 3,200 以上のブランドアイコン。'
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons は、ネットワークベンダー、クラウドプロバイダー、通信会社、テクノロジーサービスなどの人気ブランド向けに、3,200 以上の無料 SVG アイコンを提供しています。すべてのアイコンは標準の 24x24 viewBox を使用しています。
...
3,200 以上のすべてのアイコンを閲覧: [Simple Icons ウェブサイト](https://simpleicons.org/) | [Iconify エクスプローラー](https://icon-sets.iconify.design/simple-icons/)

---
title: Simple Icons
description: 'Simple Icons プロジェクトによる、人気の企業、サービス、テクノロジー向けの 3,200 以上のブランドアイコン。'
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons は、ネットワークベンダー、クラウドプロバイダー、通信会社、テクノロジーサービスなど、人気ブランド向けの 3,200 以上の無料 SVG アイコンを提供しています。すべてのアイコンは標準的な 24x24 の viewBox を使用しています。
...
3,200 以上のアイコンをすべて閲覧: [Simple Icons ウェブサイト](https://simpleicons.org/) | [Iconify エクスプローラー](https://icon-sets.iconify.design/simple-icons/)

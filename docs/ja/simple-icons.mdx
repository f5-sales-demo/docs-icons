---
title: Simple Icons
description: 'Simple Icons プロジェクトによる、人気企業・サービス・テクノロジー向けの3,200以上のブランドアイコン。'
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons は、ネットワークベンダー、クラウドプロバイダー、通信会社、テクノロジーサービスなど、人気ブランド向けの3,200以上の無料SVGアイコンを提供します。すべてのアイコンは標準の24x24ビューボックスを使用しています。
...
3,200以上のアイコンをすべて閲覧する: [Simple Icons ウェブサイト](https://simpleicons.org/) | [Iconify エクスプローラー](https://icon-sets.iconify.design/simple-icons/)

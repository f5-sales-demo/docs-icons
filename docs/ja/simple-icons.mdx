...
Simple Icons は、ネットワークベンダー、クラウドプロバイダー、通信会社、テクノロジーサービスなどの人気ブランド向けに、3,200以上の無料 SVG アイコンを提供しています。すべてのアイコンは標準の 24x24 viewBox を使用しています。
...
3,200以上のすべてのアイコンを閲覧: [Simple Icons ウェブサイト](https://simpleicons.org/) | [Iconify エクスプローラー](https://icon-sets.iconify.design/simple-icons/)

...
[GCP Architecture Icons](https://cloud.google.com/icons) は、Google Cloud インフラストラクチャのドキュメント作成に使用できる 216 色のサービスアイコンを提供します。`@f5xc-salesdemos/icons-gcp` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングできます。デフォルトサイズは 24x24 で、インラインフィルを使用します。

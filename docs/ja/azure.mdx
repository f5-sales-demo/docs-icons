...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) は、Azure インフラのドキュメント作成に使用できる606種類のカラーサービスアイコンを提供します。`@f5xc-salesdemos/icons-azure` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。デフォルトサイズはグラデーション塗りつぶしで18x18です。

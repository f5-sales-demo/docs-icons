---
title: Material Design アイコン
description: 'Material Design アイコンの厳選リファレンス — Icon コンポーネントで利用可能な 7,638 個の塗りつぶしおよびアウトラインアイコン。'
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) は、ほぼすべてのユースケースをカバーする 7,638 個の塗りつぶしおよびアウトラインバリアントのアイコンを提供します。`@f5xc-salesdemos/icons-mdi` の `Icon` コンポーネントを使用して、名前を指定して任意のアイコンをレンダリングできます。
...
7,638 個の Material Design アイコンの完全なリストについては、[Iconify MDI エクスプローラー](https://icon-sets.iconify.design/mdi/)をご覧ください。

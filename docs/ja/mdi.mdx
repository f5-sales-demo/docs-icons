...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) は、ほぼあらゆるユースケースをカバーするフィルドおよびアウトラインバリアントを持つ 7,638 個のアイコンを提供します。`@f5-sales-demo/icons-mdi` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングできます。

...
description: >-
  Material Design Icons の厳選リファレンス — Icon コンポーネントで利用可能な 7,638
  個の塗りつぶしおよびアウトラインアイコン。
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) は、事実上あらゆるユースケースをカバーする塗りつぶしおよびアウトラインバリアントを含む 7,638 個のアイコンを提供します。`@f5xc-salesdemos/icons-mdi` の `Icon` コンポーネントを使用して、名前を指定して任意のアイコンをレンダリングできます。
...
7,638 個の Material Design Icons の完全なリストについては、[Iconify MDI エクスプローラー](https://icon-sets.iconify.design/mdi/)をご覧ください。

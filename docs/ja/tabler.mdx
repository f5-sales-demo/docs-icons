...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) は、一貫した 2px ストローク幅を持つ 6,034 個のシャープなラインアイコンを提供します。`@f5-sales-demo/icons-tabler` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。

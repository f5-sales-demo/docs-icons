...
title: Tabler Icons
description: >-
  Tabler Icons のキュレーションリファレンス — Icon コンポーネントを通じて利用可能な、一貫したストローク幅を持つ 6,034
  個の鮮明なラインアイコン。
sidebar:
  label: Tabler
  order: 9
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) は、一貫した 2px のストローク幅を持つ 6,034 個の鮮明なラインアイコンを提供します。`@f5xc-salesdemos/icons-tabler` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。
...
6,034 個の Tabler Icons の完全なリストは、[Iconify Tabler エクスプローラー](https://icon-sets.iconify.design/tabler/) をご覧ください。

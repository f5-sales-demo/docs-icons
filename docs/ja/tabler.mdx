...
title: Tabler Icons
description: >-
  Tabler Icons の厳選リファレンス — 一貫したストローク幅を持つ 6,034 個のシャープなラインアイコンを Icon
  コンポーネント経由で利用できます。
sidebar:
  label: Tabler
  order: 9
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) は、一貫した 2px のストローク幅を持つ 6,034 個のシャープなラインアイコンを提供します。`@f5xc-salesdemos/icons-tabler` の `Icon` コンポーネントを使用して、名前を指定して任意のアイコンをレンダリングできます。

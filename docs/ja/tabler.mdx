...
title: Tabler Icons
description: >-
  Tabler Icons の厳選リファレンス — Icon コンポーネントで利用可能な、一貫したストローク幅を持つ 6,034
  個のシャープなラインアイコン。
sidebar:
  label: Tabler
  order: 9
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) は、一貫した 2px のストローク幅を持つ 6,034 個のシャープなラインアイコンを提供します。`@f5xc-salesdemos/icons-tabler` の `Icon` コンポーネントを使用して、名前を指定するだけで任意のアイコンをレンダリングできます。
...
6,034 個すべての Tabler Icons の一覧は、[Iconify Tabler エクスプローラー](https://icon-sets.iconify.design/tabler/)をご覧ください。

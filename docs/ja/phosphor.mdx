...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) は、regular、bold、duotone、fill、light、thin の 6 種類のウェイトオプションを備えた 9,161 個のアイコンを提供します。`@f5xc-salesdemos/icons-phosphor` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。

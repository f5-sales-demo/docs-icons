...
description: >-
  Phosphor Icons のキュレーション済みリファレンス — Icon コンポーネント経由で利用可能な柔軟なウェイトバリアントを備えた 9,161
  個のアイコン。
sidebar:
  label: Phosphor
  order: 8
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) は、regular、bold、duotone、fill、light、thin の 6 種類のウェイトオプションを備えた 9,161 個のアイコンを提供します。`@f5-sales-demo/icons-phosphor` の `Icon` コンポーネントを使用して、名前でアイコンをレンダリングします。
...
9,161 個の Phosphor Icons の完全な一覧（すべてのウェイトバリアントを含む）については、[Iconify Phosphor エクスプローラー](https://icon-sets.iconify.design/ph/) をご覧ください。

---
title: ไอคอนสถาปัตยกรรม AWS
description: >-
  ข้อมูลอ้างอิงที่คัดสรรสำหรับไอคอนสถาปัตยกรรม AWS — ไอคอนบริการสี 885
  รายการสำหรับแผนภาพโครงสร้างพื้นฐานคลาวด์และเอกสาร
sidebar:
  label: AWS
  order: 14
i18n:
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) มีไอคอนบริการสี 885 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน AWS ใช้ส่วนประกอบ `Icon` จาก `@f5-sales-demo/icons-aws` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 48x48 โดยมีการกำหนดขนาดเฉพาะไอคอนได้
...
ไอคอนเหล่านี้ใช้สีของผู้จำหน่ายดั้งเดิม (ไม่ใช่ `currentColor`) โดยสีถูกฝังไว้ในมาร์กอัป SVG และคงไว้ทั้งในโหมดสว่างและโหมดมืด
...
## พื้นที่จัดเก็บข้อมูลและฐานข้อมูล
...
สำหรับรายการไอคอนสถาปัตยกรรม AWS ครบทั้ง 885 รายการ โปรดเยี่ยมชม [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/)

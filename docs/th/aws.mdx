...
description: >-
  เอกสารอ้างอิงที่คัดสรรสำหรับไอคอนสถาปัตยกรรม AWS — ไอคอนบริการสี 885
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) มีไอคอนบริการสี 885 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน AWS ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-aws` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 48x48 โดยมีการกำหนดขนาดเฉพาะต่อไอคอน
...
ไอคอนเหล่านี้ใช้สีจากผู้ให้บริการต้นฉบับ (ไม่ใช่ `currentColor`) สีถูกฝังไว้ในมาร์กอัป SVG และถูกรักษาไว้ทั้งในโหมดสว่างและโหมดมืด

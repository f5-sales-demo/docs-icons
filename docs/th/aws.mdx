...
description: >-
  เอกสารอ้างอิงสำหรับไอคอนสถาปัตยกรรม AWS — ไอคอนบริการสี 885
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) มีไอคอนบริการสี 885 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน AWS ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-aws` เพื่อแสดงผลไอคอนตามชื่อ ขนาดเริ่มต้นคือ 48x48 โดยสามารถกำหนดขนาดเฉพาะสำหรับแต่ละไอคอนได้
...
ไอคอนเหล่านี้ใช้สีดั้งเดิมจากผู้ผลิต (ไม่ใช่ `currentColor`) สีต่าง ๆ ถูกฝังอยู่ในมาร์กอัป SVG และคงอยู่ทั้งในโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอนสถาปัตยกรรม AWS ทั้งหมด 885 รายการ เยี่ยมชมได้ที่ [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/)

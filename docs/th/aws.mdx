...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) มีไอคอนบริการสี 885 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน AWS ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-aws` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 48x48 โดยมีการกำหนดขนาดเฉพาะไอคอนได้

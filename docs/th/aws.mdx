...
description: >-
  แหล่งอ้างอิงที่คัดสรรสำหรับไอคอนสถาปัตยกรรม AWS — ไอคอนบริการสี 885
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) มีไอคอนบริการสี 885 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน AWS ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-aws` เพื่อเรนเดอร์ไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 48x48 พร้อมรองรับการปรับขนาดเฉพาะต่อไอคอน
...
ไอคอนเหล่านี้ใช้สีดั้งเดิมจากผู้ผลิต (ไม่ใช่ `currentColor`) สีถูกฝังอยู่ในมาร์กอัป SVG และคงไว้ทั้งในโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอนสถาปัตยกรรม AWS ทั้งหมด 885 รายการ เยี่ยมชม [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/)

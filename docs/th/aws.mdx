...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) มีไอคอนบริการสี 885 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน AWS ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-aws` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 48x48 พร้อมรองรับการกำหนดขนาดแบบเฉพาะไอคอน
...
ไอคอนเหล่านี้ใช้สีต้นฉบับจากผู้ให้บริการ (ไม่ใช่ `currentColor`) สีถูกฝังอยู่ในมาร์กอัป SVG และคงไว้ทั้งในโหมดสว่างและโหมดมืด
...
## พื้นที่จัดเก็บข้อมูล &amp; ฐานข้อมูล
...
สำหรับรายการไอคอนสถาปัตยกรรม AWS ทั้งหมด 885 รายการ โปรดเยี่ยมชม [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/)

...
description: >-
  แหล่งอ้างอิงที่คัดสรรสำหรับ GCP Architecture Icons — ไอคอนบริการสี 216
...
[GCP Architecture Icons](https://cloud.google.com/icons) มีไอคอนบริการสี 216 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Google Cloud ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-gcp` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 24x24 พร้อมสีแบบอินไลน์
...
ไอคอนเหล่านี้ใช้สีดั้งเดิมของผู้ให้บริการ (ไม่ใช่ `currentColor`) สีถูกฝังอยู่ในมาร์กอัป SVG และคงอยู่ทั้งในโหมดสว่างและโหมดมืด

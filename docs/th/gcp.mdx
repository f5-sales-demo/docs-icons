---
title: ไอคอนสถาปัตยกรรม GCP
description: >-
  อ้างอิงที่คัดสรรสำหรับไอคอนสถาปัตยกรรม GCP — ไอคอนบริการสีจำนวน 216
...
[GCP Architecture Icons](https://cloud.google.com/icons) มีไอคอนบริการสีจำนวน 216 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Google Cloud ใช้คอมโพเนนต์ `Icon` จาก `@f5-sales-demo/icons-gcp` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 24x24 พร้อม inline fills
...
ไอคอนเหล่านี้ใช้สีของผู้ผลิตดั้งเดิม (ไม่ใช่ `currentColor`) สีถูกฝังไว้ในมาร์กอัป SVG และถูกรักษาไว้ทั้งในโหมดสว่างและโหมดมืด
...
สำหรับรายการ GCP Architecture Icons ครบทั้ง 216 รายการ โปรดเยี่ยมชมหน้า [Google Cloud Architecture Icons](https://cloud.google.com/icons)

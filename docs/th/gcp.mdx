...
description: >-
  เอกสารอ้างอิงไอคอนสถาปัตยกรรม GCP ที่คัดสรรมาแล้ว — ไอคอนบริการสี 216
...
[GCP Architecture Icons](https://cloud.google.com/icons) มีไอคอนบริการสี 216 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Google Cloud ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-gcp` เพื่อแสดงผลไอคอนใด ๆ ตามชื่อ ขนาดเริ่มต้นคือ 24x24 พร้อมการเติมสีแบบอินไลน์
...
ไอคอนเหล่านี้ใช้สีดั้งเดิมจากผู้ให้บริการ (ไม่ใช่ `currentColor`) สีถูกฝังอยู่ในมาร์กอัป SVG และจะแสดงผลเหมือนกันทั้งในโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอนสถาปัตยกรรม GCP ครบทั้ง 216 รายการ โปรดเยี่ยมชมหน้า [Google Cloud Architecture Icons](https://cloud.google.com/icons)

...
description: >-
  คู่มืออ้างอิงไอคอนสถาปัตยกรรม GCP — ไอคอนบริการสี 216
...
[GCP Architecture Icons](https://cloud.google.com/icons) มีไอคอนบริการสี 216 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Google Cloud ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-gcp` เพื่อแสดงผลไอคอนตามชื่อ ขนาดเริ่มต้นคือ 24x24 พร้อมสีแบบ inline fills
...
ไอคอนเหล่านี้ใช้สีต้นฉบับจากผู้ให้บริการ (ไม่ใช่ `currentColor`) สีถูกฝังอยู่ใน SVG markup และแสดงผลเหมือนกันทั้งในโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอนสถาปัตยกรรม GCP ครบทั้ง 216 รายการ กรุณาเยี่ยมชมหน้า [Google Cloud Architecture Icons](https://cloud.google.com/icons)

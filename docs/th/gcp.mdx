...
[GCP Architecture Icons](https://cloud.google.com/icons) มีไอคอนบริการสีจำนวน 216 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Google Cloud ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-gcp` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 24x24 พร้อม inline fills

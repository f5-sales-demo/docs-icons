...
description: >-
  ข้อมูลอ้างอิงที่คัดสรรสำหรับไอคอนสถาปัตยกรรม GCP — ไอคอนบริการสี 216
...
[GCP Architecture Icons](https://cloud.google.com/icons) มีไอคอนบริการสี 216 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Google Cloud ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-gcp` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 24x24 พร้อมการเติมแบบอินไลน์

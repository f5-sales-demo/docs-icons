...
description: >-
  เอกสารอ้างอิงที่คัดสรรสำหรับ Phosphor Icons — ไอคอน 9,161
  รายการพร้อมตัวเลือกน้ำหนักที่ยืดหยุ่น ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) มีไอคอน 9,161 รายการพร้อมตัวเลือกน้ำหนักที่หลากหลาย — regular, bold, duotone, fill, light และ thin ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-phosphor` เพื่อแสดงผลไอคอนใด ๆ ตามชื่อ
...
ไอคอนแสดงผลเป็น inline SVG โดยใช้ `currentColor` — ปรับตัวเองให้เข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ

:::note[รูปแบบน้ำหนัก]
ไอคอน Phosphor มีหกระดับน้ำหนัก น้ำหนัก regular ใช้ชื่อพื้นฐาน (เช่น `globe`) น้ำหนักอื่น ๆ ต่อท้ายด้วยคำต่อท้าย: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin` ตัวอย่างด้านล่างแสดงน้ำหนัก regular
:::
...
สำหรับรายการไอคอน Phosphor ทั้งหมด 9,161 รายการ (ครอบคลุมทุกรูปแบบน้ำหนัก) โปรดเยี่ยมชม [Iconify Phosphor explorer](https://icon-sets.iconify.design/ph/)

---
title: ไอคอน Phosphor
description: >-
  เอกสารอ้างอิงคัดสรรสำหรับ Phosphor Icons — ไอคอน 9,161
  รายการพร้อมตัวเลือกน้ำหนักเส้นที่ยืดหยุ่น ใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) ให้บริการไอคอน 9,161 รายการพร้อมตัวเลือกน้ำหนักเส้นที่ยืดหยุ่น — regular, bold, duotone, fill, light และ thin ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-phosphor` เพื่อแสดงผลไอคอนใด ๆ ตามชื่อ
...
:::note[ตัวเลือกน้ำหนักเส้น]
ไอคอน Phosphor มีน้ำหนักเส้น 6 แบบ น้ำหนัก regular จะใช้ชื่อพื้นฐาน (เช่น `globe`) น้ำหนักอื่น ๆ จะเติมคำต่อท้าย: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin` ตัวอย่างด้านล่างแสดงน้ำหนัก regular
:::
...
สำหรับรายการไอคอน Phosphor Icons ทั้งหมด 9,161 รายการ (ครอบคลุมทุกตัวเลือกน้ำหนักเส้น) เยี่ยมชม [เครื่องมือสำรวจ Phosphor บน Iconify](https://icon-sets.iconify.design/ph/)

...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) มีไอคอนจำนวน 9,161 รายการพร้อมตัวเลือกน้ำหนักที่หลากหลาย ได้แก่ regular, bold, duotone, fill, light และ thin ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-phosphor` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ

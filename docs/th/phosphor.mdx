...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) ให้ไอคอน 9,161 รายการพร้อมตัวเลือกน้ำหนักเส้นที่ยืดหยุ่น — regular, bold, duotone, fill, light และ thin ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-phosphor` เพื่อเรนเดอร์ไอคอนใด ๆ ตามชื่อ
...
ไอคอนจะเรนเดอร์เป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ปรับเข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ

:::note[ตัวเลือกน้ำหนักเส้น]
ไอคอน Phosphor มีน้ำหนักเส้น 6 แบบ น้ำหนัก regular จะใช้ชื่อพื้นฐาน (เช่น `globe`) น้ำหนักอื่น ๆ จะต่อท้ายด้วยคำต่อท้าย: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin` ตัวอย่างด้านล่างแสดงน้ำหนัก regular
:::
...
สำหรับรายการไอคอน Phosphor ทั้งหมด 9,161 รายการ (ครอบคลุมทุกตัวเลือกน้ำหนักเส้น) เยี่ยมชม [Iconify Phosphor explorer](https://icon-sets.iconify.design/ph/)

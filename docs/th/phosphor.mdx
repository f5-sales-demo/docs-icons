...
description: >-
  เอกสารอ้างอิง Phosphor Icons ที่คัดสรรแล้ว — ไอคอน 9,161 ตัว
  พร้อมตัวเลือกน้ำหนักที่ยืดหยุ่น ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) มีไอคอน 9,161 ตัว พร้อมตัวเลือกน้ำหนักที่ยืดหยุ่น — regular, bold, duotone, fill, light และ thin ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-phosphor` เพื่อเรนเดอร์ไอคอนใด ๆ ตามชื่อ
...
ไอคอนจะเรนเดอร์เป็น SVG แบบ inline โดยใช้ `currentColor` — ไอคอนจะปรับตัวตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ

:::note[ตัวเลือกน้ำหนัก]
ไอคอน Phosphor มีน้ำหนัก 6 แบบ น้ำหนัก regular ใช้ชื่อฐาน (เช่น `globe`) น้ำหนักอื่น ๆ จะต่อท้ายด้วย suffix: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin` ตัวอย่างด้านล่างแสดงน้ำหนัก regular
:::
...
สำหรับรายการไอคอน Phosphor ทั้งหมด 9,161 ตัว (ครอบคลุมทุกตัวเลือกน้ำหนัก) เยี่ยมชม [Iconify Phosphor explorer](https://icon-sets.iconify.design/ph/)

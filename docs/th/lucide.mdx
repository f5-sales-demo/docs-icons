...
title: ไอคอน Lucide
description: >-
  เอกสารอ้างอิงสำหรับไอคอน Lucide — ไอคอนแบบเส้นสมัยใหม่มากกว่า 1,600 รายการ
  ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) มีไอคอนแบบเส้นที่ทันสมัยและสอดคล้องกันประมาณ 1,600 รายการ ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-lucide` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ซึ่งจะปรับตัวตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ

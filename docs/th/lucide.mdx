...
title: ไอคอน Lucide
description: >-
  การอ้างอิงไอคอน Lucide ที่คัดสรรแล้ว — ไอคอนสโตรกสมัยใหม่กว่า 1,600
  รายการที่ใช้งานได้ผ่านส่วนประกอบ Icon
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) มีไอคอนสโตรกที่ทันสมัยและสอดคล้องกันประมาณ 1,600 รายการ ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-lucide` เพื่อแสดงไอคอนใดก็ได้โดยระบุชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ปรับให้เข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Lucide ทั้งหมดประมาณ 1,600 รายการ โปรดเยี่ยมชม [lucide.dev/icons](https://lucide.dev/icons/)

...
title: ไอคอน Lucide
description: >-
  เอกสารอ้างอิงสำหรับไอคอน Lucide — ไอคอนแบบเส้นสมัยใหม่กว่า 1,600
  รายการที่ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) มีไอคอนแบบเส้นที่ทันสมัยและสม่ำเสมอประมาณ 1,600 รายการ ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-lucide` เพื่อแสดงไอคอนใดก็ได้โดยระบุชื่อ
...
ไอคอนจะถูกแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ทำให้ปรับตัวเข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Lucide ทั้งหมดประมาณ 1,600 รายการ เยี่ยมชมได้ที่ [lucide.dev/icons](https://lucide.dev/icons/)

...
title: ไอคอน Lucide
description: >-
  เอกสารอ้างอิงสำหรับไอคอน Lucide — ไอคอนสโตรกสมัยใหม่กว่า 1,600
...
[Lucide](https://lucide.dev/) มีไอคอนสโตรกที่ทันสมัยและสม่ำเสมอประมาณ 1,600 รายการ ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-lucide` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ปรับตัวอัตโนมัติตามโหมดสว่างและโหมดมืด

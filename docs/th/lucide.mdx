...
title: ไอคอน Lucide
description: >-
  เอกสารอ้างอิงคัดสรรสำหรับไอคอน Lucide — ไอคอนแบบเส้นขีดสมัยใหม่กว่า 1,600
  รายการ พร้อมใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) มีไอคอนแบบเส้นขีดที่ทันสมัยและสม่ำเสมอประมาณ 1,600 รายการ ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-lucide` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — จึงปรับตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ

...
[Lucide](https://lucide.dev/) มีไอคอนสโตรกที่ทันสมัยและสอดคล้องกันประมาณ 1,600 รายการ ใช้ส่วนประกอบ `Icon` จาก `@f5-sales-demo/icons-lucide` เพื่อแสดงไอคอนใดก็ได้โดยระบุชื่อ

...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) มีไอคอน 7,638 รายการพร้อมตัวแปรแบบเติมและแบบโครงร่าง ครอบคลุมการใช้งานแทบทุกกรณี ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-mdi` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ

...
description: >-
  การอ้างอิงที่คัดสรรสำหรับ Material Design Icons — ไอคอนแบบ filled และ outlined
  จำนวน 7,638 รายการที่ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) มีไอคอนจำนวน 7,638 รายการพร้อมตัวแปรแบบ filled และ outlined ที่ครอบคลุมกรณีการใช้งานเกือบทุกประเภท ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-mdi` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น inline SVG โดยใช้ `currentColor` — ซึ่งจะปรับตัวโดยอัตโนมัติสำหรับโหมดสว่างและโหมดมืด
...
สำหรับรายการ Material Design Icons ครบทั้ง 7,638 รายการ โปรดเยี่ยมชม [Iconify MDI explorer](https://icon-sets.iconify.design/mdi/)

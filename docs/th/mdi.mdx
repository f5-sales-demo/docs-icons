...
description: >-
  แหล่งอ้างอิงไอคอน Material Design ที่คัดสรรแล้ว — ไอคอนแบบเติมสีและแบบเส้นขอบ
  7,638 รายการ พร้อมใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) มีไอคอนจำนวน 7,638 รายการ พร้อมรูปแบบแบบเติมสีและแบบเส้นขอบที่ครอบคลุมแทบทุกกรณีการใช้งาน ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-mdi` เพื่อแสดงผลไอคอนตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — จะปรับตัวตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Material Design ทั้งหมด 7,638 รายการ เยี่ยมชมได้ที่ [Iconify MDI explorer](https://icon-sets.iconify.design/mdi/)

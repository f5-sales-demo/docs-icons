---
title: ไอคอน Material Design
description: >-
  เอกสารอ้างอิงไอคอน Material Design ที่คัดสรรแล้ว — ไอคอนแบบทึบและแบบเส้นขอบ
  7,638 รายการที่ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) ให้บริการไอคอน 7,638 รายการพร้อมรูปแบบทึบและเส้นขอบที่ครอบคลุมแทบทุกกรณีการใช้งาน ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-mdi` เพื่อเรนเดอร์ไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะเรนเดอร์เป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ไอคอนจะปรับตัวเข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ

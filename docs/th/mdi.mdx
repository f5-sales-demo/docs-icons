...
description: >-
  ...
  ไอคอนแบบเติมและแบบโครงร่าง 7,638 รายการ ที่ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) มีไอคอน 7,638 รายการพร้อมตัวแปรแบบเติมและแบบโครงร่าง ครอบคลุมการใช้งานแทบทุกกรณี ใช้คอมโพเนนต์ `Icon` จาก `@f5-sales-demo/icons-mdi` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — จะปรับตัวโดยอัตโนมัติตามโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอน Material Design ทั้งหมด 7,638 รายการ โปรดเยี่ยมชม [Iconify MDI explorer](https://icon-sets.iconify.design/mdi/)

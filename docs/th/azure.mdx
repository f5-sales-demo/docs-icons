...
description: >-
  แหล่งอ้างอิงที่คัดสรรสำหรับไอคอนสถาปัตยกรรม Azure — ไอคอนบริการสี 606
  รายการสำหรับไดอะแกรมโครงสร้างพื้นฐานคลาวด์และเอกสารประกอบ
sidebar:
  label: Azure
  order: 15
i18n:
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) ให้บริการไอคอนบริการสี 606 รายการสำหรับการจัดทำเอกสารโครงสร้างพื้นฐาน Azure ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-azure` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ ขนาดเริ่มต้นคือ 18x18 พร้อมการเติมแบบไล่ระดับ
...
ไอคอนเหล่านี้ใช้สีดั้งเดิมจากผู้ผลิต (ไม่ใช่ `currentColor`) สีจะถูกฝังไว้ในมาร์กอัป SVG และคงอยู่ทั้งในโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอนสถาปัตยกรรม Azure ครบทั้ง 606 รายการ เยี่ยมชมหน้า [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/)

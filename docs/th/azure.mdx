...
description: >-
  คู่มืออ้างอิงไอคอนสถาปัตยกรรม Azure ที่คัดสรรมาแล้ว — ไอคอนบริการสี 606
  รายการสำหรับแผนภาพโครงสร้างพื้นฐานคลาวด์และเอกสารประกอบ
sidebar:
  label: Azure
  order: 15
i18n:
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) มีไอคอนบริการสี 606 รายการสำหรับจัดทำเอกสารโครงสร้างพื้นฐาน Azure ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-azure` เพื่อเรนเดอร์ไอคอนตามชื่อ ขนาดเริ่มต้นคือ 18x18 พร้อมการเติมสีแบบไล่ระดับ
...
ไอคอนเหล่านี้ใช้สีดั้งเดิมของผู้ผลิต (ไม่ใช่ `currentColor`) สีถูกฝังอยู่ในมาร์กอัป SVG และคงไว้ทั้งในโหมดสว่างและโหมดมืด

...
Starlight มีไอคอนในตัวมากกว่า 200 รายการที่ใช้งานได้ผ่านคอมโพเนนต์ `<Icon>` — ไม่ต้องติดตั้งเพิ่มเติม ปลั๊กอิน `starlight-plugin-icons` ได้รับการกำหนดค่าไว้แล้วในธีม ดังนั้นไอคอนเหล่านี้จะทำงานได้ในทุก content repo
...
| `label` | `string` | — | ป้ายกำกับสำหรับการเข้าถึงโดยโปรแกรมอ่านหน้าจอ ใช้สำหรับไอคอนที่สื่อความหมาย ละไว้สำหรับไอคอนที่เป็นการตกแต่ง |
...
:::tip[การเข้าถึง]
เพิ่ม prop `label` เมื่อไอคอนสื่อความหมาย (เช่น ไอคอนลิงก์) ละ `label` ไว้สำหรับไอคอนที่เป็นการตกแต่งล้วนๆ — Starlight จะซ่อนไอคอนเหล่านั้นจากเทคโนโลยีช่วยเหลือโดยอัตโนมัติ
:::
...
ไอคอน Seti ใช้คำนำหน้า `seti:` และถูกออกแบบมาเพื่อแสดงประเภทไฟล์ สามารถใช้ได้ทั้งในคอมโพเนนต์ `<Icon>` และคอมโพเนนต์ `<FileTree>`

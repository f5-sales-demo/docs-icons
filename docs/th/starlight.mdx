...
description: >-
  รายการอ้างอิงฉบับสมบูรณ์สำหรับไอคอนในตัวของ Starlight กว่า 200
...
Starlight มีไอคอนในตัวกว่า 200 รายการที่ใช้งานได้ผ่านคอมโพเนนต์ `<Icon>` — ไม่จำเป็นต้องติดตั้งเพิ่มเติม ปลั๊กอิน `starlight-plugin-icons` ได้รับการกำหนดค่าไว้ในธีมแล้ว ดังนั้นไอคอนเหล่านี้จึงใช้งานได้ในทุก content repo

## การใช้งานคอมโพเนนต์ Icon
...
| `label` | `string` | — | ป้ายกำกับสำหรับการเข้าถึงโดยโปรแกรมอ่านหน้าจอ ใช้สำหรับไอคอนที่สื่อความหมาย; ละไว้สำหรับไอคอนตกแต่ง |
...
:::tip[การเข้าถึง]
เพิ่ม prop `label` เมื่อไอคอนสื่อความหมาย (เช่น ไอคอนลิงก์) ละ `label` ไว้สำหรับไอคอนตกแต่งเท่านั้น — Starlight จะซ่อนไอคอนเหล่านั้นจากเทคโนโลยีช่วยเหลือโดยอัตโนมัติ
:::
...
ไอคอน Seti ใช้คำนำหน้า `seti:` และออกแบบมาเพื่อแสดงประเภทไฟล์ ไอคอนเหล่านี้ใช้งานได้ในคอมโพเนนต์ `<Icon>` และคอมโพเนนต์ `<FileTree>`

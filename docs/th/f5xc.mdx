...
title: F5 XC
description: >-
  เอกสารอ้างอิงภาพสำหรับไอคอนบริการ F5 Distributed Cloud (XC) ทั้ง 30 รายการจาก
...
เอกสารอ้างอิงภาพครบถ้วนสำหรับทุกไอคอนในแพ็คเกจ [`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc) ไอคอนทั้ง 30 รายการนี้แสดงถึงบริการ F5 Distributed Cloud และพร้อมใช้งานในรูปแบบ Iconify JSON พร้อมคอมโพเนนต์ Astro
...
:::note[โหมดมืด]
ไอคอนหลายสีเหล่านี้ใช้ CSS custom properties (`--color-N600`, `--color-brand`, `--color-blue-light`, `--color-N200`) ที่ปรับตัวอัตโนมัติตามโหมดสว่างและโหมดมืด สีกรมท่าและสีฟ้าอ่อนจะสลับกันในโหมดมืด ขณะที่สีแดงเน้นของ F5 จะคงที่ตลอด
:::

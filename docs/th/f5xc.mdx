...
ข้อมูลอ้างอิงภาพทั้งหมดสำหรับทุกไอคอนในแพ็กเกจ [`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc) ไอคอนทั้ง 30 รายการนี้แสดงถึงบริการ F5 Distributed Cloud และพร้อมใช้งานในรูปแบบ Iconify JSON พร้อมคอมโพเนนต์ Astro
...
:::note[โหมดมืด]
ไอคอนหลายสีเหล่านี้ใช้ CSS custom properties (`--color-N600`, `--color-brand`, `--color-blue-light`, `--color-N200`) ที่ปรับเปลี่ยนตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ สีน้ำเงินเข้มและสีฟ้าอ่อนจะสลับกันในโหมดมืด ในขณะที่สีแดงเน้นของ F5 จะคงที่ตลอด
:::

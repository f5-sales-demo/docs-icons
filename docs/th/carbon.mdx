...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) มอบไอคอนสไตล์เส้นโครงร่างที่สะอาดตาจำนวน 2,582 รายการจากภาษาการออกแบบระดับองค์กรของ IBM ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-carbon` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ

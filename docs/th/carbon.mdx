...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) มอบไอคอนแบบเส้นขอบที่สะอาดตา 2,582 รายการจากภาษาการออกแบบระดับองค์กรของ IBM ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-carbon` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — จึงปรับตัวตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการ Carbon Icons ทั้งหมด 2,582 รายการ เยี่ยมชม [Iconify Carbon explorer](https://icon-sets.iconify.design/carbon/)

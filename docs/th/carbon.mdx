...
title: Carbon Icons
description: >-
  เอกสารอ้างอิงที่คัดสรรสำหรับ Carbon Icons — ไอคอนระดับองค์กร 2,582
  รายการจากภาษาการออกแบบของ IBM ที่ใช้งานได้ผ่านส่วนประกอบ Icon
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) มอบไอคอนสไตล์เส้นโครงร่างที่สะอาดตาจำนวน 2,582 รายการจากภาษาการออกแบบระดับองค์กรของ IBM ใช้ส่วนประกอบ `Icon` จาก `@f5-sales-demo/icons-carbon` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ
...
ไอคอนแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ปรับตัวเองโดยอัตโนมัติสำหรับโหมดสว่างและโหมดมืด
...
สำหรับรายการ Carbon Icons ครบทั้ง 2,582 รายการ โปรดเยี่ยมชม [Iconify Carbon explorer](https://icon-sets.iconify.design/carbon/)

...
title: ไอคอน Carbon
description: >-
  แหล่งอ้างอิงไอคอน Carbon ที่คัดสรรแล้ว — ไอคอนระดับองค์กร 2,582
  รายการจากภาษาออกแบบของ IBM ที่สามารถใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) มีไอคอนแบบเส้นขอบที่สะอาดตา 2,582 รายการจากภาษาออกแบบระดับองค์กรของ IBM ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-carbon` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ซึ่งจะปรับตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Carbon ทั้งหมด 2,582 รายการ โปรดเยี่ยมชม [Iconify Carbon explorer](https://icon-sets.iconify.design/carbon/)

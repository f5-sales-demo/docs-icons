...
description: >-
  ...
  รายการจากภาษาออกแบบของ IBM ที่พร้อมใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) ให้บริการไอคอนแบบเส้นขอบที่สะอาดตา 2,582 รายการจากภาษาออกแบบระดับองค์กรของ IBM ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-carbon` เพื่อแสดงผลไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ซึ่งจะปรับตัวให้เข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Carbon ทั้งหมด 2,582 รายการ เยี่ยมชม [Iconify Carbon explorer](https://icon-sets.iconify.design/carbon/)

...
description: >-
  ...
  รายการจากภาษาการออกแบบของ IBM ที่พร้อมใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) ให้บริการไอคอนแบบเส้นรูปทรงที่สะอาดตา 2,582 รายการจากภาษาการออกแบบระดับองค์กรของ IBM ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-carbon` เพื่อแสดงผลไอคอนตามชื่อที่ต้องการ
...
ไอคอนแสดงผลเป็น SVG แบบ inline โดยใช้ `currentColor` — ปรับตัวได้อัตโนมัติทั้งในโหมดสว่างและโหมดมืด

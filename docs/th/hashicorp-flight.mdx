---
title: ไอคอน HashiCorp Flight
description: >-
  เอกสารอ้างอิงภาพสำหรับไอคอน HashiCorp Flight ทั้ง 672 รายการจาก
...
เอกสารอ้างอิงภาพครบถ้วนสำหรับไอคอนทุกรายการในแพ็คเกจ [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight) ไอคอนจะถูกเรนเดอร์ผ่านคอมโพเนนต์ `Icon` และจัดเรียงตามหมวดหมู่
...
ไอคอนจะเรนเดอร์เป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ไอคอนแบบสีเดียวจะปรับตัวตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ ไอคอนแบบมีสีจะคงสีดั้งเดิมไว้

:::note[โหมดมืด]
ไอคอนแบบสีเดียวใช้ `currentColor` และปรับตัวโดยอัตโนมัติ ไอคอนแบบมีสี (ไอคอนที่ลงท้ายด้วย `-color`) จะคงสีดั้งเดิมไว้ผ่านคลาส `no-invert`
:::

...
description: >-
  อ้างอิงภาพสำหรับไอคอน HashiCorp Flight ทั้งหมด 672 รายการจาก
...
อ้างอิงภาพสำหรับทุกไอคอนในแพ็กเกจ [`@f5-sales-demo/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5-sales-demo/icons-hashicorp-flight) ไอคอนแสดงผลผ่านคอมโพเนนต์ `Icon` และจัดเรียงตามหมวดหมู่
...
ไอคอนแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ไอคอนโมโนโครมจะปรับตัวอัตโนมัติตามโหมดสว่างและมืด ส่วนไอคอนแบบสีจะคงสีต้นฉบับไว้

:::note[โหมดมืด]
ไอคอนโมโนโครมใช้ `currentColor` และปรับตัวโดยอัตโนมัติ ส่วนไอคอนแบบสี (ไอคอนที่ลงท้ายด้วย `-color`) จะคงสีต้นฉบับไว้ผ่านคลาส `no-invert`
:::

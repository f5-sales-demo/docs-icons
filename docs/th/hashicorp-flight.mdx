...
description: >-
  แหล่งอ้างอิงภาพสำหรับไอคอน HashiCorp Flight ทั้งหมด 672 รายการจาก
...
แหล่งอ้างอิงภาพครบถ้วนสำหรับทุกไอคอนในแพ็คเกจ [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight) ไอคอนถูกเรนเดอร์ผ่านคอมโพเนนต์ `Icon` และจัดเรียงตามหมวดหมู่
...
ไอคอนเรนเดอร์เป็น SVG แบบ inline โดยใช้ `currentColor` — ไอคอนแบบสีเดียวจะปรับตัวอัตโนมัติตามโหมดสว่างและโหมดมืด ไอคอนแบบสีจะรักษาสีดั้งเดิมไว้

:::note[โหมดมืด]
ไอคอนแบบสีเดียวใช้ `currentColor` และปรับตัวอัตโนมัติ ไอคอนแบบสี (ไอคอนที่ลงท้ายด้วย `-color`) จะรักษาสีดั้งเดิมไว้ผ่านคลาส `no-invert`
:::

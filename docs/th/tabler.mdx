...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) มีไอคอนเส้นคมชัดจำนวน 6,034 รายการที่มีความกว้างของเส้น 2px สม่ำเสมอ ใช้ส่วนประกอบ `Icon` จาก `@f5xc-salesdemos/icons-tabler` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ

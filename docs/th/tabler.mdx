...
title: Tabler Icons
description: >-
  เอกสารอ้างอิงที่คัดสรรสำหรับ Tabler Icons — ไอคอนเส้นคมชัด 6,034 รายการ
  พร้อมความหนาของเส้นที่สม่ำเสมอ ใช้งานผ่าน Icon component
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) มีไอคอนเส้นคมชัด 6,034 รายการ พร้อมความหนาของเส้น 2px ที่สม่ำเสมอ ใช้ `Icon` component จาก `@f5xc-salesdemos/icons-tabler` เพื่อแสดงผลไอคอนใดๆ ตามชื่อ
...
ไอคอนจะแสดงผลเป็น inline SVG โดยใช้ `currentColor` — ทำให้ปรับตัวตามโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Tabler ทั้งหมด 6,034 รายการ เยี่ยมชมได้ที่ [Iconify Tabler explorer](https://icon-sets.iconify.design/tabler/)

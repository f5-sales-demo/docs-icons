...
title: ไอคอน Tabler
description: >-
  เอกสารอ้างอิงไอคอน Tabler ที่คัดสรรมาแล้ว — ไอคอนเส้นคมชัด 6,034
  รายการพร้อมความหนาเส้นขีดสม่ำเสมอ ใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) มีไอคอนเส้นคมชัด 6,034 รายการพร้อมความหนาเส้นขีดสม่ำเสมอ 2px ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-tabler` เพื่อแสดงผลไอคอนตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ไอคอนจะปรับเข้ากับโหมดสว่างและโหมดมืดโดยอัตโนมัติ
...
สำหรับรายการไอคอน Tabler ทั้งหมด 6,034 รายการ เยี่ยมชม [Iconify Tabler explorer](https://icon-sets.iconify.design/tabler/)

...
title: ไอคอน Tabler
description: >-
  เอกสารอ้างอิงคัดสรรสำหรับ Tabler Icons — ไอคอนเส้นคมชัด 6,034
  รายการพร้อมความหนาเส้นสม่ำเสมอ ใช้งานผ่านคอมโพเนนต์ Icon
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) มีไอคอนเส้นคมชัด 6,034 รายการพร้อมความหนาเส้นสม่ำเสมอที่ 2px ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-tabler` เพื่อแสดงผลไอคอนตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ปรับตัวอัตโนมัติสำหรับโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอน Tabler ครบทั้ง 6,034 รายการ เยี่ยมชม [ตัวสำรวจ Tabler บน Iconify](https://icon-sets.iconify.design/tabler/)

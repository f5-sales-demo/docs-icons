...
title: Tabler Icons
description: >-
  เอกสารอ้างอิงสำหรับ Tabler Icons — ไอคอนเส้นคมชัด 6,034
  รายการที่มีความกว้างของเส้นสม่ำเสมอ พร้อมใช้งานผ่านส่วนประกอบ Icon
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) มีไอคอนเส้นคมชัดจำนวน 6,034 รายการที่มีความกว้างของเส้น 2px สม่ำเสมอ ใช้ส่วนประกอบ `Icon` จาก `@f5-sales-demo/icons-tabler` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น SVG แบบอินไลน์โดยใช้ `currentColor` — ปรับตัวได้โดยอัตโนมัติสำหรับโหมดสว่างและโหมดมืด
...
สำหรับรายการ Tabler Icons ทั้งหมดจำนวน 6,034 รายการ ให้เยี่ยมชม [Iconify Tabler explorer](https://icon-sets.iconify.design/tabler/)

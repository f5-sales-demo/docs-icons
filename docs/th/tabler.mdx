...
title: Tabler Icons
description: >-
  เอกสารอ้างอิงที่คัดสรรสำหรับ Tabler Icons — ไอคอนเส้นคมชัด 6,034
  รายการที่มีความกว้างของเส้นสม่ำเสมอ ใช้งานได้ผ่านคอมโพเนนต์ Icon
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) มีไอคอนเส้นคมชัด 6,034 รายการที่มีความกว้างของเส้นสม่ำเสมอที่ 2px ใช้คอมโพเนนต์ `Icon` จาก `@f5xc-salesdemos/icons-tabler` เพื่อแสดงไอคอนใดก็ได้ตามชื่อ
...
ไอคอนจะแสดงผลเป็น inline SVG โดยใช้ `currentColor` — ซึ่งปรับตัวโดยอัตโนมัติตามโหมดสว่างและโหมดมืด
...
สำหรับรายการไอคอน Tabler ทั้งหมด 6,034 รายการ โปรดเยี่ยมชม [Iconify Tabler explorer](https://icon-sets.iconify.design/tabler/)

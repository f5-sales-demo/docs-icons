---
title: HashiCorp Flight Icone
description: >-
  Riferimento visivo per tutte le 672 icone HashiCorp Flight di
...
import Icon from '@f5-sales-demo/icons-hashicorp-flight/Icon.astro';

Riferimento visivo completo per ogni icona nel pacchetto [`@f5-sales-demo/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5-sales-demo/icons-hashicorp-flight). Le icone vengono visualizzate come SVG inline tramite il componente `Icon` e sono organizzate per categoria.
...
Le icone vengono visualizzate come SVG inline usando `currentColor` — le icone monocromatiche si adattano automaticamente alla modalità chiara e scura. Le varianti a colori preservano i colori originali.

:::note[Modalità scura]
Le icone monocromatiche usano `currentColor` e si adattano automaticamente. Le varianti a colori (icone che terminano con `-color`) preservano i colori originali tramite la classe `no-invert`.
:::

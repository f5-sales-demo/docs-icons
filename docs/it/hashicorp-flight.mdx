---
title: Icone HashiCorp Flight
description: >-
  Riferimento visivo per tutte le 672 icone HashiCorp Flight da
...
Riferimento visivo completo per ogni icona nel pacchetto [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). Le icone vengono renderizzate tramite il componente `Icon` e organizzate per categoria.
...
Le icone vengono renderizzate come SVG inline utilizzando `currentColor` — le icone monocromatiche si adattano automaticamente alla modalità chiara e scura. Le varianti a colori mantengono i colori originali.

:::note[Modalità scura]
Le icone monocromatiche utilizzano `currentColor` e si adattano automaticamente. Le varianti a colori (icone che terminano con `-color`) mantengono i colori originali tramite la classe `no-invert`.
:::

...
title: Icone Lucide
description: >-
  Riferimento selezionato per le icone Lucide — oltre 1.600 icone moderne con
  tratto disponibili tramite il componente Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) fornisce circa 1.600 icone moderne e uniformi con tratto. Utilizzare il componente `Icon` da `@f5xc-salesdemos/icons-lucide` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo di circa 1.600 icone Lucide, visitare [lucide.dev/icons](https://lucide.dev/icons/).

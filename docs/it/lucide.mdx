...
title: Icone Lucide
description: >-
  Riferimento curato per le icone Lucide — oltre 1.600 icone moderne a tratto
...
[Lucide](https://lucide.dev/) fornisce circa 1.600 icone moderne e coerenti a tratto. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-lucide` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle circa 1.600 icone Lucide, visitate [lucide.dev/icons](https://lucide.dev/icons/).

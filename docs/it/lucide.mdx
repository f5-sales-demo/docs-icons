...
[Lucide](https://lucide.dev/) fornisce circa 1.600 icone moderne e uniformi con tratto. Utilizzare il componente `Icon` da `@f5-sales-demo/icons-lucide` per renderizzare qualsiasi icona per nome.

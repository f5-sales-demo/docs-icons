...
[Lucide](https://lucide.dev/) fornisce circa 1.600 icone moderne e coerenti con tratto. Utilizza il componente `Icon` di `@f5xc-salesdemos/icons-lucide` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo di circa 1.600 icone Lucide, visita [lucide.dev/icons](https://lucide.dev/icons/).

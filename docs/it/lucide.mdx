...
[Lucide](https://lucide.dev/) fornisce circa 1.600 icone moderne e coerenti con tratto. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-lucide` per renderizzare qualsiasi icona per nome.

...
| Pacchetto | Numero | Utilizzo | Pagina |
|-----------|--------|----------|--------|
...
| Icone piene/contornate su larga scala | Material Design (mdi) | Il set più ampio con 7.638 icone |
| Linguaggio di design IBM | Carbon | 2.582 icone di livello enterprise |
| Opzioni flessibili di spessore | Phosphor | 9.161 icone con sei varianti di spessore |
...
| Loghi di brand/aziende | Simple Icons | Oltre 3.200 icone brand per vendor e servizi |
| Loghi vendor cloud/infrastruttura | HashiCorp Flight | Icone vendor per AWS, GCP, Azure, K8s |
| Diagrammi architettura AWS | AWS Architecture | 885 icone a colori per infrastruttura AWS |
| Diagrammi architettura Azure | Azure Architecture | 606 icone a colori per infrastruttura Azure |
| Diagrammi architettura GCP | GCP Architecture | 216 icone a colori per infrastruttura Google Cloud |

...
Sono disponibili diversi pacchetti di icone Iconify come pacchetti npm con componenti Astro `Icon`. Ogni pacchetto ha il proprio import e utilizza la stessa API basata su `name`.
...
- **Flessibilità dei pesi**: Phosphor offre sei varianti di peso (thin, light, regular, bold, fill, duotone) per un controllo preciso del peso visivo.
- **Stroke coerenti**: Tabler utilizza uno spessore di stroke uniforme di 2px su tutte le 6.034 icone per un aspetto omogeneo.

Consulta la pagina dedicata di ciascun pacchetto per griglie di icone curate e link per la navigazione.

...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) fornisce 885 icone a colori dei servizi per documentare l'infrastruttura AWS. Utilizzare il componente `Icon` da `@f5xc-salesdemos/icons-aws` per renderizzare qualsiasi icona tramite nome. La dimensione predefinita è 48x48 con possibilità di sovrascrittura per singola icona.

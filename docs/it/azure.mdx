...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) fornisce 606 icone di servizi a colori per documentare l'infrastruttura Azure. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-azure` per rendere qualsiasi icona per nome. La dimensione predefinita è 18x18 con riempimenti sfumati.

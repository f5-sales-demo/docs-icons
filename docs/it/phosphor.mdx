...
description: >-
  Riferimento curato per le icone Phosphor — 9.161 icone con varianti di peso
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) fornisce 9.161 icone con opzioni di peso flessibili — regular, bold, duotone, fill, light e thin. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-phosphor` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 9.161 icone Phosphor (in tutte le varianti di peso), visitate l'[esploratore Phosphor di Iconify](https://icon-sets.iconify.design/ph/).

...
Per l'elenco completo delle 9.161 icone Phosphor (in tutte le varianti di peso), visitate l'[esploratore Iconify Phosphor](https://icon-sets.iconify.design/ph/).

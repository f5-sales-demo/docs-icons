...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) fornisce 9.161 icone con opzioni di peso flessibili — regular, bold, duotone, fill, light e thin. Utilizza il componente `Icon` da `@f5-sales-demo/icons-phosphor` per visualizzare qualsiasi icona per nome.

...
description: >-
  Riferimento curato per le Material Design Icons — 7.638 icone piene e con
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornisce 7.638 icone con varianti piene e con contorno che coprono praticamente ogni caso d'uso. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-mdi` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 7.638 Material Design Icons, visita l'[esploratore Iconify MDI](https://icon-sets.iconify.design/mdi/).

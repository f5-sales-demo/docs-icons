---
title: Icone Material Design
description: >-
  Riferimento curato per le icone Material Design — 7.638 icone piene e con
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornisce 7.638 icone con varianti piene e con contorno che coprono praticamente ogni caso d'uso. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-mdi` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 7.638 icone Material Design, visitate l'[esploratore MDI di Iconify](https://icon-sets.iconify.design/mdi/).

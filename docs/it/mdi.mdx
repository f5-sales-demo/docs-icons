...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornisce 7.638 icone con varianti piene e con contorno che coprono virtualmente ogni caso d'uso. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-mdi` per renderizzare qualsiasi icona per nome.

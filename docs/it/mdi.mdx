...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornisce 7.638 icone con varianti piene e con contorno che coprono praticamente ogni caso d'uso. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-mdi` per visualizzare qualsiasi icona per nome.
...
Per l'elenco completo di 7.638 Material Design Icons, visita l'[explorer MDI di Iconify](https://icon-sets.iconify.design/mdi/).

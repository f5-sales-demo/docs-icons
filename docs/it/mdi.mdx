...
description: >-
  Riferimento curato per Material Design Icons — 7.638 icone piene e con
  contorno disponibili tramite il componente Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornisce 7.638 icone con varianti piene e con contorno che coprono virtualmente ogni caso d'uso. Utilizza il componente `Icon` da `@f5-sales-demo/icons-mdi` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 7.638 Material Design Icons, visita l'[explorer Iconify MDI](https://icon-sets.iconify.design/mdi/).

...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornisce 6.034 icone lineari nitide con uno spessore del tratto uniforme di 2px. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-tabler` per visualizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 6.034 icone Tabler, visitate l'[esploratore Iconify Tabler](https://icon-sets.iconify.design/tabler/).

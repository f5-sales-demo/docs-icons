...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornisce 6.034 icone a linee nitide con uno spessore del tratto uniforme di 2px. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-tabler` per renderizzare qualsiasi icona per nome.

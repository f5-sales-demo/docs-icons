...
title: Icone Tabler
description: >-
  Riferimento curato per le icone Tabler — 6.034 icone lineari nitide con
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornisce 6.034 icone lineari nitide con uno spessore del tratto uniforme di 2px. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-tabler` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 6.034 icone Tabler, visitate l'[esploratore Tabler su Iconify](https://icon-sets.iconify.design/tabler/).

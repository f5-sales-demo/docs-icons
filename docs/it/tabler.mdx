...
description: >-
  ...
  larghezza del tratto uniforme disponibili tramite il componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornisce 6.034 icone a linee nitide con una larghezza del tratto uniforme di 2px. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-tabler` per visualizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 6.034 Tabler Icons, visita l'[esploratore Iconify Tabler](https://icon-sets.iconify.design/tabler/).

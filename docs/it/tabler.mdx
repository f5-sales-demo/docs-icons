...
title: Tabler Icons
description: >-
  Riferimento curato per Tabler Icons — 6.034 icone lineari nitide con spessore
  del tratto uniforme, disponibili tramite il componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornisce 6.034 icone lineari nitide con uno spessore del tratto uniforme di 2px. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-tabler` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 6.034 Tabler Icons, visita l'[esploratore Tabler su Iconify](https://icon-sets.iconify.design/tabler/).

...
Simple Icons fornisce oltre 3.200 icone SVG gratuite per brand popolari, inclusi fornitori di rete, provider cloud, aziende di telecomunicazioni e servizi tecnologici. Tutte le icone utilizzano un viewBox standard 24x24.
...
## Telecomunicazioni e fornitori di servizi
...
Esplora tutte le oltre 3.200 icone: [Sito web Simple Icons](https://simpleicons.org/) | [Esploratore Iconify](https://icon-sets.iconify.design/simple-icons/)

...
Simple Icons fornisce oltre 3.200 icone SVG gratuite per i brand più popolari, tra cui vendor di rete, provider cloud, aziende di telecomunicazioni e servizi tecnologici. Tutte le icone utilizzano un viewBox standard 24x24.
...
Sfoglia tutte le oltre 3.200 icone: [Sito web Simple Icons](https://simpleicons.org/) | [Esplora su Iconify](https://icon-sets.iconify.design/simple-icons/)

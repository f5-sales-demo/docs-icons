...
title: Simple Icons
description: >-
  Oltre 3.200 icone di brand per aziende, servizi e tecnologie popolari dal
  progetto Simple Icons.
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons fornisce oltre 3.200 icone SVG gratuite per brand popolari, tra cui vendor di rete, provider cloud, operatori di telecomunicazioni e servizi tecnologici. Tutte le icone utilizzano un viewBox standard 24x24.
...
## Operatori Telefonici e Provider di Servizi
...
Sfoglia tutte le oltre 3.200 icone: [Sito web Simple Icons](https://simpleicons.org/) | [Esplora con Iconify](https://icon-sets.iconify.design/simple-icons/)

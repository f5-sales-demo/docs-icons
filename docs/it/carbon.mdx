...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornisce 2.582 icone pulite e delineate dal linguaggio di design enterprise di IBM. Utilizzare il componente `Icon` da `@f5xc-salesdemos/icons-carbon` per visualizzare qualsiasi icona per nome.

...
description: >-
  ...
  linguaggio di design di IBM disponibili tramite il componente Icon.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornisce 2.582 icone pulite e delineate dal linguaggio di design enterprise di IBM. Utilizzare il componente `Icon` da `@f5-sales-demo/icons-carbon` per visualizzare qualsiasi icona per nome.
...
Per l'elenco completo di 2.582 Icone Carbon, visitare l'[esploratore Iconify Carbon](https://icon-sets.iconify.design/carbon/).

...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornisce 2.582 icone pulite e delineate dal linguaggio di design enterprise di IBM. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-carbon` per visualizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 2.582 icone Carbon, visita il [browser Carbon di Iconify](https://icon-sets.iconify.design/carbon/).

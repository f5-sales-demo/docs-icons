...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornisce 2.582 icone pulite e con contorno dal linguaggio di design enterprise di IBM. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-carbon` per renderizzare qualsiasi icona per nome.
...
Per l'elenco completo delle 2.582 Icone Carbon, visita l'[esploratore Carbon su Iconify](https://icon-sets.iconify.design/carbon/).

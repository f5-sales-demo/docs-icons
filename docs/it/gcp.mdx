...
[GCP Architecture Icons](https://cloud.google.com/icons) fornisce 216 icone di servizi a colori per documentare l'infrastruttura Google Cloud. Utilizza il componente `Icon` da `@f5xc-salesdemos/icons-gcp` per visualizzare qualsiasi icona per nome. La dimensione predefinita è 24x24 con riempimenti inline.

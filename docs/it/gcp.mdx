...
description: >-
  Riferimento curato per le icone di architettura GCP — 216 icone a colori per
...
[GCP Architecture Icons](https://cloud.google.com/icons) fornisce 216 icone a colori per documentare l'infrastruttura Google Cloud. Utilizzare il componente `Icon` da `@f5xc-salesdemos/icons-gcp` per visualizzare qualsiasi icona per nome. La dimensione predefinita è 24x24 con riempimenti inline.
...
Per l'elenco completo delle 216 icone di architettura GCP, visitare la pagina [Google Cloud Architecture Icons](https://cloud.google.com/icons).

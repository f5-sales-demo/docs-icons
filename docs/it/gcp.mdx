---
title: Icone dell'architettura GCP
description: >-
  Riferimento curato per le icone dell'architettura GCP — 216 icone di servizi a
  colori per diagrammi di infrastrutture cloud e documentazione.
sidebar:
  label: GCP
  order: 16
i18n:
...
[GCP Architecture Icons](https://cloud.google.com/icons) fornisce 216 icone di servizi a colori per documentare l'infrastruttura Google Cloud. Utilizza il componente `Icon` da `@f5-sales-demo/icons-gcp` per visualizzare qualsiasi icona per nome. La dimensione predefinita è 24x24 con riempimenti inline.
...
Per l'elenco completo delle 216 icone dell'architettura GCP, visita la pagina [Google Cloud Architecture Icons](https://cloud.google.com/icons).

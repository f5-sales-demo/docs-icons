---
title: Icone di Architettura GCP
description: >-
  Riferimento curato per le Icone di Architettura GCP — 216 icone a colori dei
...
[GCP Architecture Icons](https://cloud.google.com/icons) fornisce 216 icone a colori dei servizi per documentare l'infrastruttura Google Cloud. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-gcp` per renderizzare qualsiasi icona tramite nome. La dimensione predefinita è 24x24 con riempimenti inline.
...
Per l'elenco completo delle 216 Icone di Architettura GCP, visitate la pagina [Google Cloud Architecture Icons](https://cloud.google.com/icons).

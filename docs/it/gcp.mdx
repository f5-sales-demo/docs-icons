...
description: >-
  Riferimento curato per le Icone di Architettura GCP — 216 icone colorate dei
...
[GCP Architecture Icons](https://cloud.google.com/icons) fornisce 216 icone colorate dei servizi per documentare l'infrastruttura Google Cloud. Utilizzate il componente `Icon` da `@f5xc-salesdemos/icons-gcp` per renderizzare qualsiasi icona per nome. La dimensione predefinita è 24x24 con riempimenti inline.

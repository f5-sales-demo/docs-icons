...
يوفر Simple Icons أكثر من 3,200 أيقونة SVG مجانية للعلامات التجارية الشائعة بما في ذلك موردي الشبكات ومزودي الخدمات السحابية وشركات الاتصالات وخدمات التكنولوجيا. تستخدم جميع الأيقونات viewBox قياسي بحجم 24×24.

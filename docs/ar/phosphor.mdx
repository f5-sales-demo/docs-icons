...
توفر [أيقونات Phosphor](https://icon-sets.iconify.design/ph/) 9,161 أيقونة مع خيارات وزن مرنة — عادي، غامق، ثنائي النغمة، مملوء، خفيف، ورفيع. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-phosphor` لعرض أي أيقونة بالاسم.

...
description: >-
  مرجع منتقى لأيقونات Phosphor — 9,161 أيقونة مع خيارات وزن مرنة متاحة عبر مكوّن
  Icon.
sidebar:
  label: Phosphor
  order: 8
...
توفر [أيقونات Phosphor](https://icon-sets.iconify.design/ph/) 9,161 أيقونة مع خيارات وزن مرنة — عادي، غامق، ثنائي اللون، مملوء، خفيف، ورفيع. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-phosphor` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كصور SVG مضمّنة باستخدام `currentColor` — وتتكيف تلقائيًا مع الوضع الفاتح والداكن.

:::note[متغيرات الوزن]
تأتي أيقونات Phosphor بستة أوزان. يستخدم الوزن العادي الاسم الأساسي (مثل `globe`). أما الأوزان الأخرى فتُضيف لاحقة: `globe-bold`، و`globe-duotone`، و`globe-fill`، و`globe-light`، و`globe-thin`. تعرض الأمثلة أدناه الوزن العادي.
:::
...
للاطلاع على القائمة الكاملة المؤلفة من 9,161 أيقونة من أيقونات Phosphor (عبر جميع متغيرات الوزن)، تفضل بزيارة [مستكشف Phosphor على Iconify](https://icon-sets.iconify.design/ph/).

...
description: >-
  مرجع منتقى لأيقونات Phosphor — 9,161 أيقونة مع متغيرات أوزان مرنة متاحة عبر
  مكوّن Icon.
sidebar:
  label: Phosphor
  order: 8
...
توفر [أيقونات Phosphor](https://icon-sets.iconify.design/ph/) عدد 9,161 أيقونة مع خيارات أوزان مرنة — عادي، غامق، ثنائي اللون، معبأ، خفيف، ورفيع. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-phosphor` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — فتتكيف تلقائيًا مع الوضع الفاتح والداكن.

:::note[متغيرات الأوزان]
تأتي أيقونات Phosphor بستة أوزان. يستخدم الوزن العادي الاسم الأساسي (مثل `globe`). أما الأوزان الأخرى فتُلحق لاحقة: `globe-bold`، `globe-duotone`، `globe-fill`، `globe-light`، `globe-thin`. تعرض الأمثلة أدناه الوزن العادي.
:::
...
للاطلاع على القائمة الكاملة لأيقونات Phosphor البالغ عددها 9,161 أيقونة (عبر جميع متغيرات الأوزان)، قم بزيارة [مستكشف Phosphor على Iconify](https://icon-sets.iconify.design/ph/).

...
description: >-
  مرجع منسّق لأيقونات Phosphor — 9,161 أيقونة مع متغيرات وزن مرنة متاحة عبر
  مكوّن Icon.
sidebar:
  label: Phosphor
  order: 8
...
توفر [أيقونات Phosphor](https://icon-sets.iconify.design/ph/) عدد 9,161 أيقونة مع خيارات وزن مرنة — عادي، عريض، ثنائي اللون، معبّأ، خفيف، ونحيف. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-phosphor` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — فتتكيف تلقائياً مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 9,161 أيقونة من أيقونات Phosphor (عبر جميع متغيرات الوزن)، قم بزيارة [مستكشف Phosphor على Iconify](https://icon-sets.iconify.design/ph/).

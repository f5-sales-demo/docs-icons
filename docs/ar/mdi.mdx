...
description: >-
  مرجع منتقى لأيقونات Material Design — 7,638 أيقونة مملوءة ومحددة الحواف متاحة
  عبر مكوّن الأيقونة.
sidebar:
...
توفر [أيقونات Material Design](https://icon-sets.iconify.design/mdi/) 7,638 أيقونة بمتغيرات مملوءة ومحددة الحواف تغطي كل حالة استخدام تقريبًا. استخدم مكوّن `Icon` من `@f5-sales-demo/icons-mdi` لعرض أي أيقونة باسمها.
...
تُعرض الأيقونات كـ SVG مضمّنة باستخدام `currentColor` — وتتكيف تلقائيًا مع الوضع الفاتح والوضع الداكن.
...
للاطلاع على القائمة الكاملة المؤلفة من 7,638 أيقونة من أيقونات Material Design، تفضل بزيارة [مستكشف Iconify MDI](https://icon-sets.iconify.design/mdi/).

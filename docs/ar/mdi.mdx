...
description: >-
  مرجع منتقى لأيقونات Material Design — 7,638 أيقونة مملوءة ومحددة الخطوط متاحة
  عبر مكوّن Icon.
sidebar:
...
توفر [أيقونات Material Design](https://icon-sets.iconify.design/mdi/) عدد 7,638 أيقونة بمتغيرات مملوءة ومحددة الخطوط تغطي تقريبًا كل حالة استخدام. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-mdi` لعرض أي أيقونة حسب الاسم.
...
يتم عرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — فتتكيف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 7,638 أيقونة من Material Design Icons، قم بزيارة [مستكشف Iconify MDI](https://icon-sets.iconify.design/mdi/).

---
title: أيقونات التصميم المادي
description: >-
  مرجع منسّق لأيقونات التصميم المادي — 7,638 أيقونة مملوءة ومحددة الخطوط متاحة
  عبر مكوّن Icon.
sidebar:
  label: التصميم المادي
  order: 6
i18n:
...
توفر [أيقونات التصميم المادي](https://icon-sets.iconify.design/mdi/) عدد 7,638 أيقونة بمتغيرات مملوءة ومحددة الخطوط تغطي تقريبًا كل حالة استخدام. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-mdi` لعرض أي أيقونة حسب الاسم.
...
للاطلاع على القائمة الكاملة التي تضم 7,638 أيقونة من أيقونات التصميم المادي، قم بزيارة [مستكشف Iconify لأيقونات MDI](https://icon-sets.iconify.design/mdi/).

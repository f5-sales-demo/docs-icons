...
توفر [أيقونات Material Design](https://icon-sets.iconify.design/mdi/) 7,638 أيقونة بمتغيرات مملوءة ومحددة الحواف تغطي كل حالة استخدام تقريبًا. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-mdi` لعرض أي أيقونة باسمها.

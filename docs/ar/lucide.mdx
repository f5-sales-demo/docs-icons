...
description: >-
  مرجع منتقى لأيقونات Lucide — أكثر من 1,600 أيقونة حديثة ذات خطوط متاحة عبر
  مكوّن Icon.
sidebar:
  label: Lucide
  order: 5
...
يوفر [Lucide](https://lucide.dev/) ما يقارب 1,600 أيقونة حديثة ومتسقة ذات خطوط. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-lucide` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كـ SVG مضمّن باستخدام `currentColor` — وتتكيف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم ما يقارب 1,600 أيقونة من Lucide، تفضل بزيارة [lucide.dev/icons](https://lucide.dev/icons/).

...
description: >-
  مرجع منسق لأيقونات Lucide — أكثر من 1,600 أيقونة حديثة ذات خطوط متاحة عبر
  مكوّن Icon.
sidebar:
  label: Lucide
  order: 5
...
تُعرض الأيقونات كـ SVG مضمّنة باستخدام `currentColor` — وتتكيف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة لما يزيد على 1,600 أيقونة من Lucide، تفضل بزيارة [lucide.dev/icons](https://lucide.dev/icons/).

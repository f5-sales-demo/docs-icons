...
description: >-
  مرجع منسّق لأيقونات Lucide — أكثر من 1,600 أيقونة حديثة بخطوط متاحة عبر مكوّن
  Icon.
sidebar:
  label: Lucide
  order: 5
...
يوفر [Lucide](https://lucide.dev/) حوالي 1,600 أيقونة حديثة ومتسقة بخطوط. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-lucide` لعرض أي أيقونة بالاسم.
...
للاطلاع على القائمة الكاملة لحوالي 1,600 أيقونة من Lucide، قم بزيارة [lucide.dev/icons](https://lucide.dev/icons/).

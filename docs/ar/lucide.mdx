---
title: أيقونات Lucide
description: >-
  مرجع منسّق لأيقونات Lucide — أكثر من 1,600 أيقونة خطية حديثة متاحة عبر مكون
  Icon.
sidebar:
  label: Lucide
  order: 5
...
يوفر [Lucide](https://lucide.dev/) حوالي 1,600 أيقونة خطية حديثة ومتسقة. استخدم مكون `Icon` من `@f5xc-salesdemos/icons-lucide` لعرض أي أيقونة حسب الاسم.
...
للاطلاع على القائمة الكاملة لأيقونات Lucide التي تضم حوالي 1,600 أيقونة، قم بزيارة [lucide.dev/icons](https://lucide.dev/icons/).

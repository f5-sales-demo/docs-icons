...
description: >-
  مرجع منسّق لأيقونات Lucide — أكثر من 1,600 أيقونة خطية حديثة متاحة عبر مكوّن
  Icon.
sidebar:
  label: Lucide
  order: 5
...
يوفر [Lucide](https://lucide.dev/) حوالي 1,600 أيقونة خطية حديثة ومتسقة. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-lucide` لعرض أي أيقونة باسمها.
...
تُعرض الأيقونات كملفات SVG مضمّنة باستخدام `currentColor` — فتتكيف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم حوالي 1,600 أيقونة من Lucide، قم بزيارة [lucide.dev/icons](https://lucide.dev/icons/).

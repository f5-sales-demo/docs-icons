...
description: >-
  مرجع منسق لأيقونات بنية Azure — 606 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: Azure
  order: 15
...
توفر [أيقونات بنية Azure](https://learn.microsoft.com/en-us/azure/architecture/icons/) عدد 606 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ Azure. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-azure` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 18×18 مع تعبئات متدرجة.
...
تستخدم هذه الأيقونات ألوان المورد الأصلية (وليس `currentColor`). الألوان مضمنة في ترميز SVG ومحفوظة في كل من الوضع الفاتح والداكن.

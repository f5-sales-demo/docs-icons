...
توفر [أيقونات معمارية Azure](https://learn.microsoft.com/en-us/azure/architecture/icons/) 606 أيقونة خدمة ملونة لتوثيق بنية Azure التحتية. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-azure` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 18×18 مع تعبئة متدرجة.

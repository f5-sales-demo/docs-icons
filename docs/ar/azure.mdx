---
title: أيقونات معمارية Azure
description: >-
  مرجع منسق لأيقونات معمارية Azure — 606 أيقونة خدمة ملونة لمخططات البنية
...
توفر [أيقونات معمارية Azure](https://learn.microsoft.com/en-us/azure/architecture/icons/) 606 أيقونة خدمة ملونة لتوثيق بنية Azure التحتية. استخدم مكوّن `Icon` من `@f5-sales-demo/icons-azure` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 18×18 مع تعبئة متدرجة.
...
تستخدم هذه الأيقونات ألوان المورّد الأصلية (وليس `currentColor`). الألوان مضمّنة في علامات SVG ومحفوظة في كلا وضعي الإضاءة الفاتحة والداكنة.
...
للاطلاع على القائمة الكاملة المؤلفة من 606 أيقونة معمارية لـ Azure، تفضل بزيارة صفحة [أيقونات معمارية Microsoft Azure](https://learn.microsoft.com/en-us/azure/architecture/icons/).

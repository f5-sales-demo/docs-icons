...
description: >-
  مرجع منظّم لأيقونات معمارية Azure — 606 أيقونة خدمة ملوّنة لمخططات البنية
...
يوفّر [Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) عدد 606 أيقونة خدمة ملوّنة لتوثيق البنية التحتية في Azure. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-azure` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 18×18 مع تعبئة متدرجة.
...
تستخدم هذه الأيقونات ألوان البائع الأصلية (وليس `currentColor`). الألوان مضمّنة في ترميز SVG وتُحفظ في كلٍّ من الوضع الفاتح والوضع الداكن.
...
للاطلاع على القائمة الكاملة التي تضم 606 أيقونة معمارية لـ Azure، تفضّل بزيارة صفحة [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

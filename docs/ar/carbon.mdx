...
توفر [أيقونات Carbon](https://icon-sets.iconify.design/carbon/) عدد 2,582 أيقونة نظيفة بخطوط خارجية من لغة التصميم المؤسسية لشركة IBM. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-carbon` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — وتتكيف تلقائياً مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة لأيقونات Carbon البالغ عددها 2,582 أيقونة، قم بزيارة [مستكشف Carbon على Iconify](https://icon-sets.iconify.design/carbon/).

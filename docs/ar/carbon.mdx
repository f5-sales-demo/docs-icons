...
description: >-
  مرجع منتقى لأيقونات Carbon — 2,582 أيقونة على مستوى المؤسسات من لغة تصميم IBM،
...
توفر [أيقونات Carbon](https://icon-sets.iconify.design/carbon/) 2,582 أيقونة نظيفة ذات خطوط واضحة من لغة تصميم IBM المؤسسية. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-carbon` لعرض أي أيقونة بالاسم.
...
للاطلاع على القائمة الكاملة المؤلفة من 2,582 أيقونة Carbon، تفضل بزيارة [مستكشف Iconify Carbon](https://icon-sets.iconify.design/carbon/).

...
description: >-
  مرجع منظّم لأيقونات Carbon — 2,582 أيقونة بمستوى مؤسسي من لغة تصميم IBM متاحة
  عبر مكوّن Icon.
sidebar:
  label: Carbon
  order: 7
...
توفر [أيقونات Carbon](https://icon-sets.iconify.design/carbon/) 2,582 أيقونة نظيفة ذات حدود خارجية من لغة تصميم IBM المؤسسية. استخدم مكوّن `Icon` من `@f5-sales-demo/icons-carbon` لعرض أي أيقونة باسمها.
...
للاطلاع على القائمة الكاملة المتضمنة 2,582 أيقونة من Carbon، تفضّل بزيارة [مستعرض Carbon في Iconify](https://icon-sets.iconify.design/carbon/).

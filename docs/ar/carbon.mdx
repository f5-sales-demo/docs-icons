---
title: أيقونات Carbon
description: >-
  Curated reference for Carbon Icons — 2,582 enterprise-grade icons from IBM's
  design language available via the Icon component.
sidebar:
  label: Carbon
  order: 7
i18n:
...
توفر [أيقونات Carbon](https://icon-sets.iconify.design/carbon/) مجموعة من 2,582 أيقونة نظيفة بأسلوب الخطوط الخارجية من لغة التصميم المؤسسي لشركة IBM. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-carbon` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مُضمّنة باستخدام `currentColor` — فتتكيف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 2,582 أيقونة من أيقونات Carbon، قم بزيارة [مستكشف Carbon على Iconify](https://icon-sets.iconify.design/carbon/).

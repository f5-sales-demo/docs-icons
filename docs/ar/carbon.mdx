...
description: >-
  مرجع منسّق لأيقونات Carbon — 2,582 أيقونة بمستوى المؤسسات من لغة تصميم IBM
...
توفر [أيقونات Carbon](https://icon-sets.iconify.design/carbon/) عدد 2,582 أيقونة نظيفة بخطوط خارجية من لغة تصميم IBM للمؤسسات. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-carbon` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — فتتكيّف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 2,582 أيقونة من Carbon، قم بزيارة [مستكشف Carbon على Iconify](https://icon-sets.iconify.design/carbon/).

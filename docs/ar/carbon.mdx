...
توفر [أيقونات Carbon](https://icon-sets.iconify.design/carbon/) 2,582 أيقونة نظيفة ذات حدود خارجية من لغة تصميم IBM المؤسسية. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-carbon` لعرض أي أيقونة باسمها.

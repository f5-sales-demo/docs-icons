---
title: أيقونات بنية AWS
description: >-
  مرجع منتقى لأيقونات بنية AWS — 885 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: AWS
  order: 14
...
توفر [أيقونات بنية AWS](https://aws.amazon.com/architecture/icons/) 885 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ AWS. استخدم مكوّن `Icon` من `@f5-sales-demo/icons-aws` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 48×48 مع إمكانية تجاوز الحجم لكل أيقونة على حدة.
...
تستخدم هذه الأيقونات الألوان الأصلية للمورّد (وليس `currentColor`). الألوان مدمجة في ترميز SVG وتُحفظ في كلا وضعَي الإضاءة والظلام.
...
للاطلاع على القائمة الكاملة المكونة من 885 أيقونة من أيقونات بنية AWS، تفضل بزيارة [أيقونات AWS لمخططات البنية](https://aws.amazon.com/architecture/icons/).

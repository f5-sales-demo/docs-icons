---
title: أيقونات هندسة AWS
description: >-
  مرجع منسّق لأيقونات هندسة AWS — 885 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: AWS
  order: 14
...
توفر [أيقونات هندسة AWS](https://aws.amazon.com/architecture/icons/) عدد 885 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ AWS. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-aws` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 48×48 مع إمكانية تجاوز الحجم لكل أيقونة.
...
تستخدم هذه الأيقونات الألوان الأصلية من المورّد (وليس `currentColor`). الألوان مضمّنة في ترميز SVG ومحفوظة في كلا الوضعين الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 885 أيقونة من أيقونات هندسة AWS، قم بزيارة [أيقونات AWS لمخططات الهندسة المعمارية](https://aws.amazon.com/architecture/icons/).

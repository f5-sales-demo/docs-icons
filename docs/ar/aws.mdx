...
description: >-
  مرجع منسّق لأيقونات بنية AWS — 885 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: AWS
  order: 14
...
توفر [أيقونات بنية AWS](https://aws.amazon.com/architecture/icons/) عدد 885 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ AWS. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-aws` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 48×48 مع إمكانية تخصيص الحجم لكل أيقونة.
...
تستخدم هذه الأيقونات الألوان الأصلية من المورّد (وليس `currentColor`). الألوان مضمّنة في ترميز SVG ويتم الحفاظ عليها في كل من الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة المكونة من 885 أيقونة بنية AWS، قم بزيارة [أيقونات AWS لمخططات البنية](https://aws.amazon.com/architecture/icons/).

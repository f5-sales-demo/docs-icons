...
تستخدم هذه الأيقونات ألوان المورّد الأصلية (وليس `currentColor`). الألوان مضمّنة في ترميز SVG ويتم الحفاظ عليها في كل من الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 885 أيقونة من أيقونات بنية AWS، قم بزيارة [أيقونات AWS لمخططات البنية](https://aws.amazon.com/architecture/icons/).

...
توفر [أيقونات بنية AWS](https://aws.amazon.com/architecture/icons/) 885 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ AWS. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-aws` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 48×48 مع إمكانية تجاوز الحجم لكل أيقونة على حدة.

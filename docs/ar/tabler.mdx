...
description: >-
  مرجع منتقى لأيقونات Tabler — 6,034 أيقونة خطية واضحة بعرض خط ثابت متاحة عبر
  مكوّن Icon.
sidebar:
  label: Tabler
  order: 9
...
توفر [أيقونات Tabler](https://icon-sets.iconify.design/tabler/) 6,034 أيقونة خطية واضحة بعرض خط ثابت يبلغ 2px. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-tabler` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كملفات SVG مضمّنة تستخدم `currentColor` — وتتكيف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة المؤلفة من 6,034 أيقونة من أيقونات Tabler، تفضل بزيارة [مستكشف Iconify Tabler](https://icon-sets.iconify.design/tabler/).

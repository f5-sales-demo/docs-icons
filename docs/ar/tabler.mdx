...
description: >-
  مرجع منسّق لأيقونات Tabler — 6,034 أيقونة خطية واضحة بعرض حد متسق متاحة عبر
  مكوّن Icon.
sidebar:
  label: Tabler
  order: 9
...
توفر [أيقونات Tabler](https://icon-sets.iconify.design/tabler/) مجموعة من 6,034 أيقونة خطية واضحة بعرض حد متسق يبلغ 2 بكسل. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-tabler` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — فتتكيّف تلقائياً مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 6,034 أيقونة من Tabler، قم بزيارة [مستعرض Tabler على Iconify](https://icon-sets.iconify.design/tabler/).

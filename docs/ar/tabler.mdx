...
توفر [أيقونات Tabler](https://icon-sets.iconify.design/tabler/) 6,034 أيقونة خطية حادة بعرض خط موحد يبلغ 2px. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-tabler` لعرض أي أيقونة بالاسم.

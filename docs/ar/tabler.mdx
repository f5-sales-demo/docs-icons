...
title: Tabler Icons
description: >-
  مرجع منسّق لأيقونات Tabler — 6,034 أيقونة خطية واضحة بعرض حد متّسق متاحة عبر
  مكوّن Icon.
sidebar:
  label: Tabler
  order: 9
...
توفر [Tabler Icons](https://icon-sets.iconify.design/tabler/) عدد 6,034 أيقونة خطية واضحة بعرض حد متّسق يبلغ 2 بكسل. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-tabler` لعرض أي أيقونة بالاسم.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — وتتكيّف تلقائيًا مع الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة التي تضم 6,034 أيقونة من Tabler Icons، قم بزيارة [مستكشف Tabler على Iconify](https://icon-sets.iconify.design/tabler/).

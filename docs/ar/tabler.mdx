...
توفر [أيقونات Tabler](https://icon-sets.iconify.design/tabler/) عدد 6,034 أيقونة خطية واضحة بعرض حد متسق يبلغ 2 بكسل. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-tabler` لعرض أي أيقونة بالاسم.
...
للاطلاع على القائمة الكاملة التي تضم 6,034 أيقونة من Tabler، قم بزيارة [مستكشف Tabler على Iconify](https://icon-sets.iconify.design/tabler/).

...
description: >-
  مرجع شامل لجميع أيقونات Starlight المدمجة التي يزيد عددها عن 200 أيقونة
  والمتاحة عبر مكوّن Icon.
sidebar:
...
يتضمن Starlight أكثر من 200 أيقونة مدمجة متاحة عبر مكوّن `<Icon>` — دون الحاجة إلى أي تثبيت. إضافة `starlight-plugin-icons` مُهيأة مسبقاً في القالب، لذا تعمل هذه الأيقونات في أي مستودع محتوى.

## استخدام مكوّن الأيقونة

استورد المكوّن ومرّر اسم الأيقونة:
...
| `label` | `string` | — | تسمية وصفية لقارئات الشاشة. استخدمها للأيقونات ذات المعنى؛ واحذفها للأيقونات الزخرفية. |
...
:::tip[إمكانية الوصول]
أضف خاصية `label` عندما تحمل الأيقونة معنى (مثل أيقونة رابط). احذف `label` للأيقونات الزخرفية البحتة — سيقوم Starlight بإخفائها تلقائياً عن تقنيات المساعدة.
:::

...
مرجع بصري شامل لكل أيقونة في حزمة [`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc). تمثل هذه الأيقونات الثلاثون خدمات F5 Distributed Cloud وهي متاحة بصيغة Iconify JSON مع مكوّن Astro.
...
أو استيراد Iconify JSON مباشرة:
...
:::note[الوضع الداكن]
تستخدم هذه الأيقونات متعددة الألوان خصائص CSS المخصصة (`--color-N600`، `--color-brand`، `--color-blue-light`، `--color-N200`) التي تتكيف تلقائيًا مع الوضع الفاتح والداكن. يتبادل اللون الأزرق الداكن والأزرق الفاتح في الوضع الداكن بينما يبقى لون F5 الأحمر المميز ثابتًا.
:::

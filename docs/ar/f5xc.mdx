...
مرجع بصري شامل لكل أيقونة في حزمة [`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc). تمثل هذه الأيقونات الثلاثون خدمات F5 Distributed Cloud وهي متاحة بتنسيق Iconify JSON مع مكوّن Astro.

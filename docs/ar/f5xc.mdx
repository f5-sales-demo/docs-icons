...
title: F5 XC
description: >-
  مرجع بصري لجميع أيقونات خدمات F5 Distributed Cloud (XC) البالغ عددها 30 من
...
مرجع بصري كامل لكل أيقونة في حزمة [`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc). تمثل هذه الأيقونات الـ 30 خدمات F5 Distributed Cloud وهي متاحة بتنسيق Iconify JSON مع مكوّن Astro.
...
:::note[الوضع الداكن]
تستخدم هذه الأيقونات متعددة الألوان خصائص CSS المخصصة (`--color-N600`، `--color-brand`، `--color-blue-light`، `--color-N200`) التي تتكيف تلقائياً مع الوضع الفاتح والداكن. يتبادل اللون الكحلي والأزرق الفاتح في الوضع الداكن بينما يبقى لون F5 الأحمر المميز ثابتاً.
:::

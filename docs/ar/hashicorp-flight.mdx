...
description: >-
  مرجع بصري لجميع أيقونات HashiCorp Flight البالغ عددها 672 من
...
مرجع بصري شامل لكل أيقونة في حزمة [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). يتم عرض الأيقونات عبر مكون `Icon` ومنظمة حسب الفئة.
...
يتم عرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — تتكيف الأيقونات أحادية اللون تلقائياً مع الوضع الفاتح والداكن. تحافظ المتغيرات الملونة على ألوانها الأصلية.

:::note[الوضع الداكن]
تستخدم الأيقونات أحادية اللون `currentColor` وتتكيف تلقائياً. تحافظ المتغيرات الملونة (الأيقونات التي تنتهي بـ `-color`) على ألوانها الأصلية عبر فئة `no-invert`.
:::

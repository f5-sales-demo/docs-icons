...
مرجع بصري شامل لكل أيقونة في حزمة [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). يتم عرض الأيقونات عبر مكوّن `Icon` ومنظمة حسب الفئة.
...
تُعرض الأيقونات كرسومات SVG مضمّنة باستخدام `currentColor` — تتكيف الأيقونات أحادية اللون تلقائيًا مع الوضع الفاتح والداكن. تحتفظ المتغيرات الملونة بألوانها الأصلية.

:::note[الوضع الداكن]
تستخدم الأيقونات أحادية اللون `currentColor` وتتكيف تلقائيًا. تحتفظ المتغيرات الملونة (الأيقونات المنتهية بـ `-color`) بألوانها الأصلية عبر فئة `no-invert`.
:::

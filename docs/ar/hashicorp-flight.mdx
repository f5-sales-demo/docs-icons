---
title: أيقونات HashiCorp Flight
description: >-
  مرجع مرئي لجميع أيقونات HashiCorp Flight البالغ عددها 672 أيقونة من
...
مرجع مرئي شامل لكل أيقونة في حزمة [`@f5-sales-demo/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5-sales-demo/icons-hashicorp-flight). يتم عرض الأيقونات عبر مكوّن `Icon` ومنظّمة حسب الفئة.
...
تُعرض الأيقونات كـ SVG مضمّنة باستخدام `currentColor` — تتكيف الأيقونات أحادية اللون تلقائيًا مع الوضع الفاتح والداكن. تحتفظ الإصدارات الملونة بألوانها الأصلية.

:::note[الوضع الداكن]
تستخدم الأيقونات أحادية اللون `currentColor` وتتكيف تلقائيًا. تحتفظ المتغيرات الملونة (الأيقونات التي تنتهي بـ `-color`) بألوانها الأصلية عبر الفئة `no-invert`.
:::

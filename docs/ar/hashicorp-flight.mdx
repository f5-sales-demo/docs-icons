...
مرجع مرئي شامل لكل أيقونة في حزمة [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). يتم عرض الأيقونات عبر مكوّن `Icon` ومنظّمة حسب الفئة.

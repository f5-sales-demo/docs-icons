...
description: >-
  مرجع منسّق لأيقونات معمارية GCP — 216 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: GCP
  order: 16
...
توفّر [أيقونات معمارية GCP](https://cloud.google.com/icons) 216 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ Google Cloud. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-gcp` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 24x24 مع تعبئة مضمّنة.
...
تستخدم هذه الأيقونات ألوان المورّد الأصلية (وليس `currentColor`). الألوان مضمّنة في ترميز SVG ومحفوظة في كلٍّ من الوضع الفاتح والوضع الداكن.
...
## تصفّح جميع الأيقونات

للاطلاع على القائمة الكاملة المؤلفة من 216 أيقونة معمارية لـ GCP، قم بزيارة صفحة [أيقونات معمارية Google Cloud](https://cloud.google.com/icons).

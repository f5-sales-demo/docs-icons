---
title: أيقونات معمارية GCP
description: >-
  مرجع منتقى لأيقونات معمارية GCP — 216 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: GCP
  order: 16
...
توفر [أيقونات معمارية GCP](https://cloud.google.com/icons) 216 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ Google Cloud. استخدم مكوّن `Icon` من `@f5-sales-demo/icons-gcp` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 24×24 مع تعبئات مدمجة.
...
تستخدم هذه الأيقونات ألوان البائع الأصلية (وليس `currentColor`). الألوان مضمّنة في ترميز SVG وتُحفظ في وضع الإضاءة والوضع المظلم على حدٍّ سواء.
...
للاطلاع على القائمة الكاملة لـ 216 أيقونة معمارية من GCP، تفضل بزيارة صفحة [أيقونات معمارية Google Cloud](https://cloud.google.com/icons).

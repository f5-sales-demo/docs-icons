...
توفر [أيقونات بنية GCP](https://cloud.google.com/icons) 216 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ Google Cloud. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-gcp` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 24×24 مع تعبئات مضمّنة.
...
تستخدم هذه الأيقونات الألوان الأصلية للمورّد (وليس `currentColor`). الألوان مضمّنة في ترميز SVG ومحفوظة في كلا الوضعين الفاتح والداكن.

...
توفر [أيقونات بنية GCP](https://cloud.google.com/icons) عدد 216 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ Google Cloud. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-gcp` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 24×24 مع تعبئة مضمّنة.
...
للاطلاع على القائمة الكاملة لـ 216 أيقونة بنية GCP، قم بزيارة صفحة [أيقونات بنية Google Cloud](https://cloud.google.com/icons).

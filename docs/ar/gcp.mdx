---
title: أيقونات بنية GCP
description: >-
  مرجع منسّق لأيقونات بنية GCP — 216 أيقونة خدمة ملونة لمخططات البنية التحتية
  السحابية والتوثيق.
sidebar:
  label: GCP
  order: 16
...
توفر [أيقونات بنية GCP](https://cloud.google.com/icons) عدد 216 أيقونة خدمة ملونة لتوثيق البنية التحتية لـ Google Cloud. استخدم مكوّن `Icon` من `@f5xc-salesdemos/icons-gcp` لعرض أي أيقونة بالاسم. الحجم الافتراضي هو 24×24 مع تعبئات مضمّنة.
...
تستخدم هذه الأيقونات ألوان المورّد الأصلية (وليس `currentColor`). الألوان مضمّنة في ترميز SVG ومحفوظة في كلٍّ من الوضع الفاتح والداكن.
...
للاطلاع على القائمة الكاملة لأيقونات بنية GCP البالغ عددها 216 أيقونة، قم بزيارة صفحة [أيقونات بنية Google Cloud](https://cloud.google.com/icons).

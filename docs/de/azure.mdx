...
description: >-
  Kuratierte Referenz für Azure Architecture Icons — 606 farbige Dienst-Icons
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) stellt 606 farbige Dienst-Icons zur Dokumentation von Azure-Infrastruktur bereit. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-azure`, um ein beliebiges Icon nach Name zu rendern. Die Standardgröße beträgt 18x18 mit Verlaufsfüllungen.
...
Diese Icons verwenden die originalen Herstellerfarben (nicht `currentColor`). Die Farben sind im SVG-Markup eingebettet und bleiben sowohl im hellen als auch im dunklen Modus erhalten.
...
Die vollständige Liste mit 606 Azure Architecture Icons finden Sie auf der Seite [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

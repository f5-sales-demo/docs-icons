...
description: >-
  Kuratierte Referenz für Azure Architecture Icons — 606 farbige Service-Icons
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) stellt 606 farbige Service-Icons für die Dokumentation von Azure-Infrastruktur bereit. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-azure`, um ein beliebiges Icon anhand seines Namens darzustellen. Die Standardgröße beträgt 18x18 mit Verlaufsfüllungen.
...
Diese Icons verwenden die Original-Herstellerfarben (nicht `currentColor`). Die Farben sind im SVG-Markup eingebettet und werden sowohl im hellen als auch im dunklen Modus beibehalten.
...
Die vollständige Liste aller 606 Azure Architecture Icons finden Sie auf der Seite [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

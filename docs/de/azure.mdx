---
title: Azure-Architektur-Symbole
description: >-
  Kuratierte Referenz für Azure-Architektur-Symbole — 606 farbige Dienstsymbole
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) bietet 606 farbige Dienstsymbole zur Dokumentation von Azure-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-azure`, um jedes Symbol nach Name darzustellen. Die Standardgröße beträgt 18x18 mit Verlaufsfüllungen.
...
Diese Symbole verwenden die originalen Herstellerfarben (nicht `currentColor`). Die Farben sind in das SVG-Markup eingebettet und werden sowohl im hellen als auch im dunklen Modus beibehalten.
...
Die vollständige Liste aller 606 Azure-Architektur-Symbole finden Sie auf der Seite [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

---
title: Azure-Architektur-Icons
description: >-
  Kuratierte Referenz für Azure-Architektur-Icons — 606 farbige Dienst-Icons für
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) bietet 606 farbige Dienst-Icons zur Dokumentation von Azure-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-azure`, um jedes Icon anhand seines Namens darzustellen. Die Standardgröße beträgt 18x18 mit Verlaufsfüllungen.
...
Die vollständige Liste aller 606 Azure-Architektur-Icons finden Sie auf der Seite [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) bietet 7.638 Symbole mit gefüllten und umrandeten Varianten, die nahezu jeden Anwendungsfall abdecken. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-mdi`, um ein beliebiges Symbol nach Name darzustellen.

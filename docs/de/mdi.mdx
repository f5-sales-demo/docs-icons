...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) bietet 7.638 Icons mit gefüllten und umrandeten Varianten, die nahezu jeden Anwendungsfall abdecken. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-mdi`, um ein beliebiges Icon nach Name darzustellen.
...
Die vollständige Liste mit 7.638 Material Design Icons finden Sie im [Iconify MDI-Explorer](https://icon-sets.iconify.design/mdi/).

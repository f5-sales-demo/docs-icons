...
description: >-
  Kuratierte Referenz für Material Design Icons — 7.638 ausgefüllte und
  umrandete Icons, verfügbar über die Icon-Komponente.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) bietet 7.638 Icons mit ausgefüllten und umrandeten Varianten, die praktisch jeden Anwendungsfall abdecken. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-mdi`, um jedes Icon anhand seines Namens darzustellen.
...
Für die vollständige Liste aller 7.638 Material Design Icons besuchen Sie den [Iconify MDI Explorer](https://icon-sets.iconify.design/mdi/).

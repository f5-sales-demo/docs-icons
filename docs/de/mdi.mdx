...
description: >-
  ...
  Icons, verfügbar über die Icon-Komponente.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) bietet 7.638 Icons mit gefüllten und umrandeten Varianten, die praktisch jeden Anwendungsfall abdecken. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-mdi`, um ein beliebiges Icon anhand seines Namens darzustellen.

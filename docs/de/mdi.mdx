...
description: >-
  Kuratierte Referenz für Material Design Icons — 7.638 gefüllte und umrandete
  Symbole, verfügbar über die Icon-Komponente.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) bietet 7.638 Symbole mit gefüllten und umrandeten Varianten, die nahezu jeden Anwendungsfall abdecken. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-mdi`, um ein beliebiges Symbol nach Name darzustellen.
...
Symbole werden als inline SVGs mit `currentColor` gerendert — sie passen sich automatisch an den Hell- und Dunkelmodus an.
...
Die vollständige Liste aller 7.638 Material Design Icons finden Sie im [Iconify MDI Explorer](https://icon-sets.iconify.design/mdi/).

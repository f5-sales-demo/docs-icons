...
title: Tabler Icons
description: >-
  Kuratierte Referenz für Tabler Icons — 6.034 klare Liniensymbole mit
  einheitlicher Strichstärke, verfügbar über die Icon-Komponente.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) bietet 6.034 klare Liniensymbole mit einer einheitlichen Strichstärke von 2px. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-tabler`, um ein beliebiges Symbol anhand seines Namens darzustellen.

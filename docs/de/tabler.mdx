...
title: Tabler Icons
description: >-
  Kuratierte Referenz für Tabler Icons — 6.034 gestochen scharfe Linien-Icons
  mit einheitlicher Strichbreite, verfügbar über die Icon-Komponente.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) bietet 6.034 gestochen scharfe Linien-Icons mit einer einheitlichen Strichbreite von 2px. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-tabler`, um ein beliebiges Icon per Name darzustellen.
...
Die vollständige Liste mit 6.034 Tabler Icons finden Sie im [Iconify Tabler Explorer](https://icon-sets.iconify.design/tabler/).

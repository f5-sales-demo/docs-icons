...
description: >-
  ...
  mit einheitlicher Strichstärke, verfügbar über die Icon-Komponente.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) bietet 6.034 gestochen scharfe Linien-Icons mit einer einheitlichen Strichstärke von 2px. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-tabler`, um jedes Icon anhand seines Namens darzustellen.
...
Die vollständige Liste aller 6.034 Tabler Icons finden Sie im [Iconify Tabler Explorer](https://icon-sets.iconify.design/tabler/).

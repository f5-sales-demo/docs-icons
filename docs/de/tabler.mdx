...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) bietet 6.034 gestochen scharfe Linien-Icons mit einer einheitlichen Strichbreite von 2px. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-tabler`, um ein beliebiges Icon per Name darzustellen.

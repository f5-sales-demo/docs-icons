...
Vollständige visuelle Referenz für jedes Icon im Paket [`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc). Diese 30 Icons repräsentieren F5 Distributed Cloud Services und sind als Iconify JSON mit einer Astro-Komponente verfügbar.
...
:::note[Dunkelmodus]
Diese mehrfarbigen Icons verwenden CSS Custom Properties (`--color-N600`, `--color-brand`, `--color-blue-light`, `--color-N200`), die sich automatisch an den hellen und dunklen Modus anpassen. Navy und Hellblau werden im Dunkelmodus getauscht, während der rote F5-Akzent konstant bleibt.
:::

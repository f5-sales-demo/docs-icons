...
Phosphor Icons gibt es in sechs Gewichten. Das reguläre Gewicht verwendet den Basisnamen (z. B. `globe`). Andere Gewichte fügen ein Suffix an: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Die folgenden Beispiele zeigen das reguläre Gewicht.
:::

...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) bietet 9.161 Icons mit flexiblen Gewichtsoptionen — regular, bold, duotone, fill, light und thin. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-phosphor`, um ein beliebiges Icon anhand seines Namens darzustellen.
...
Phosphor-Icons sind in sechs Gewichten erhältlich. Das reguläre Gewicht verwendet den Basisnamen (z. B. `globe`). Andere Gewichte fügen ein Suffix hinzu: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Die folgenden Beispiele zeigen das reguläre Gewicht.
:::

...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) bietet 9.161 Icons mit flexiblen Gewichtsoptionen — regular, bold, duotone, fill, light und thin. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-phosphor`, um jedes Icon anhand seines Namens darzustellen.
...
Phosphor Icons gibt es in sechs Gewichtungen. Die reguläre Gewichtung verwendet den Basisnamen (z. B. `globe`). Andere Gewichtungen fügen ein Suffix hinzu: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Die folgenden Beispiele zeigen die reguläre Gewichtung.
:::

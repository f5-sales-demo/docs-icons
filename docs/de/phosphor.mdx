...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) bietet 9.161 Icons mit flexiblen Gewichtsoptionen — regular, bold, duotone, fill, light und thin. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-phosphor`, um jedes Icon nach Name zu rendern.
...
Phosphor Icons sind in sechs Gewichten verfügbar. Das reguläre Gewicht verwendet den Basisnamen (z. B. `globe`). Andere Gewichte hängen ein Suffix an: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Die folgenden Beispiele zeigen das reguläre Gewicht.
:::
...
Für die vollständige Liste der 9.161 Phosphor Icons (über alle Gewichtsvarianten hinweg) besuchen Sie den [Iconify Phosphor Explorer](https://icon-sets.iconify.design/ph/).

...
description: >-
  Kuratierte Referenz für AWS Architecture Icons — 885 farbige Dienst-Icons für
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) bietet 885 farbige Dienst-Icons zur Dokumentation von AWS-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-aws`, um ein beliebiges Icon anhand seines Namens darzustellen. Die Standardgröße beträgt 48x48, mit individuellen Größenüberschreibungen pro Icon.

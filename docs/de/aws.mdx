---
title: AWS-Architektur-Icons
description: >-
  Kuratierte Referenz für AWS-Architektur-Icons — 885 farbige Service-Icons für
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) stellt 885 farbige Service-Icons zur Dokumentation von AWS-Infrastruktur bereit. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-aws`, um ein beliebiges Icon anhand seines Namens darzustellen. Die Standardgröße beträgt 48x48 mit individuellen Größenüberschreibungen pro Icon.
...
Die vollständige Liste aller 885 AWS-Architektur-Icons finden Sie unter [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

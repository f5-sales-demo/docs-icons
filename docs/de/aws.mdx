---
title: AWS-Architektur-Symbole
description: >-
  Kuratierte Referenz für AWS-Architektur-Symbole — 885 farbige Dienstsymbole
  für Cloud-Infrastrukturdiagramme und Dokumentation.
sidebar:
  label: AWS
  order: 14
i18n:
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) bietet 885 farbige Dienstsymbole zur Dokumentation von AWS-Infrastrukturen. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-aws`, um beliebige Symbole nach Namen zu rendern. Die Standardgröße beträgt 48x48 mit symbolspezifischen Größenüberschreibungen.
...
Diese Symbole verwenden die originalen Herstellerfarben (nicht `currentColor`). Die Farben sind im SVG-Markup eingebettet und werden sowohl im hellen als auch im dunklen Modus beibehalten.
...
## Alle Symbole durchsuchen

Die vollständige Liste mit 885 AWS-Architektur-Symbolen finden Sie unter [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

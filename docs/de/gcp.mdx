...
[GCP Architecture Icons](https://cloud.google.com/icons) bietet 216 farbige Service-Icons zur Dokumentation der Google Cloud-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-gcp`, um jedes Icon anhand seines Namens darzustellen. Die Standardgröße beträgt 24x24 mit eingebetteten Füllungen.
...
Für die vollständige Liste aller 216 GCP-Architektur-Icons besuchen Sie die Seite [Google Cloud Architecture Icons](https://cloud.google.com/icons).

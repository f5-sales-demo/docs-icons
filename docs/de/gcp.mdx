...
description: >-
  Kuratierte Referenz für GCP Architecture Icons — 216 farbige Service-Icons für
...
[GCP Architecture Icons](https://cloud.google.com/icons) bietet 216 farbige Service-Icons zur Dokumentation von Google Cloud-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-gcp`, um jedes Icon nach Name darzustellen. Die Standardgröße beträgt 24x24 mit eingebetteten Füllungen.
...
Diese Icons verwenden die ursprünglichen Herstellerfarben (nicht `currentColor`). Die Farben sind im SVG-Markup eingebettet und werden sowohl im hellen als auch im dunklen Modus beibehalten.
...
Die vollständige Liste aller 216 GCP Architecture Icons finden Sie auf der Seite [Google Cloud Architecture Icons](https://cloud.google.com/icons).

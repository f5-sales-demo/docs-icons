---
title: GCP-Architektur-Icons
description: >-
  Kuratierte Referenz für GCP-Architektur-Icons — 216 farbige Service-Icons für
...
[GCP Architecture Icons](https://cloud.google.com/icons) stellt 216 farbige Service-Icons zur Dokumentation von Google-Cloud-Infrastruktur bereit. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-gcp`, um jedes Icon anhand seines Namens darzustellen. Die Standardgröße beträgt 24x24 mit eingebetteten Füllfarben.
...
Diese Icons verwenden die Original-Herstellerfarben (nicht `currentColor`). Die Farben sind im SVG-Markup eingebettet und bleiben sowohl im hellen als auch im dunklen Modus erhalten.
...
Die vollständige Liste aller 216 GCP-Architektur-Icons finden Sie auf der Seite [Google Cloud Architecture Icons](https://cloud.google.com/icons).

...
description: >-
  Kuratierte Referenz für GCP-Architektur-Symbole — 216 farbige Dienst-Symbole
...
[GCP Architecture Icons](https://cloud.google.com/icons) bietet 216 farbige Dienst-Symbole zur Dokumentation der Google Cloud-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-gcp`, um ein beliebiges Symbol nach Name zu rendern. Die Standardgröße beträgt 24x24 mit eingebetteten Füllungen.
...
Diese Symbole verwenden die originalen Anbieterfarben (nicht `currentColor`). Die Farben sind im SVG-Markup eingebettet und werden sowohl im hellen als auch im dunklen Modus beibehalten.
...
Die vollständige Liste mit 216 GCP-Architektur-Symbolen finden Sie auf der Seite [Google Cloud Architecture Icons](https://cloud.google.com/icons).

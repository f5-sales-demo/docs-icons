---
title: GCP-Architektur-Symbole
description: >-
  Kuratierte Referenz für GCP-Architektur-Symbole — 216 farbige Dienstsymbole
...
[GCP Architecture Icons](https://cloud.google.com/icons) bietet 216 farbige Dienstsymbole zur Dokumentation der Google Cloud-Infrastruktur. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-gcp`, um ein beliebiges Symbol nach Name zu rendern. Die Standardgröße beträgt 24x24 mit eingebetteten Füllungen.
...
Diese Symbole verwenden die ursprünglichen Herstellerfarben (nicht `currentColor`). Die Farben sind in das SVG-Markup eingebettet und bleiben sowohl im hellen als auch im dunklen Modus erhalten.
...
Die vollständige Liste aller 216 GCP-Architektur-Symbole finden Sie auf der Seite [Google Cloud Architecture Icons](https://cloud.google.com/icons).

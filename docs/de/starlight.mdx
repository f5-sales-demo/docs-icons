...
| `label` | `string` | — | Barrierefreies Label für Screenreader. Verwenden Sie es für bedeutungstragende Icons; lassen Sie es bei dekorativen Icons weg. |
...
Fügen Sie ein `label`-Prop hinzu, wenn ein Icon eine Bedeutung vermittelt (z. B. ein Link-Icon). Lassen Sie `label` bei rein dekorativen Icons weg — Starlight verbirgt sie automatisch vor unterstützenden Technologien.
:::

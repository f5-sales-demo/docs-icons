...
[Lucide](https://lucide.dev/) bietet ca. 1.600 moderne, einheitliche Strich-Icons. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-lucide`, um jedes Icon nach Name zu rendern.
...
Die vollständige Liste der ca. 1.600 Lucide-Icons finden Sie unter [lucide.dev/icons](https://lucide.dev/icons/).

...
title: Lucide Icons
description: >-
  Kuratierte Referenz für Lucide-Icons — über 1.600 moderne Stroke-Icons,
...
[Lucide](https://lucide.dev/) bietet ~1.600 moderne, konsistente Stroke-Icons. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-lucide`, um ein beliebiges Icon per Name zu rendern.

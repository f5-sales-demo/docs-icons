...
[Lucide](https://lucide.dev/) bietet ~1.600 moderne, konsistente Stroke-Icons. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-lucide`, um ein beliebiges Icon per Name zu rendern.

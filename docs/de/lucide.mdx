...
[Lucide](https://lucide.dev/) bietet ca. 1.600 moderne, konsistente Strich-Icons. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-lucide`, um jedes Icon anhand seines Namens darzustellen.
...
Die vollständige Liste mit ca. 1.600 Lucide-Icons finden Sie unter [lucide.dev/icons](https://lucide.dev/icons/).

...
[Lucide](https://lucide.dev/) bietet ~1.600 moderne, konsistente Strich-Icons. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-lucide`, um ein beliebiges Icon per Name darzustellen.
...
Die vollständige Liste mit ~1.600 Lucide-Icons finden Sie unter [lucide.dev/icons](https://lucide.dev/icons/).

...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) bietet 2.582 klare, konturierte Icons aus IBMs Unternehmens-Designsprache. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-carbon`, um jedes Icon anhand seines Namens darzustellen.

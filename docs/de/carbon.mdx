...
title: Carbon Icons
description: >-
  Kuratierte Referenz für Carbon Icons — 2.582 unternehmenstaugliche Icons aus
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) bietet 2.582 klare, umrandete Icons aus IBMs Enterprise-Designsprache. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-carbon`, um ein beliebiges Icon anhand seines Namens darzustellen.
...
Die vollständige Liste aller 2.582 Carbon Icons finden Sie im [Iconify Carbon Explorer](https://icon-sets.iconify.design/carbon/).

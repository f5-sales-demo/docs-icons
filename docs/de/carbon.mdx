...
title: Carbon Icons
description: >-
  Kuratierte Referenz für Carbon Icons — 2.582 Enterprise-Grade-Icons aus IBMs
  Designsprache, verfügbar über die Icon-Komponente.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) bietet 2.582 klare, konturierte Icons aus IBMs Enterprise-Designsprache. Verwenden Sie die `Icon`-Komponente aus `@f5xc-salesdemos/icons-carbon`, um jedes Icon anhand seines Namens darzustellen.

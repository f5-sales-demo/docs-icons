...
title: Carbon Icons
description: >-
  Kuratierte Referenz für Carbon Icons — 2.582 unternehmensgerechte Icons aus
  IBMs Designsprache, verfügbar über die Icon-Komponente.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) bietet 2.582 klare, umrissbasierte Icons aus IBMs Enterprise-Designsprache. Verwenden Sie die `Icon`-Komponente aus `@f5-sales-demo/icons-carbon`, um ein beliebiges Icon nach Name darzustellen.
...
Die vollständige Liste mit 2.582 Carbon Icons finden Sie im [Iconify Carbon Explorer](https://icon-sets.iconify.design/carbon/).

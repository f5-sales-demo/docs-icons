...
title: Icon-Referenz
description: >-
  Übersicht aller verfügbaren Icon-Pakete im Dokumentationsthema — Verwendung,
  Verhalten im Dunkelmodus und Auswahlhilfe.
sidebar:
  label: Übersicht
  order: 2
i18n:
...
Das Dokumentationsthema bietet Zugriff auf Tausende von Icons aus mehreren Paketen. Jedes Paket verwendet dasselbe Muster: Importieren Sie die `Icon.astro`-Komponente des Pakets und referenzieren Sie Icons über ihren Namen.
...
## Verhalten bei Dunkel-/Hellmodus
...
| IBM Design-Sprache | Carbon | 2.582 Icons in Enterprise-Qualität |

...
title: Icon-Referenz
description: >-
  Übersicht über alle im Dokumentationstheme verfügbaren Icon-Pakete —
  Verwendung, Dark-Mode-Verhalten und Auswahlhilfe.
sidebar:
  label: Übersicht
  order: 2
i18n:
...
Das Dokumentationstheme bietet Zugriff auf Tausende von Icons aus mehreren Paketen. Jedes Paket verwendet dasselbe Muster: Importieren Sie die `Icon.astro`-Komponente des Pakets und referenzieren Sie Icons über ihren Namen.
...
Icons verwenden `currentColor` und passen sich automatisch an den hellen und dunklen Modus an, ohne dass eine spezielle Behandlung erforderlich ist.
...
| Gefüllte/umrandete Icons in großer Auswahl | Material Design (mdi) | Größtes Set mit 7.638 Icons |
| IBM-Designsprache | Carbon | 2.582 Enterprise-Grade Icons |
| Flexible Stärkeoptionen | Phosphor | 9.161 Icons mit sechs Gewichtsvarianten |
| Klare Linien-Icons | Tabler | 6.034 Icons mit konsistentem 2px-Strich |

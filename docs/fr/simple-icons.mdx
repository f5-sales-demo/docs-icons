...
title: Simple Icons
description: >-
  Plus de 3 200 icônes de marques pour des entreprises, services et technologies
...
Simple Icons fournit plus de 3 200 icônes SVG gratuites pour des marques populaires, notamment des fournisseurs réseau, des fournisseurs cloud, des entreprises de télécommunications et des services technologiques. Toutes les icônes utilisent un viewBox standard de 24x24.
...
Parcourir les plus de 3 200 icônes : [Site web Simple Icons](https://simpleicons.org/) | [Explorateur Iconify](https://icon-sets.iconify.design/simple-icons/)

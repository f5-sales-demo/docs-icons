...
title: Simple Icons
description: >-
  Plus de 3 200 icônes de marques pour les entreprises, services et technologies
  populaires, issues du projet Simple Icons.
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons fournit plus de 3 200 icônes SVG gratuites pour les marques populaires, notamment les fournisseurs réseau, les fournisseurs cloud, les opérateurs de télécommunications et les services technologiques. Toutes les icônes utilisent un viewBox standard de 24x24.
...
## Télécoms et Fournisseurs de Services
...
Parcourir les 3 200+ icônes : [Site Simple Icons](https://simpleicons.org/) | [Explorateur Iconify](https://icon-sets.iconify.design/simple-icons/)

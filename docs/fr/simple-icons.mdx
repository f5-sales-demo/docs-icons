...
Simple Icons fournit plus de 3 200 icônes SVG gratuites pour les marques populaires, notamment les fournisseurs réseau, les fournisseurs cloud, les opérateurs télécom et les services technologiques. Toutes les icônes utilisent un viewBox standard de 24x24.
...
## Opérateurs télécom et fournisseurs de services
...
Parcourir l'ensemble des 3 200+ icônes : [Site web Simple Icons](https://simpleicons.org/) | [Explorateur Iconify](https://icon-sets.iconify.design/simple-icons/)

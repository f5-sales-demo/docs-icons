...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fournit 6 034 icônes en trait fin avec une largeur de trait uniforme de 2 px. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-tabler` pour afficher n'importe quelle icône par son nom.

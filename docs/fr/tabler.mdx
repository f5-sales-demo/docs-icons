...
title: Tabler Icons
description: >-
  Référence organisée pour les icônes Tabler — 6 034 icônes en trait fin avec
  une largeur de trait uniforme, disponibles via le composant Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fournit 6 034 icônes en trait fin avec une largeur de trait uniforme de 2 px. Utilisez le composant `Icon` de `@f5-sales-demo/icons-tabler` pour afficher n'importe quelle icône par son nom.
...
Pour la liste complète des 6 034 icônes Tabler, consultez l'[explorateur Iconify Tabler](https://icon-sets.iconify.design/tabler/).

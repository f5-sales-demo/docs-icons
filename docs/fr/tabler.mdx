...
title: Tabler Icons
description: >-
  Référence organisée pour les Tabler Icons — 6 034 icônes de trait nettes avec
  une épaisseur de trait uniforme disponibles via le composant Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fournit 6 034 icônes de trait nettes avec une épaisseur de trait uniforme de 2 px. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-tabler` pour afficher n'importe quelle icône par son nom.
...
Pour la liste complète des 6 034 Tabler Icons, consultez l'[explorateur Iconify Tabler](https://icon-sets.iconify.design/tabler/).

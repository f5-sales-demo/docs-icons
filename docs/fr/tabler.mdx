...
title: Icônes Tabler
description: >-
  Référence organisée pour les icônes Tabler — 6 034 icônes linéaires nettes
  avec une épaisseur de trait cohérente, disponibles via le composant Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fournit 6 034 icônes linéaires nettes avec une épaisseur de trait cohérente de 2px. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-tabler` pour afficher n'importe quelle icône par son nom.
...
Pour la liste complète des 6 034 icônes Tabler, visitez l'[explorateur Tabler sur Iconify](https://icon-sets.iconify.design/tabler/).

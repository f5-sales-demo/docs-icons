...
description: >-
  Référence organisée pour les icônes d'architecture GCP — 216 icônes de
  services en couleur pour les diagrammes et la documentation d'infrastructure
  cloud.
sidebar:
  label: GCP
  order: 16
...
[GCP Architecture Icons](https://cloud.google.com/icons) fournit 216 icônes de services en couleur pour documenter l'infrastructure Google Cloud. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-gcp` pour afficher n'importe quelle icône par son nom. La taille par défaut est de 24x24 avec des remplissages en ligne.

...
description: >-
  Référence sélectionnée pour les icônes d'architecture GCP — 216 icônes de
...
[GCP Architecture Icons](https://cloud.google.com/icons) fournit 216 icônes de services en couleur pour documenter l'infrastructure Google Cloud. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-gcp` pour afficher n'importe quelle icône par son nom. La taille par défaut est 24x24 avec des remplissages intégrés.

...
description: >-
  Référence visuelle complète pour les 672 icônes HashiCorp Flight du paquet
...
Référence visuelle complète pour chaque icône du paquet [`@f5-sales-demo/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5-sales-demo/icons-hashicorp-flight). Les icônes sont rendues via le composant `Icon` et organisées par catégorie.
...
Les icônes sont rendues sous forme de SVG en ligne utilisant `currentColor` — les icônes monochromes s'adaptent automatiquement aux modes clair et sombre. Les variantes en couleur conservent leurs couleurs d'origine.

:::note[Mode sombre]
Les icônes monochromes utilisent `currentColor` et s'adaptent automatiquement. Les variantes en couleur (icônes se terminant par `-color`) conservent leurs couleurs d'origine via la classe `no-invert`.
:::

---
title: Icônes HashiCorp Flight
description: >-
  Référence visuelle pour les 672 icônes HashiCorp Flight de
...
Référence visuelle complète pour chaque icône du package [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). Les icônes sont rendues via le composant `Icon` et organisées par catégorie.
...
Les icônes sont rendues en tant que SVG en ligne utilisant `currentColor` — les icônes monochromes s'adaptent automatiquement aux modes clair et sombre. Les variantes en couleur conservent leurs couleurs d'origine.

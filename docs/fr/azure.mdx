...
Ces icônes utilisent les couleurs d'origine du fournisseur (pas `currentColor`). Les couleurs sont intégrées dans le balisage SVG et préservées en mode clair comme en mode sombre.

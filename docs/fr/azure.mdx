...
description: >-
  Référence organisée pour les icônes d'architecture Azure — 606 icônes de
  services en couleur pour les diagrammes d'infrastructure cloud et la
  documentation.
sidebar:
  label: Azure
  order: 15
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) fournit 606 icônes de services en couleur pour documenter l'infrastructure Azure. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-azure` pour afficher n'importe quelle icône par son nom. La taille par défaut est de 18x18 avec des remplissages en dégradé.

...
description: >-
  Référence organisée pour les icônes d'architecture AWS — 885 icônes de
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) fournit 885 icônes de services en couleur pour documenter l'infrastructure AWS. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-aws` pour afficher n'importe quelle icône par son nom. La taille par défaut est 48x48 avec des redimensionnements possibles par icône.
...
Ces icônes utilisent les couleurs originales du fournisseur (et non `currentColor`). Les couleurs sont intégrées dans le balisage SVG et préservées en mode clair comme en mode sombre.

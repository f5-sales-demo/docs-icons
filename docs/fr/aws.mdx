...
Pour la liste complète des 885 icônes d'architecture AWS, visitez [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

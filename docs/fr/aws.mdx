---
title: Icônes d'architecture AWS
description: >-
  Référence sélectionnée pour les icônes d'architecture AWS — 885 icônes de
  services en couleur pour les schémas d'infrastructure cloud et la
  documentation.
sidebar:
  label: AWS
  order: 14
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) fournit 885 icônes de services en couleur pour documenter l'infrastructure AWS. Utilisez le composant `Icon` de `@f5-sales-demo/icons-aws` pour afficher n'importe quelle icône par son nom. La taille par défaut est de 48x48 avec des remplacements de taille par icône.
...
Pour la liste complète des 885 icônes d'architecture AWS, consultez [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

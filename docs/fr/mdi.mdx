---
title: Icônes Material Design
description: >-
  Référence organisée pour les icônes Material Design — 7 638 icônes pleines et
  contourées disponibles via le composant Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fournit 7 638 icônes avec des variantes pleines et contourées couvrant pratiquement tous les cas d'utilisation. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-mdi` pour afficher n'importe quelle icône par son nom.
...
Pour la liste complète des 7 638 icônes Material Design, consultez l'[explorateur Iconify MDI](https://icon-sets.iconify.design/mdi/).

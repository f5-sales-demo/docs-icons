...
description: >-
  Référence sélectionnée pour les Material Design Icons — 7 638 icônes pleines
  et en contour disponibles via le composant Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fournit 7 638 icônes avec des variantes pleines et en contour couvrant pratiquement tous les cas d'utilisation. Utilisez le composant `Icon` de `@f5-sales-demo/icons-mdi` pour afficher n'importe quelle icône par son nom.
...
Les icônes s'affichent en tant que SVG intégrés utilisant `currentColor` — elles s'adaptent automatiquement aux modes clair et sombre.
...
Pour la liste complète des 7 638 Material Design Icons, visitez l'[explorateur Iconify MDI](https://icon-sets.iconify.design/mdi/).

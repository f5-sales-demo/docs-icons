...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fournit 7 638 icônes avec des variantes pleines et en contour couvrant pratiquement tous les cas d'utilisation. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-mdi` pour afficher n'importe quelle icône par son nom.
...
Les icônes sont rendues sous forme de SVG en ligne en utilisant `currentColor` — elles s'adaptent automatiquement aux modes clair et sombre.

...
description: >-
  Référence organisée pour les Material Design Icons — 7 638 icônes pleines et
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fournit 7 638 icônes avec des variantes pleines et contourées couvrant pratiquement tous les cas d'utilisation. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-mdi` pour afficher n'importe quelle icône par nom.

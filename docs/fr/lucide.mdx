...
title: Icônes Lucide
description: >-
  Référence sélectionnée pour les icônes Lucide — plus de 1 600 icônes modernes
  à trait disponibles via le composant Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) fournit environ 1 600 icônes à trait modernes et cohérentes. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-lucide` pour afficher n'importe quelle icône par son nom.
...
Pour la liste complète des quelque 1 600 icônes Lucide, visitez [lucide.dev/icons](https://lucide.dev/icons/).

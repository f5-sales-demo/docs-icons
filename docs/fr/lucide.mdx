...
Les icônes sont rendues en tant que SVG inline utilisant `currentColor` — elles s'adaptent automatiquement aux modes clair et sombre.
...
Pour la liste complète d'environ 1 600 icônes Lucide, visitez [lucide.dev/icons](https://lucide.dev/icons/).

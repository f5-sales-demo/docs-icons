...
title: Icônes Lucide
description: >-
  Référence organisée pour les icônes Lucide — plus de 1 600 icônes modernes à
  contour disponibles via le composant Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) fournit environ 1 600 icônes modernes et cohérentes à contour. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-lucide` pour afficher n'importe quelle icône par son nom.
...
Les icônes sont rendues sous forme de SVG en ligne utilisant `currentColor` — elles s'adaptent automatiquement aux modes clair et sombre.
...
Pour la liste complète des environ 1 600 icônes Lucide, visitez [lucide.dev/icons](https://lucide.dev/icons/).

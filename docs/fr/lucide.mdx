...
[Lucide](https://lucide.dev/) fournit environ 1 600 icônes à trait modernes et cohérentes. Utilisez le composant `Icon` de `@f5-sales-demo/icons-lucide` pour afficher n'importe quelle icône par son nom.

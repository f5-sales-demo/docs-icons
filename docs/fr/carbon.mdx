...
title: Icônes Carbon
description: >-
  Référence organisée pour les icônes Carbon — 2 582 icônes de qualité
  professionnelle issues du langage de design d'IBM, disponibles via le
  composant Icon.
sidebar:
  label: Carbon
  order: 7
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fournit 2 582 icônes épurées et en contour, issues du langage de design d'entreprise d'IBM. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-carbon` pour afficher n'importe quelle icône par son nom.

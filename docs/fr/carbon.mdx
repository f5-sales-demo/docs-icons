...
title: Carbon Icons
description: >-
  Référence sélectionnée pour les Carbon Icons — 2 582 icônes de qualité
  entreprise issues du langage de conception IBM, disponibles via le composant
  Icon.
sidebar:
  label: Carbon
  order: 7
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fournit 2 582 icônes épurées et en contour issues du langage de conception d'entreprise IBM. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-carbon` pour afficher n'importe quelle icône par son nom.
...
Les icônes sont rendues en SVG en ligne avec `currentColor` — elles s'adaptent automatiquement aux modes clair et sombre.
...
Pour la liste complète des 2 582 Carbon Icons, visitez l'[explorateur Iconify Carbon](https://icon-sets.iconify.design/carbon/).

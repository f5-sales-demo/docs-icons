...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fournit 2 582 icônes épurées et en contour issues du langage de conception d'entreprise d'IBM. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-carbon` pour afficher n'importe quelle icône par son nom.

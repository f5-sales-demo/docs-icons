...
title: Carbon Icons
description: >-
  Référence organisée pour Carbon Icons — 2 582 icônes de qualité entreprise
  issues du langage de design d'IBM, disponibles via le composant Icon.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fournit 2 582 icônes épurées et en contour issues du langage de design entreprise d'IBM. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-carbon` pour afficher n'importe quelle icône par son nom.
...
Pour la liste complète des 2 582 icônes Carbon, consultez l'[explorateur Carbon sur Iconify](https://icon-sets.iconify.design/carbon/).

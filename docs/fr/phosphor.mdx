...
Les icônes Phosphor existent en six poids. Le poids regular utilise le nom de base (par ex. `globe`). Les autres poids ajoutent un suffixe : `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Les exemples ci-dessous montrent le poids regular.
:::
...
Pour la liste complète des 9 161 icônes Phosphor (dans toutes les variantes de poids), visitez l'[explorateur Phosphor sur Iconify](https://icon-sets.iconify.design/ph/).

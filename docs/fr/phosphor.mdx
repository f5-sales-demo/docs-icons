...
description: >-
  ...
  de poids flexibles disponibles via le composant Icon.
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) fournit 9 161 icônes avec des options de poids flexibles — regular, bold, duotone, fill, light et thin. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-phosphor` pour afficher n'importe quelle icône par son nom.
...
:::note[Variantes de poids]
Les icônes Phosphor sont disponibles en six poids. Le poids regular utilise le nom de base (par ex. `globe`). Les autres poids ajoutent un suffixe : `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Les exemples ci-dessous montrent le poids regular.
:::
...
Pour la liste complète des 9 161 icônes Phosphor (à travers toutes les variantes de poids), visitez l'[explorateur Phosphor sur Iconify](https://icon-sets.iconify.design/ph/).

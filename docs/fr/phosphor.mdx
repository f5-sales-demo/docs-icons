---
title: Icônes Phosphor
description: >-
  Référence sélectionnée pour les icônes Phosphor — 9 161 icônes avec des
  variantes de graisse flexibles disponibles via le composant Icon.
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) fournit 9 161 icônes avec des options de graisse flexibles — regular, bold, duotone, fill, light et thin. Utilisez le composant `Icon` de `@f5xc-salesdemos/icons-phosphor` pour afficher n'importe quelle icône par son nom.
...
Les icônes Phosphor sont disponibles en six graisses. La graisse regular utilise le nom de base (ex. `globe`). Les autres graisses ajoutent un suffixe : `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Les exemples ci-dessous montrent la graisse regular.
:::
...
Pour la liste complète des 9 161 icônes Phosphor (dans toutes les variantes de graisse), visitez l'[explorateur Iconify Phosphor](https://icon-sets.iconify.design/ph/).

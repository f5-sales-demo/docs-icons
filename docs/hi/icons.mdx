...
डॉक्यूमेंटेशन थीम कई पैक से हजारों आइकन तक पहुँच प्रदान करती है। प्रत्येक पैक एक ही पैटर्न का उपयोग करता है: पैक के `Icon.astro` कंपोनेंट को इम्पोर्ट करें और आइकन को नाम से संदर्भित करें।
...
F5 XC सर्विस आइकन CSS कस्टम प्रॉपर्टीज़ का उपयोग करते हैं जो स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित हो जाती हैं — किसी विशेष क्लास हैंडलिंग की आवश्यकता नहीं है। अन्य मल्टी-कलर आइकन (जैसे HashiCorp Flight कलर वेरिएंट) के लिए, `.icon-card-image` पर `no-invert` क्लास डार्क मोड में मूल रंगों को संरक्षित रखती है।

## कौन सा पैक उपयोग करें?

| उपयोग का मामला | अनुशंसित पैक | कारण |
|----------|------------------|-----|
| सामान्य UI (एरो, क्लोज, सर्च) | Starlight बिल्ट-इन | शून्य कॉन्फ़िग, हमेशा उपलब्ध |
| F5 प्रोडक्ट डायग्राम | F5 ब्रांड | डोमेन-विशिष्ट नेटवर्किंग/सिक्योरिटी आर्ट |
| आधुनिक स्ट्रोक आइकन | Lucide | स्वच्छ, सुसंगत 1,600+ आइकन |
| बड़े पैमाने पर फिल्ड/आउटलाइंड आइकन | Material Design (mdi) | 7,638 आइकन के साथ सबसे बड़ा सेट |
| IBM डिज़ाइन भाषा | Carbon | 2,582 एंटरप्राइज़-ग्रेड आइकन |
| लचीले वेट विकल्प | Phosphor | छह वेट वेरिएंट के साथ 9,161 आइकन |
| स्पष्ट लाइन आइकन | Tabler | सुसंगत 2px स्ट्रोक के साथ 6,034 आइकन |
| F5 XC सर्विस डायग्राम | F5 XC सर्विसेज | 30 डिस्ट्रीब्यूटेड क्लाउड सर्विस आइकन |
...
| AWS आर्किटेक्चर डायग्राम | AWS आर्किटेक्चर | AWS इंफ्रास्ट्रक्चर के लिए 885 कलर सर्विस आइकन |
| Azure आर्किटेक्चर डायग्राम | Azure आर्किटेक्चर | Azure इंफ्रास्ट्रक्चर के लिए 606 कलर सर्विस आइकन |
| GCP आर्किटेक्चर डायग्राम | GCP आर्किटेक्चर | Google Cloud इंफ्रास्ट्रक्चर के लिए 216 कलर सर्विस आइकन |

...
description: >-
  Material Design Icons के लिए क्यूरेटेड संदर्भ — Icon कॉम्पोनेंट के माध्यम से
  उपलब्ध 7,638 भरे और आउटलाइन आइकन।
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) लगभग हर उपयोग के मामले को कवर करते हुए भरे और आउटलाइन वेरिएंट के साथ 7,638 आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-mdi` से `Icon` कॉम्पोनेंट का उपयोग करें।
...
7,638 Material Design Icons की पूरी सूची के लिए, [Iconify MDI एक्सप्लोरर](https://icon-sets.iconify.design/mdi/) पर जाएँ।

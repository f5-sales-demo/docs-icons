...
description: >-
  मटेरियल डिज़ाइन आइकन का क्यूरेटेड संदर्भ — Icon कंपोनेंट के माध्यम से उपलब्ध
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) लगभग हर उपयोग के मामले को कवर करने वाले फिल्ड और आउटलाइन वेरिएंट के साथ 7,638 आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-mdi` से `Icon` कंपोनेंट का उपयोग करें।

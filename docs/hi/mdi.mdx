...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) लगभग हर उपयोग के मामले को कवर करने वाले फिल्ड और आउटलाइन वेरिएंट के साथ 7,638 आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5-sales-demo/icons-mdi` से `Icon` कम्पोनेंट का उपयोग करें।

...
description: >-
  @f5xc-salesdemos/icons-hashicorp-flight से सभी 672 HashiCorp Flight आइकन का
  दृश्य संदर्भ।
sidebar:
...
[`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight) पैकेज में प्रत्येक आइकन का संपूर्ण दृश्य संदर्भ। आइकन `Icon` कंपोनेंट के माध्यम से रेंडर किए जाते हैं और श्रेणी के अनुसार व्यवस्थित हैं।
...
आइकन `currentColor` का उपयोग करके इनलाइन SVG के रूप में रेंडर होते हैं — मोनोक्रोम आइकन स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित होते हैं। रंगीन वेरिएंट अपने मूल रंगों को बनाए रखते हैं।

:::note[डार्क मोड]
मोनोक्रोम आइकन `currentColor` का उपयोग करते हैं और स्वचालित रूप से अनुकूलित होते हैं। रंगीन वेरिएंट (`-color` से समाप्त होने वाले आइकन) `no-invert` क्लास के माध्यम से अपने मूल रंगों को बनाए रखते हैं।
:::

...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) IBM की एंटरप्राइज़ डिज़ाइन भाषा से 2,582 स्वच्छ, आउटलाइन्ड आइकॉन प्रदान करता है। किसी भी आइकॉन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-carbon` से `Icon` कंपोनेंट का उपयोग करें।

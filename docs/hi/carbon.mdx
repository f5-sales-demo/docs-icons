...
title: Carbon Icons
description: >-
  Carbon Icons के लिए क्यूरेटेड संदर्भ — IBM की डिज़ाइन भाषा से 2,582
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) IBM की एंटरप्राइज़ डिज़ाइन भाषा से 2,582 स्वच्छ, आउटलाइन्ड आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-carbon` से `Icon` कंपोनेंट का उपयोग करें।
...
2,582 Carbon Icons की पूरी सूची के लिए, [Iconify Carbon एक्सप्लोरर](https://icon-sets.iconify.design/carbon/) पर जाएँ।

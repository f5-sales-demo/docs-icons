...
title: कार्बन आइकॉन
description: >-
  कार्बन आइकॉन के लिए क्यूरेटेड संदर्भ — IBM की डिज़ाइन भाषा से 2,582
  एंटरप्राइज़-ग्रेड आइकॉन जो Icon कंपोनेंट के माध्यम से उपलब्ध हैं।
sidebar:
  label: कार्बन
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) IBM की एंटरप्राइज़ डिज़ाइन भाषा से 2,582 स्वच्छ, आउटलाइन्ड आइकॉन प्रदान करता है। किसी भी आइकॉन को नाम से रेंडर करने के लिए `@f5-sales-demo/icons-carbon` से `Icon` कंपोनेंट का उपयोग करें।
...
आइकॉन `currentColor` का उपयोग करके इनलाइन SVG के रूप में रेंडर होते हैं — वे स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित हो जाते हैं।
...
## सभी आइकॉन ब्राउज़ करें

2,582 कार्बन आइकॉन की पूरी सूची के लिए, [Iconify Carbon एक्सप्लोरर](https://icon-sets.iconify.design/carbon/) पर जाएँ।

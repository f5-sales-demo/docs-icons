...
description: >-
  Phosphor Icons के लिए क्यूरेटेड संदर्भ — Icon घटक के माध्यम से लचीले वेट
  वेरिएंट के साथ 9,161 आइकन उपलब्ध हैं।
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) 9,161 आइकन लचीले वेट विकल्पों के साथ प्रदान करता है — regular, bold, duotone, fill, light, और thin। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-phosphor` से `Icon` घटक का उपयोग करें।
...
आइकन `currentColor` का उपयोग करके inline SVG के रूप में रेंडर होते हैं — ये स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित हो जाते हैं।

:::note[वेट वेरिएंट]
Phosphor आइकन छह वेट में आते हैं। regular वेट बेस नाम का उपयोग करता है (जैसे `globe`)। अन्य वेट एक suffix जोड़ते हैं: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`। नीचे दिए गए उदाहरण regular वेट दर्शाते हैं।
:::
...
9,161 Phosphor Icons की पूरी सूची (सभी वेट वेरिएंट सहित) के लिए, [Iconify Phosphor explorer](https://icon-sets.iconify.design/ph/) पर जाएँ।

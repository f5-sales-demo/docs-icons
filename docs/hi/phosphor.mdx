...
title: Phosphor आइकन
description: >-
  Phosphor आइकन के लिए क्यूरेटेड संदर्भ — Icon कंपोनेंट के माध्यम से उपलब्ध
...
:::note[वेट वेरिएंट]
Phosphor आइकन छह वेट में आते हैं। रेगुलर वेट बेस नाम का उपयोग करता है (जैसे `globe`)। अन्य वेट एक प्रत्यय जोड़ते हैं: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`। नीचे दिए गए उदाहरण रेगुलर वेट दिखाते हैं।
:::
...
9,161 Phosphor आइकन (सभी वेट वेरिएंट सहित) की पूरी सूची के लिए, [Iconify Phosphor एक्सप्लोरर](https://icon-sets.iconify.design/ph/) पर जाएँ।

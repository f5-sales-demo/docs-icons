...
title: Phosphor आइकन
description: >-
  Phosphor Icons के लिए क्यूरेटेड संदर्भ — Icon कंपोनेंट के माध्यम से उपलब्ध
  लचीले वेट वेरिएंट के साथ 9,161 आइकन।
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) लचीले वेट विकल्पों — regular, bold, duotone, fill, light, और thin — के साथ 9,161 आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-phosphor` से `Icon` कंपोनेंट का उपयोग करें।
...
:::note[वेट वेरिएंट]
Phosphor आइकन छह वेट में आते हैं। Regular वेट बेस नाम का उपयोग करता है (जैसे `globe`)। अन्य वेट एक प्रत्यय जोड़ते हैं: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`। नीचे दिए गए उदाहरण regular वेट दिखाते हैं।
:::
...
सभी वेट वेरिएंट में 9,161 Phosphor Icons की पूरी सूची के लिए, [Iconify Phosphor एक्सप्लोरर](https://icon-sets.iconify.design/ph/) पर जाएं।

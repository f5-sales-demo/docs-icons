...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) लचीले वेट विकल्पों के साथ 9,161 आइकन प्रदान करता है — regular, bold, duotone, fill, light, और thin। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-phosphor` से `Icon` घटक का उपयोग करें।

...
:::note[वेट वेरिएंट]
Phosphor आइकन छह वेट में उपलब्ध हैं। Regular वेट बेस नाम का उपयोग करता है (जैसे `globe`)। अन्य वेट एक प्रत्यय जोड़ते हैं: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`। नीचे दिए गए उदाहरण regular वेट दिखाते हैं।
:::
...
सभी वेट वेरिएंट सहित 9,161 Phosphor Icons की पूरी सूची के लिए, [Iconify Phosphor एक्सप्लोरर](https://icon-sets.iconify.design/ph/) पर जाएँ।

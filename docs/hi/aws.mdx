...
description: >-
  AWS आर्किटेक्चर आइकन के लिए क्यूरेटेड संदर्भ — क्लाउड इंफ्रास्ट्रक्चर डायग्राम
  और दस्तावेज़ीकरण के लिए 885 रंगीन सेवा आइकन।
sidebar:
  label: AWS
  order: 14
i18n:
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) AWS इंफ्रास्ट्रक्चर को दस्तावेज़ित करने के लिए 885 रंगीन सेवा आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-aws` से `Icon` कम्पोनेंट का उपयोग करें। डिफ़ॉल्ट आकार 48x48 है जिसमें प्रति-आइकन आकार ओवरराइड की सुविधा है।
...
ये आइकन मूल वेंडर रंगों का उपयोग करते हैं (`currentColor` नहीं)। रंग SVG मार्कअप में एम्बेडेड होते हैं और लाइट तथा डार्क दोनों मोड में संरक्षित रहते हैं।
...
885 AWS आर्किटेक्चर आइकन की पूरी सूची के लिए, [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/) पर जाएँ।

...
[AWS आर्किटेक्चर आइकन](https://aws.amazon.com/architecture/icons/) AWS इंफ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 885 रंगीन सेवा आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-aws` से `Icon` घटक का उपयोग करें। डिफ़ॉल्ट आकार 48x48 है जिसमें प्रति-आइकन आकार ओवरराइड की सुविधा है।

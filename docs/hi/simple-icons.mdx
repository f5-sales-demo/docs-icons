...
title: सिंपल आइकन्स
description: >-
  Simple Icons प्रोजेक्ट से लोकप्रिय कंपनियों, सेवाओं और प्रौद्योगिकियों के लिए
  3,200+ ब्रांड आइकन्स।
sidebar:
  label: सिंपल आइकन्स
  order: 11
...
Simple Icons लोकप्रिय ब्रांड्स के लिए 3,200+ मुफ्त SVG आइकन्स प्रदान करता है, जिसमें नेटवर्क विक्रेता, क्लाउड प्रदाता, टेलीकॉम कंपनियां और प्रौद्योगिकी सेवाएं शामिल हैं। सभी आइकन्स मानक 24x24 viewBox का उपयोग करते हैं।
...
सभी 3,200+ आइकन्स ब्राउज़ करें: [Simple Icons वेबसाइट](https://simpleicons.org/) | [Iconify एक्सप्लोरर](https://icon-sets.iconify.design/simple-icons/)

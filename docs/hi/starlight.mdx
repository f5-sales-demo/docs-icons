...
Starlight में 200 से अधिक बिल्ट-इन आइकन शामिल हैं जो `<Icon>` कंपोनेंट के माध्यम से उपलब्ध हैं — किसी इंस्टॉलेशन की आवश्यकता नहीं है। `starlight-plugin-icons` प्लगइन पहले से ही थीम में कॉन्फ़िगर किया गया है, इसलिए ये आइकन किसी भी कंटेंट रिपॉज़िटरी में काम करते हैं।
...
| `class` | `string` | — | अतिरिक्त CSS क्लासेज़। |

:::tip[सुलभता]
जब कोई आइकन अर्थ व्यक्त करता है (जैसे लिंक आइकन) तो `label` prop जोड़ें। पूर्णतः सजावटी आइकन के लिए `label` छोड़ दें — Starlight उन्हें स्वचालित रूप से सहायक तकनीक से छिपा देगा।
:::
...
Seti आइकन `seti:` प्रीफ़िक्स का उपयोग करते हैं और फ़ाइल-प्रकार प्रतिनिधित्व के लिए डिज़ाइन किए गए हैं। ये `<Icon>` कंपोनेंट और `<FileTree>` कंपोनेंट में काम करते हैं।

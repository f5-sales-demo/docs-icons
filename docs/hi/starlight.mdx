...
Starlight में 200 से अधिक बिल्ट-इन आइकन शामिल हैं जो `<Icon>` कंपोनेंट के माध्यम से उपलब्ध हैं — किसी इंस्टॉलेशन की आवश्यकता नहीं है। `starlight-plugin-icons` प्लगइन थीम में पहले से कॉन्फ़िगर किया गया है, इसलिए ये आइकन किसी भी कंटेंट रिपो में काम करते हैं।
...
| `label` | `string` | — | स्क्रीन रीडर के लिए सुलभ लेबल। अर्थपूर्ण आइकन के लिए उपयोग करें; सजावटी आइकन के लिए छोड़ दें। |
| `size` | `string` | `"1em"` | चौड़ाई और ऊंचाई पर लागू CSS आकार मान। |
| `color` | `string` | `"currentColor"` | CSS रंग मान। |
| `class` | `string` | — | अतिरिक्त CSS क्लासेस। |

:::tip[सुलभता]
जब कोई आइकन अर्थ व्यक्त करता है (जैसे लिंक आइकन) तो `label` प्रॉप जोड़ें। पूरी तरह सजावटी आइकन के लिए `label` छोड़ दें — Starlight उन्हें सहायक तकनीक से स्वचालित रूप से छिपा देगा।
:::

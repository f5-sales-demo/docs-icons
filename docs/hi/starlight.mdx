---
title: Starlight बिल्ट-इन आइकन
description: >-
  Icon कंपोनेंट के माध्यम से उपलब्ध सभी 200+ बिल्ट-इन Starlight आइकन का संपूर्ण
  संदर्भ।
sidebar:
  label: Starlight बिल्ट-इन
  order: 3
i18n:
...
Starlight में 200 से अधिक बिल्ट-इन आइकन शामिल हैं जो `<Icon>` कंपोनेंट के माध्यम से उपलब्ध हैं — किसी इंस्टॉलेशन की आवश्यकता नहीं। `starlight-plugin-icons` प्लगइन पहले से ही थीम में कॉन्फ़िगर किया गया है, इसलिए ये आइकन किसी भी कंटेंट रिपो में काम करते हैं।

## Icon कंपोनेंट का उपयोग

कंपोनेंट को इम्पोर्ट करें और एक आइकन नाम पास करें:
...
|------|------|---------|-------------|
| `name` | `string` | — | **आवश्यक।** नीचे दी गई तालिकाओं से आइकन का नाम। |
| `label` | `string` | — | स्क्रीन रीडर के लिए एक्सेसिबल लेबल। अर्थपूर्ण आइकन के लिए उपयोग करें; सजावटी आइकन के लिए छोड़ दें। |
| `size` | `string` | `"1em"` | चौड़ाई और ऊंचाई पर लागू होने वाला CSS आकार मान। |
| `color` | `string` | `"currentColor"` | CSS रंग मान। |
| `class` | `string` | — | अतिरिक्त CSS क्लासेस। |

:::tip[एक्सेसिबिलिटी]
जब कोई आइकन अर्थ व्यक्त करता है (जैसे लिंक आइकन) तो `label` प्रॉप जोड़ें। पूरी तरह से सजावटी आइकन के लिए `label` छोड़ दें — Starlight उन्हें सहायक तकनीक से स्वचालित रूप से छिपा देगा।
:::
...
Seti आइकन `seti:` उपसर्ग का उपयोग करते हैं और फ़ाइल-प्रकार प्रतिनिधित्व के लिए डिज़ाइन किए गए हैं। ये `<Icon>` कंपोनेंट और `<FileTree>` कंपोनेंट में काम करते हैं।

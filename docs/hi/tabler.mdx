...
title: Tabler Icons
description: >-
  Tabler Icons के लिए क्यूरेटेड संदर्भ — 6,034 स्पष्ट लाइन आइकन जो एक समान
  स्ट्रोक चौड़ाई के साथ Icon कंपोनेंट के माध्यम से उपलब्ध हैं।
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 6,034 स्पष्ट लाइन आइकन प्रदान करता है जिनकी स्ट्रोक चौड़ाई एक समान 2px है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-tabler` से `Icon` कंपोनेंट का उपयोग करें।
...
6,034 Tabler Icons की पूरी सूची के लिए, [Iconify Tabler एक्सप्लोरर](https://icon-sets.iconify.design/tabler/) पर जाएँ।

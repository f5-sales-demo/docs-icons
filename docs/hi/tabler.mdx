...
title: Tabler Icons
description: >-
  Tabler Icons के लिए क्यूरेटेड संदर्भ — Icon घटक के माध्यम से उपलब्ध 6,034
  क्रिस्प लाइन आइकन जिनकी स्ट्रोक चौड़ाई एकसमान है।
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 6,034 क्रिस्प लाइन आइकन प्रदान करता है जिनकी स्ट्रोक चौड़ाई एकसमान 2px है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-tabler` से `Icon` घटक का उपयोग करें।
...
आइकन `currentColor` का उपयोग करके इनलाइन SVG के रूप में रेंडर होते हैं — ये स्वतः लाइट और डार्क मोड के अनुसार अनुकूलित हो जाते हैं।
...
6,034 Tabler Icons की पूरी सूची के लिए, [Iconify Tabler explorer](https://icon-sets.iconify.design/tabler/) पर जाएं।

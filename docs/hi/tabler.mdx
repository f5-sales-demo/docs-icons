...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 6,034 स्पष्ट लाइन आइकन प्रदान करता है जिनमें सुसंगत 2px स्ट्रोक चौड़ाई है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-tabler` से `Icon` घटक का उपयोग करें।

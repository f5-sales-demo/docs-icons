...
title: Tabler आइकन
description: >-
  Tabler आइकन के लिए क्यूरेटेड संदर्भ — Icon घटक के माध्यम से उपलब्ध 6,034
  स्पष्ट लाइन आइकन जिनमें सुसंगत स्ट्रोक चौड़ाई है।
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 6,034 स्पष्ट लाइन आइकन प्रदान करता है जिनमें सुसंगत 2px स्ट्रोक चौड़ाई है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5-sales-demo/icons-tabler` से `Icon` घटक का उपयोग करें।
...
आइकन `currentColor` का उपयोग करके इनलाइन SVG के रूप में रेंडर होते हैं — ये स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित हो जाते हैं।
...
6,034 Tabler आइकन की पूरी सूची के लिए, [Iconify Tabler एक्सप्लोरर](https://icon-sets.iconify.design/tabler/) पर जाएँ।

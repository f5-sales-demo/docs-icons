...
title: Tabler आइकन
description: >-
  Tabler आइकन के लिए क्यूरेटेड संदर्भ — Icon कंपोनेंट के माध्यम से उपलब्ध समान
  स्ट्रोक चौड़ाई वाले 6,034 स्पष्ट लाइन आइकन।
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) एक समान 2px स्ट्रोक चौड़ाई के साथ 6,034 स्पष्ट लाइन आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-tabler` से `Icon` कंपोनेंट का उपयोग करें।

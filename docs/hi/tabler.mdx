...
title: Tabler आइकन्स
description: >-
  Tabler आइकन्स के लिए क्यूरेटेड संदर्भ — Icon कंपोनेंट के माध्यम से उपलब्ध
  एकसमान स्ट्रोक चौड़ाई वाले 6,034 स्पष्ट लाइन आइकन्स।
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) एकसमान 2px स्ट्रोक चौड़ाई वाले 6,034 स्पष्ट लाइन आइकन्स प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-tabler` से `Icon` कंपोनेंट का उपयोग करें।
...
आइकन्स `currentColor` का उपयोग करते हुए इनलाइन SVG के रूप में रेंडर होते हैं — वे स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित हो जाते हैं।
...
## सभी आइकन्स ब्राउज़ करें

6,034 Tabler आइकन्स की पूर्ण सूची के लिए, [Iconify Tabler एक्सप्लोरर](https://icon-sets.iconify.design/tabler/) पर जाएँ।

...
description: >-
  ...
  डायग्राम और दस्तावेज़ीकरण के लिए 606 रंगीन सेवा आइकन।
sidebar:
  label: Azure
  order: 15
i18n:
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) Azure इन्फ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 606 रंगीन सेवा आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-azure` से `Icon` घटक का उपयोग करें। डिफ़ॉल्ट आकार ग्रेडिएंट फिल के साथ 18x18 है।
...
606 Azure आर्किटेक्चर आइकन की पूरी सूची के लिए, [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) पृष्ठ पर जाएँ।

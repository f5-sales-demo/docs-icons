...
description: >-
  Azure Architecture Icons के लिए क्यूरेटेड संदर्भ — क्लाउड इन्फ्रास्ट्रक्चर
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) Azure इन्फ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 606 रंगीन सेवा आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-azure` से `Icon` कंपोनेंट का उपयोग करें। डिफ़ॉल्ट आकार 18x18 है जिसमें ग्रेडिएंट फिल हैं।
...
606 Azure Architecture Icons की पूरी सूची के लिए, [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) पृष्ठ पर जाएँ।

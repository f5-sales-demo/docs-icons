...
description: >-
  Azure आर्किटेक्चर आइकन के लिए क्यूरेटेड संदर्भ — क्लाउड इंफ्रास्ट्रक्चर
  डायग्राम और दस्तावेज़ीकरण के लिए 606 कलर सर्विस आइकन।
sidebar:
  label: Azure
  order: 15
i18n:
...
[Azure आर्किटेक्चर आइकन](https://learn.microsoft.com/en-us/azure/architecture/icons/) Azure इंफ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 606 कलर सर्विस आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5-sales-demo/icons-azure` से `Icon` घटक का उपयोग करें। डिफ़ॉल्ट आकार ग्रेडिएंट फिल के साथ 18x18 है।
...
ये आइकन मूल वेंडर रंगों का उपयोग करते हैं (`currentColor` नहीं)। रंग SVG मार्कअप में एम्बेड किए गए हैं और लाइट तथा डार्क दोनों मोड में संरक्षित हैं।
...
606 Azure आर्किटेक्चर आइकन की पूरी सूची के लिए, [Microsoft Azure आर्किटेक्चर आइकन](https://learn.microsoft.com/en-us/azure/architecture/icons/) पृष्ठ पर जाएँ।

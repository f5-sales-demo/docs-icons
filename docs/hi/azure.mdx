...
[Azure आर्किटेक्चर आइकन](https://learn.microsoft.com/en-us/azure/architecture/icons/) Azure इंफ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 606 कलर सर्विस आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-azure` से `Icon` घटक का उपयोग करें। डिफ़ॉल्ट आकार ग्रेडिएंट फिल के साथ 18x18 है।

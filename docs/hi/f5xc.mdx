...
title: F5 XC
description: >-
  @f5xc-salesdemos/icons-f5xc से सभी 30 F5 Distributed Cloud (XC) सेवा आइकनों का
  दृश्य संदर्भ।
sidebar:
  label: F5 XC
  order: 13
...
[`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc) पैकेज में प्रत्येक आइकन का पूर्ण दृश्य संदर्भ। ये 30 आइकन F5 Distributed Cloud सेवाओं का प्रतिनिधित्व करते हैं और Astro कंपोनेंट के साथ Iconify JSON के रूप में उपलब्ध हैं।
...
:::note[डार्क मोड]
ये मल्टी-कलर आइकन CSS कस्टम प्रॉपर्टीज (`--color-N600`, `--color-brand`, `--color-blue-light`, `--color-N200`) का उपयोग करते हैं जो स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित होते हैं। डार्क मोड में नेवी और लाइट-ब्लू आपस में बदल जाते हैं जबकि F5 का लाल एक्सेंट स्थिर रहता है।
:::

...
title: Lucide आइकन
description: >-
  Lucide आइकन के लिए क्यूरेटेड संदर्भ — Icon कंपोनेंट के माध्यम से उपलब्ध 1,600+
  आधुनिक स्ट्रोक आइकन।
sidebar:
  label: Lucide
  order: 5
...
[Lucide](https://lucide.dev/) ~1,600 आधुनिक, सुसंगत स्ट्रोक आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-lucide` से `Icon` कंपोनेंट का उपयोग करें।
...
आइकन `currentColor` का उपयोग करते हुए इनलाइन SVG के रूप में रेंडर होते हैं — वे स्वचालित रूप से लाइट और डार्क मोड के अनुसार अनुकूलित हो जाते हैं।
...
~1,600 Lucide आइकन की पूरी सूची के लिए, [lucide.dev/icons](https://lucide.dev/icons/) पर जाएँ।

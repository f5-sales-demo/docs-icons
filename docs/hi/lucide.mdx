...
[Lucide](https://lucide.dev/) लगभग 1,600 आधुनिक, सुसंगत स्ट्रोक आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-lucide` से `Icon` घटक का उपयोग करें।
...
लगभग 1,600 Lucide आइकन की पूरी सूची के लिए, [lucide.dev/icons](https://lucide.dev/icons/) पर जाएँ।

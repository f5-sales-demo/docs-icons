...
description: >-
  ...
  डायग्राम और दस्तावेज़ीकरण के लिए 216 रंगीन सर्विस आइकन।
sidebar:
  label: GCP
  order: 16
i18n:
...
[GCP आर्किटेक्चर आइकन](https://cloud.google.com/icons) Google Cloud इन्फ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 216 रंगीन सर्विस आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-gcp` से `Icon` कंपोनेंट का उपयोग करें। डिफ़ॉल्ट आकार 24x24 है जिसमें इनलाइन फ़िल्स हैं।
...
ये आइकन मूल वेंडर रंगों का उपयोग करते हैं (`currentColor` नहीं)। रंग SVG मार्कअप में एम्बेडेड हैं और लाइट और डार्क दोनों मोड में संरक्षित रहते हैं।
...
216 GCP आर्किटेक्चर आइकन की पूरी सूची के लिए, [Google Cloud आर्किटेक्चर आइकन](https://cloud.google.com/icons) पेज पर जाएँ।

...
[GCP Architecture Icons](https://cloud.google.com/icons) Google Cloud इन्फ्रास्ट्रक्चर के दस्तावेज़ीकरण के लिए 216 रंगीन सेवा आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5-sales-demo/icons-gcp` से `Icon` घटक का उपयोग करें। डिफ़ॉल्ट आकार 24x24 है जिसमें इनलाइन फ़िल्स हैं।
...
ये आइकन मूल विक्रेता रंगों का उपयोग करते हैं (`currentColor` नहीं)। रंग SVG मार्कअप में एम्बेड किए गए हैं और लाइट तथा डार्क दोनों मोड में सुरक्षित रहते हैं।
...
216 GCP आर्किटेक्चर आइकन की पूरी सूची के लिए, [Google Cloud Architecture Icons](https://cloud.google.com/icons) पृष्ठ पर जाएँ।

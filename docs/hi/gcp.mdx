...
description: >-
  GCP आर्किटेक्चर आइकन के लिए क्यूरेटेड संदर्भ — क्लाउड इंफ्रास्ट्रक्चर डायग्राम
...
[GCP Architecture Icons](https://cloud.google.com/icons) Google Cloud इंफ्रास्ट्रक्चर को दस्तावेज़ित करने के लिए 216 रंगीन सेवा आइकन प्रदान करता है। किसी भी आइकन को नाम से रेंडर करने के लिए `@f5xc-salesdemos/icons-gcp` से `Icon` कंपोनेंट का उपयोग करें। डिफ़ॉल्ट आकार 24x24 है जिसमें इनलाइन फ़िल हैं।
...
216 GCP आर्किटेक्चर आइकन की पूरी सूची के लिए, [Google Cloud Architecture Icons](https://cloud.google.com/icons) पेज पर जाएँ।

---
title: Simple Icons
description: '來自 Simple Icons 專案的 3,200+ 個品牌圖示，涵蓋熱門公司、服務和技術。'
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons 提供 3,200+ 個免費 SVG 圖示，涵蓋熱門品牌，包括網路設備供應商、雲端服務供應商、電信公司和技術服務。所有圖示使用標準的 24x24 viewBox。
...
瀏覽所有 3,200+ 個圖示：[Simple Icons 網站](https://simpleicons.org/) | [Iconify 瀏覽器](https://icon-sets.iconify.design/simple-icons/)

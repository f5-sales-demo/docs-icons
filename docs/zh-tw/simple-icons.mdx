---
title: Simple Icons
description: '來自 Simple Icons 專案，提供 3,200+ 個熱門公司、服務與技術的品牌圖示。'
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
Simple Icons 提供 3,200+ 個免費 SVG 圖示，涵蓋熱門品牌，包括網路設備廠商、雲端供應商、電信公司及技術服務。所有圖示均使用標準 24x24 viewBox。
...
瀏覽全部 3,200+ 個圖示：[Simple Icons 官網](https://simpleicons.org/) | [Iconify 瀏覽器](https://icon-sets.iconify.design/simple-icons/)

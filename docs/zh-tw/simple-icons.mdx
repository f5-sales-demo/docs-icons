...
Simple Icons 提供 3,200+ 個免費 SVG 圖示，涵蓋熱門品牌，包括網路廠商、雲端供應商、電信公司和技術服務。所有圖示使用標準 24x24 viewBox。
...
瀏覽全部 3,200+ 個圖示：[Simple Icons 網站](https://simpleicons.org/) | [Iconify 瀏覽器](https://icon-sets.iconify.design/simple-icons/)

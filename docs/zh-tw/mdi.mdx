...
description: 'Material Design Icons 精選參考 — 透過 Icon 元件可使用 7,638 個填充與輪廓圖示。'
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) 提供 7,638 個圖示，涵蓋填充與輪廓兩種變體，幾乎適用於所有使用情境。使用來自 `@f5xc-salesdemos/icons-mdi` 的 `Icon` 元件，即可依名稱渲染任意圖示。
...
圖示以內嵌 SVG 形式渲染，使用 `currentColor` — 可自動適應明亮與深色模式。

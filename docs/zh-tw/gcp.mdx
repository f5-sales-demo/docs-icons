...
[GCP 架構圖示](https://cloud.google.com/icons) 提供 216 個彩色服務圖示，用於記錄 Google Cloud 基礎架構。使用 `@f5xc-salesdemos/icons-gcp` 的 `Icon` 元件，透過名稱渲染任何圖示。預設尺寸為 24x24，搭配內嵌填色。
...
如需查看完整的 216 個 GCP 架構圖示清單，請前往 [Google Cloud 架構圖示](https://cloud.google.com/icons) 頁面。

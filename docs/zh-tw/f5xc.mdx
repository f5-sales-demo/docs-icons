---
title: F5 XC
description: 來自 @f5-sales-demo/icons-f5xc 的所有 30 個 F5 Distributed Cloud (XC) 服務圖示的視覺參考。
sidebar:
  label: F5 XC
  order: 13
i18n:
...
[`@f5-sales-demo/icons-f5xc`](https://www.npmjs.com/package/@f5-sales-demo/icons-f5xc) 套件中每個圖示的完整視覺參考。這 30 個圖示代表 F5 Distributed Cloud 服務，並以 Iconify JSON 格式搭配 Astro 元件提供使用。
...
:::note[深色模式]
這些多色圖示使用 CSS 自訂屬性（`--color-N600`、`--color-brand`、`--color-blue-light`、`--color-N200`），會自動適應淺色和深色模式。深藍色和淺藍色在深色模式下會互換，而 F5 紅色強調色則保持不變。
:::

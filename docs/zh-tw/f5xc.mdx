---
title: F5 XC
description: 來自 @f5xc-salesdemos/icons-f5xc 的全部 30 個 F5 Distributed Cloud (XC) 服務圖示的視覺參考。
sidebar:
  label: F5 XC
  order: 13
i18n:
...
[`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc) 套件中每個圖示的完整視覺參考。這 30 個圖示代表 F5 Distributed Cloud 服務，並以 Iconify JSON 格式搭配 Astro 元件提供使用。

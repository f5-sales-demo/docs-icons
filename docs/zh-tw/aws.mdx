---
title: AWS 架構圖示
description: AWS 架構圖示精選參考 — 885 個彩色服務圖示，適用於雲端基礎架構圖表與文件。
sidebar:
  label: AWS
  order: 14
i18n:
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) 提供 885 個彩色服務圖示，用於記錄 AWS 基礎架構。使用 `@f5xc-salesdemos/icons-aws` 中的 `Icon` 元件，可依名稱渲染任何圖示。預設大小為 48x48，並支援各圖示的大小覆寫。

...
[AWS 架構圖示](https://aws.amazon.com/architecture/icons/) 提供 885 個彩色服務圖示，用於記錄 AWS 基礎架構。使用 `@f5xc-salesdemos/icons-aws` 中的 `Icon` 元件，透過名稱渲染任意圖示。預設尺寸為 48x48，各圖示可個別覆寫尺寸。

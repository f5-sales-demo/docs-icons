...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) 提供 9,161 個圖示，並支援彈性粗細選項 — regular、bold、duotone、fill、light 與 thin。使用來自 `@f5xc-salesdemos/icons-phosphor` 的 `Icon` 元件，透過名稱渲染任意圖示。

...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) 提供 9,161 個圖示，具備靈活的粗細選項 — regular、bold、duotone、fill、light 和 thin。使用 `@f5xc-salesdemos/icons-phosphor` 中的 `Icon` 元件，即可透過名稱渲染任何圖示。

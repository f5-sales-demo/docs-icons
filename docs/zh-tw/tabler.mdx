...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 提供 6,034 個清晰的線條圖示，具有一致的 2px 筆畫寬度。使用 `@f5xc-salesdemos/icons-tabler` 中的 `Icon` 元件，透過名稱渲染任何圖示。
...
圖示以內聯 SVG 的形式渲染，使用 `currentColor` — 它們會自動適應淺色和深色模式。
...
如需查看完整的 6,034 個 Tabler Icons 列表，請造訪 [Iconify Tabler 瀏覽器](https://icon-sets.iconify.design/tabler/)。

---
title: Tabler Icons
description: 'Tabler Icons 精選參考手冊 — 6,034 個筆畫寬度一致的清晰線條圖示，可透過 Icon 元件使用。'
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) 提供 6,034 個具有一致 2px 筆畫寬度的清晰線條圖示。使用來自 `@f5-sales-demo/icons-tabler` 的 `Icon` 元件，透過名稱渲染任意圖示。
...
如需完整的 6,034 個 Tabler Icons 清單，請造訪 [Iconify Tabler 探索器](https://icon-sets.iconify.design/tabler/)。

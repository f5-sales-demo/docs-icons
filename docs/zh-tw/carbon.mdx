---
title: Carbon 圖示
description: 'Carbon Icons 精選參考 — 2,582 個來自 IBM 設計語言的企業級圖示，可透過 Icon 元件使用。'
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) 提供 2,582 個來自 IBM 企業設計語言的簡潔外框圖示。使用 `@f5-sales-demo/icons-carbon` 中的 `Icon` 元件，透過名稱渲染任意圖示。
...
如需完整的 2,582 個 Carbon Icons 清單，請造訪 [Iconify Carbon 瀏覽器](https://icon-sets.iconify.design/carbon/)。

---
title: Lucide 圖示
description: 'Lucide 圖示精選參考 — 透過 Icon 元件可使用超過 1,600 個現代描邊圖示。'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) 提供約 1,600 個現代、一致的描邊圖示。使用 `@f5xc-salesdemos/icons-lucide` 中的 `Icon` 元件，即可透過名稱呈現任何圖示。
...
圖示以內嵌 SVG 方式呈現，使用 `currentColor` — 可自動適應亮色與暗色模式。
...
如需查看完整的約 1,600 個 Lucide 圖示清單，請造訪 [lucide.dev/icons](https://lucide.dev/icons/)。

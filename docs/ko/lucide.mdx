---
title: Lucide 아이콘
description: 'Lucide 아이콘 큐레이션 레퍼런스 — Icon 컴포넌트를 통해 사용할 수 있는 1,600개 이상의 모던 스트로크 아이콘.'
sidebar:
  label: Lucide
  order: 5
i18n:
...
약 1,600개의 Lucide 아이콘 전체 목록은 [lucide.dev/icons](https://lucide.dev/icons/)를 방문하세요.

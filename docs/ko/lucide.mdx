---
title: Lucide 아이콘
description: 'Lucide 아이콘 선별 레퍼런스 — Icon 컴포넌트를 통해 사용할 수 있는 1,600개 이상의 모던 스트로크 아이콘.'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/)는 약 1,600개의 모던하고 일관된 스트로크 아이콘을 제공합니다. `@f5xc-salesdemos/icons-lucide`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.
...
약 1,600개의 Lucide 아이콘 전체 목록은 [lucide.dev/icons](https://lucide.dev/icons/)에서 확인할 수 있습니다.

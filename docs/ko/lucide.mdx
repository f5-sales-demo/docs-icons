---
title: Lucide 아이콘
description: 'Lucide 아이콘 선별 레퍼런스 — Icon 컴포넌트를 통해 사용 가능한 1,600개 이상의 모던 스트로크 아이콘.'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/)는 약 1,600개의 모던하고 일관된 스트로크 아이콘을 제공합니다. `@f5xc-salesdemos/icons-lucide`의 `Icon` 컴포넌트를 사용하여 이름으로 모든 아이콘을 렌더링할 수 있습니다.

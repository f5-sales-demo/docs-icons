---
title: Lucide 아이콘
description: 'Lucide 아이콘 큐레이션 참조 — Icon 구성 요소를 통해 사용 가능한 1,600개 이상의 현대적인 스트로크 아이콘.'
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/)는 약 1,600개의 현대적이고 일관된 스트로크 아이콘을 제공합니다. `@f5xc-salesdemos/icons-lucide`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요.
...
약 1,600개의 전체 Lucide 아이콘 목록은 [lucide.dev/icons](https://lucide.dev/icons/)를 방문하세요.

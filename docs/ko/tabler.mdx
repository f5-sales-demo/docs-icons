...
title: Tabler Icons
description: >-
  Tabler Icons 큐레이션 레퍼런스 — 일관된 선 두께의 선명한 라인 아이콘 6,034개를 Icon 컴포넌트를 통해 사용할 수
  있습니다.
sidebar:
  label: Tabler
  order: 9
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/)는 일관된 2px 선 두께의 선명한 라인 아이콘 6,034개를 제공합니다. `@f5xc-salesdemos/icons-tabler`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.
...
6,034개의 Tabler Icons 전체 목록은 [Iconify Tabler 탐색기](https://icon-sets.iconify.design/tabler/)를 방문하세요.

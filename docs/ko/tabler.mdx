...
[Tabler Icons](https://icon-sets.iconify.design/tabler/)는 일관된 2px 선 두께를 가진 6,034개의 선명한 라인 아이콘을 제공합니다. `@f5xc-salesdemos/icons-tabler`의 `Icon` 구성 요소를 사용하여 이름으로 모든 아이콘을 렌더링하세요.

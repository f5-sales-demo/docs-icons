---
title: Tabler Icons
description: 'Tabler Icons의 선별된 참조 — Icon 구성 요소를 통해 사용 가능한 일관된 선 굵기의 선명한 라인 아이콘 6,034개.'
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/)는 일관된 2px 선 굵기를 가진 선명한 라인 아이콘 6,034개를 제공합니다. `@f5xc-salesdemos/icons-tabler`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.
...
Tabler Icons 6,034개의 전체 목록은 [Iconify Tabler 탐색기](https://icon-sets.iconify.design/tabler/)를 방문하십시오.

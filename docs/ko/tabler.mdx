---
title: Tabler 아이콘
description: 'Tabler Icons 큐레이션 레퍼런스 — Icon 컴포넌트를 통해 사용 가능한 일관된 스트로크 너비의 선명한 라인 아이콘 6,034개.'
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/)는 일관된 2px 스트로크 너비를 가진 6,034개의 선명한 라인 아이콘을 제공합니다. `@f5xc-salesdemos/icons-tabler`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.
...
6,034개의 Tabler Icons 전체 목록을 확인하려면 [Iconify Tabler 탐색기](https://icon-sets.iconify.design/tabler/)를 방문하세요.

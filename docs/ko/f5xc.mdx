...
title: F5 XC
description: >-
  @f5xc-salesdemos/icons-f5xc의 F5 Distributed Cloud (XC) 서비스 아이콘 30개에 대한 시각적
  참조입니다.
sidebar:
  label: F5 XC
  order: 13
...
[`@f5xc-salesdemos/icons-f5xc`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-f5xc) 패키지의 모든 아이콘에 대한 완전한 시각적 참조입니다. 이 30개의 아이콘은 F5 Distributed Cloud 서비스를 나타내며, Astro 컴포넌트와 함께 Iconify JSON으로 사용할 수 있습니다.

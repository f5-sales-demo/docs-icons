...
[Azure 아키텍처 아이콘](https://learn.microsoft.com/en-us/azure/architecture/icons/)은 Azure 인프라 문서화를 위한 606개의 컬러 서비스 아이콘을 제공합니다. `@f5xc-salesdemos/icons-azure`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링합니다. 기본 크기는 그라디언트 채우기가 적용된 18x18입니다.

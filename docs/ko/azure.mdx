...
description: Azure 아키텍처 아이콘에 대한 선별된 참조 — 클라우드 인프라 다이어그램 및 문서화를 위한 606개의 컬러 서비스 아이콘.
sidebar:
  label: Azure
  order: 15
i18n:
...
[Azure 아키텍처 아이콘](https://learn.microsoft.com/en-us/azure/architecture/icons/)은 Azure 인프라를 문서화하기 위한 606개의 컬러 서비스 아이콘을 제공합니다. `@f5xc-salesdemos/icons-azure`의 `Icon` 컴포넌트를 사용하여 이름으로 원하는 아이콘을 렌더링할 수 있습니다. 기본 크기는 18x18이며 그라디언트 채우기가 적용됩니다.
...
606개의 Azure 아키텍처 아이콘 전체 목록은 [Microsoft Azure 아키텍처 아이콘](https://learn.microsoft.com/en-us/azure/architecture/icons/) 페이지를 방문하세요.

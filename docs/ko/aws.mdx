...
[AWS 아키텍처 아이콘](https://aws.amazon.com/architecture/icons/)은 AWS 인프라 문서화를 위한 885개의 컬러 서비스 아이콘을 제공합니다. `@f5xc-salesdemos/icons-aws`의 `Icon` 구성 요소를 사용하여 이름으로 모든 아이콘을 렌더링하세요. 기본 크기는 48x48이며 아이콘별 크기 재정의가 가능합니다.

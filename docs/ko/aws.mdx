---
title: AWS 아키텍처 아이콘
description: AWS 아키텍처 아이콘에 대한 선별된 참조 자료 — 클라우드 인프라 다이어그램 및 문서화를 위한 885개의 컬러 서비스 아이콘.
sidebar:
  label: AWS
  order: 14
i18n:
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/)는 AWS 인프라를 문서화하기 위한 885개의 컬러 서비스 아이콘을 제공합니다. `@f5xc-salesdemos/icons-aws`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다. 기본 크기는 48x48이며, 아이콘별 크기 재정의가 가능합니다.
...
885개의 AWS 아키텍처 아이콘 전체 목록은 [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/)를 방문하세요.

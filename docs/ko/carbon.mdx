...
title: Carbon 아이콘
description: >-
  Carbon 아이콘 큐레이션 참조 — IBM의 디자인 언어에서 제공하는 2,582개의 엔터프라이즈급 아이콘으로 Icon 구성 요소를 통해
  사용할 수 있습니다.
sidebar:
  label: Carbon
  order: 7
...
[Carbon 아이콘](https://icon-sets.iconify.design/carbon/)은 IBM의 엔터프라이즈 디자인 언어에서 제공하는 2,582개의 깔끔한 아웃라인 아이콘을 제공합니다. `@f5-sales-demo/icons-carbon`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요.
...
2,582개의 Carbon 아이콘 전체 목록을 보려면 [Iconify Carbon 탐색기](https://icon-sets.iconify.design/carbon/)를 방문하세요.

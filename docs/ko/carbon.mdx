...
title: Carbon 아이콘
description: >-
  Carbon 아이콘 큐레이션 참조 — IBM의 디자인 언어에서 제공하는 2,582개의 엔터프라이즈급 아이콘을 Icon 컴포넌트를 통해 사용할
  수 있습니다.
sidebar:
  label: Carbon
  order: 7
...
2,582개의 전체 Carbon 아이콘 목록은 [Iconify Carbon 탐색기](https://icon-sets.iconify.design/carbon/)를 방문하세요.

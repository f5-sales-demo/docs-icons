...
title: Carbon 아이콘
description: >-
  Carbon Icons에 대한 선별된 참조 — IBM의 디자인 언어에서 제공하는 2,582개의 엔터프라이즈급 아이콘을 Icon 컴포넌트를
  통해 사용할 수 있습니다.
sidebar:
  label: Carbon
  order: 7
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/)는 IBM의 엔터프라이즈 디자인 언어에서 제공하는 2,582개의 깔끔한 아웃라인 아이콘을 제공합니다. `@f5xc-salesdemos/icons-carbon`의 `Icon` 컴포넌트를 사용하여 이름으로 모든 아이콘을 렌더링할 수 있습니다.
...
2,582개의 Carbon Icons 전체 목록은 [Iconify Carbon 탐색기](https://icon-sets.iconify.design/carbon/)를 방문하세요.

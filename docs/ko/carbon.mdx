...
[Carbon 아이콘](https://icon-sets.iconify.design/carbon/)은 IBM의 엔터프라이즈 디자인 언어에서 제공하는 2,582개의 깔끔한 아웃라인 아이콘을 제공합니다. `@f5xc-salesdemos/icons-carbon`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요.

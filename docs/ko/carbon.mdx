...
title: Carbon Icons
description: >-
  Carbon Icons의 선별된 참조 — Icon 구성 요소를 통해 사용할 수 있는 IBM의 디자인 언어에서 가져온 2,582개의
  엔터프라이즈급 아이콘.
sidebar:
  label: Carbon
  order: 7
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/)는 IBM의 엔터프라이즈 디자인 언어에서 가져온 2,582개의 깔끔하고 외곽선 스타일의 아이콘을 제공합니다. `@f5xc-salesdemos/icons-carbon`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요.

---
title: Phosphor 아이콘
description: 'Phosphor 아이콘 엄선 참고 자료 — Icon 컴포넌트를 통해 사용할 수 있는 유연한 굵기 변형을 갖춘 9,161개의 아이콘.'
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/)는 regular, bold, duotone, fill, light, thin 등 유연한 굵기 옵션을 갖춘 9,161개의 아이콘을 제공합니다. `@f5xc-salesdemos/icons-phosphor`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.
...
:::note[굵기 변형]
Phosphor 아이콘은 여섯 가지 굵기로 제공됩니다. regular 굵기는 기본 이름을 사용합니다(예: `globe`). 다른 굵기는 접미사를 추가합니다: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. 아래 예시는 regular 굵기를 보여줍니다.
:::
...
모든 굵기 변형을 포함한 9,161개의 Phosphor 아이콘 전체 목록은 [Iconify Phosphor 탐색기](https://icon-sets.iconify.design/ph/)를 방문하세요.

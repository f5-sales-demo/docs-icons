...
description: >-
  Material Design Icons의 큐레이션 참조 — Icon 구성 요소를 통해 사용 가능한 7,638개의 채워진 아이콘과 외곽선
  아이콘.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/)는 사실상 모든 사용 사례를 포괄하는 채워진 변형과 외곽선 변형을 포함한 7,638개의 아이콘을 제공합니다. `@f5-sales-demo/icons-mdi`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요.
...
아이콘은 `currentColor`를 사용하여 인라인 SVG로 렌더링됩니다 — 라이트 모드와 다크 모드에 자동으로 적응합니다.

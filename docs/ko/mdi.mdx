...
description: >-
  Material Design Icons에 대한 엄선된 레퍼런스 — Icon 컴포넌트를 통해 사용할 수 있는 7,638개의
  채워진(filled) 및 윤곽선(outlined) 아이콘입니다.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/)는 거의 모든 사용 사례를 포괄하는 채워진(filled) 및 윤곽선(outlined) 변형을 갖춘 7,638개의 아이콘을 제공합니다. `@f5xc-salesdemos/icons-mdi`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.

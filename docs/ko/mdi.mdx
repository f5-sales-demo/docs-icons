...
description: 'Material Design Icons에 대한 엄선된 참조 — Icon 컴포넌트를 통해 사용할 수 있는 7,638개의 채움 및 윤곽 아이콘.'
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/)는 거의 모든 사용 사례를 포괄하는 7,638개의 채움 및 윤곽 변형 아이콘을 제공합니다. `@f5xc-salesdemos/icons-mdi`의 `Icon` 컴포넌트를 사용하여 이름으로 아이콘을 렌더링할 수 있습니다.
...
7,638개의 Material Design Icons 전체 목록을 보려면 [Iconify MDI 탐색기](https://icon-sets.iconify.design/mdi/)를 방문하세요.

...
[Material Design Icons](https://icon-sets.iconify.design/mdi/)는 사실상 모든 사용 사례를 포괄하는 채워진 변형과 외곽선 변형을 포함한 7,638개의 아이콘을 제공합니다. `@f5xc-salesdemos/icons-mdi`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요.

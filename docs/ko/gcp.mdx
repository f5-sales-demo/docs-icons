...
[GCP 아키텍처 아이콘](https://cloud.google.com/icons)은 Google Cloud 인프라 문서화를 위한 216개의 컬러 서비스 아이콘을 제공합니다. `@f5xc-salesdemos/icons-gcp`의 `Icon` 구성 요소를 사용하여 이름으로 아이콘을 렌더링하세요. 기본 크기는 인라인 채우기를 포함한 24x24입니다.

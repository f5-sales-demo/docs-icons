...
Simple Icons는 네트워크 벤더, 클라우드 제공업체, 통신 회사 및 기술 서비스를 포함한 인기 브랜드를 위한 3,200개 이상의 무료 SVG 아이콘을 제공합니다. 모든 아이콘은 표준 24x24 viewBox를 사용합니다.
...
3,200개 이상의 모든 아이콘 둘러보기: [Simple Icons 웹사이트](https://simpleicons.org/) | [Iconify 탐색기](https://icon-sets.iconify.design/simple-icons/)

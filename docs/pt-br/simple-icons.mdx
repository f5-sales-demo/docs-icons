...
title: Simple Icons
description: >-
  Mais de 3.200 ícones de marcas para empresas, serviços e tecnologias populares
  do projeto Simple Icons.
sidebar:
  label: Simple Icons
  order: 11
i18n:
...
O Simple Icons fornece mais de 3.200 ícones SVG gratuitos para marcas populares, incluindo fornecedores de rede, provedores de nuvem, empresas de telecomunicações e serviços de tecnologia. Todos os ícones utilizam um viewBox padrão de 24x24.
...
## Fornecedores de Rede e Segurança
...
Navegue por todos os mais de 3.200 ícones: [Site do Simple Icons](https://simpleicons.org/) | [Explorador do Iconify](https://icon-sets.iconify.design/simple-icons/)

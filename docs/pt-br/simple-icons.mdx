...
title: Simple Icons
description: >-
  Mais de 3.200 ícones de marcas para empresas populares, serviços e tecnologias
...
Simple Icons fornece mais de 3.200 ícones SVG gratuitos para marcas populares, incluindo fornecedores de rede, provedores de nuvem, empresas de telecomunicações e serviços de tecnologia. Todos os ícones utilizam um viewBox padrão de 24x24.
...
Navegue por todos os mais de 3.200 ícones: [Site do Simple Icons](https://simpleicons.org/) | [Explorador Iconify](https://icon-sets.iconify.design/simple-icons/)

...
Os ícones de serviços F5 XC utilizam propriedades CSS personalizadas que se adaptam automaticamente aos modos claro e escuro — nenhum tratamento especial de classes é necessário. Para outros ícones multicoloridos (como as variantes de cor do HashiCorp Flight), a classe `no-invert` em `.icon-card-image` preserva as cores originais no modo escuro.

## Qual Pacote Devo Usar?

| Caso de Uso | Pacote Recomendado | Motivo |
|-------------|-------------------|--------|
...
| Linguagem de design IBM | Carbon | 2.582 ícones de nível corporativo |

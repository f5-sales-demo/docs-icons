...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornece 6.034 ícones de linha nítidos com uma largura de traço consistente de 2px. Use o componente `Icon` de `@f5xc-salesdemos/icons-tabler` para renderizar qualquer ícone pelo nome.

...
title: Tabler Icons
description: >-
  Referência curada para Tabler Icons — 6.034 ícones de linha nítidos com
  largura de traço consistente, disponíveis através do componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
Para a lista completa de 6.034 Tabler Icons, visite o [explorador Iconify Tabler](https://icon-sets.iconify.design/tabler/).

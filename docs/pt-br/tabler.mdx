...
description: >-
  ...
  espessura de traço consistente disponíveis via componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornece 6.034 ícones de linha nítidos com uma espessura de traço consistente de 2px. Use o componente `Icon` de `@f5xc-salesdemos/icons-tabler` para renderizar qualquer ícone pelo nome.
...
Para a lista completa com 6.034 Tabler Icons, visite o [explorador Iconify Tabler](https://icon-sets.iconify.design/tabler/).

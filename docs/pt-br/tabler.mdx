...
title: Tabler Icons
description: >-
  Referência selecionada para Tabler Icons — 6.034 ícones de linha nítidos com
  largura de traço consistente disponíveis via o componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) fornece 6.034 ícones de linha nítidos com uma largura de traço consistente de 2px. Use o componente `Icon` de `@f5-sales-demo/icons-tabler` para renderizar qualquer ícone pelo nome.
...
Para a lista completa de 6.034 Tabler Icons, visite o [explorador Tabler do Iconify](https://icon-sets.iconify.design/tabler/).

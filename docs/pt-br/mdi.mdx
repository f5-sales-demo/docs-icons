...
description: >-
  Referência curada para Material Design Icons — 7.638 ícones preenchidos e
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornece 7.638 ícones com variantes preenchidas e contornadas cobrindo virtualmente todos os casos de uso. Use o componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar qualquer ícone pelo nome.
...
Para a lista completa de 7.638 Material Design Icons, visite o [explorador Iconify MDI](https://icon-sets.iconify.design/mdi/).

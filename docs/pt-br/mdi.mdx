...
description: >-
  Referência curada para Ícones Material Design — 7.638 ícones preenchidos e
  contornados disponíveis via o componente Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornece 7.638 ícones com variantes preenchidas e contornadas cobrindo praticamente todos os casos de uso. Use o componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar qualquer ícone pelo nome.

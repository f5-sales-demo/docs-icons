---
title: Ícones Material Design
description: >-
  Referência curada para Ícones Material Design — 7.638 ícones preenchidos e com
  contorno disponíveis através do componente Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornece 7.638 ícones com variantes preenchidas e com contorno, cobrindo praticamente todos os casos de uso. Use o componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar qualquer ícone pelo nome.
...
Para a lista completa de 7.638 Ícones Material Design, visite o [explorador Iconify MDI](https://icon-sets.iconify.design/mdi/).

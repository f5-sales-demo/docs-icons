...
description: >-
  Referência selecionada de Material Design Icons — 7.638 ícones preenchidos e
...
Os ícones são renderizados como SVGs inline usando `currentColor` — adaptam-se automaticamente aos modos claro e escuro.
...
Para a lista completa de 7.638 Material Design Icons, visite o [explorador MDI do Iconify](https://icon-sets.iconify.design/mdi/).

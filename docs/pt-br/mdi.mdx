...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) fornece 7.638 ícones com variantes preenchidas e delineadas, cobrindo praticamente todos os casos de uso. Use o componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar qualquer ícone pelo nome.

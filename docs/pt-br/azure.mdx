---
title: Ícones de Arquitetura do Azure
description: >-
  Referência selecionada para Ícones de Arquitetura do Azure — 606 ícones de
  serviços coloridos para diagramas de infraestrutura em nuvem e documentação.
sidebar:
  label: Azure
  order: 15
i18n:
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) fornece 606 ícones de serviços coloridos para documentar infraestrutura do Azure. Use o componente `Icon` do `@f5xc-salesdemos/icons-azure` para renderizar qualquer ícone pelo nome. O tamanho padrão é 18x18 com preenchimentos em gradiente.
...
Para a lista completa dos 606 Ícones de Arquitetura do Azure, visite a página [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

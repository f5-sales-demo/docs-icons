---
title: Ícones de Arquitetura Azure
description: >-
  Referência selecionada de Ícones de Arquitetura Azure — 606 ícones coloridos
  de serviços para diagramas de infraestrutura em nuvem e documentação.
sidebar:
  label: Azure
  order: 15
i18n:
...
[Ícones de Arquitetura Azure](https://learn.microsoft.com/en-us/azure/architecture/icons/) fornece 606 ícones coloridos de serviços para documentar infraestrutura Azure. Use o componente `Icon` de `@f5-sales-demo/icons-azure` para renderizar qualquer ícone pelo nome. O tamanho padrão é 18x18 com preenchimentos em gradiente.
...
Esses ícones utilizam as cores originais do fornecedor (não `currentColor`). As cores estão incorporadas na marcação SVG e são preservadas tanto no modo claro quanto no modo escuro.
...
Para a lista completa de 606 Ícones de Arquitetura Azure, visite a página [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).

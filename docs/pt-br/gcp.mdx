...
[GCP Architecture Icons](https://cloud.google.com/icons) fornece 216 ícones coloridos de serviços para documentar a infraestrutura do Google Cloud. Utilize o componente `Icon` do pacote `@f5xc-salesdemos/icons-gcp` para renderizar qualquer ícone pelo nome. O tamanho padrão é 24x24 com preenchimentos inline.

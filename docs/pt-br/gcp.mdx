...
description: >-
  Referência selecionada para Ícones de Arquitetura GCP — 216 ícones de serviços
...
[GCP Architecture Icons](https://cloud.google.com/icons) fornece 216 ícones de serviços coloridos para documentar a infraestrutura do Google Cloud. Use o componente `Icon` de `@f5xc-salesdemos/icons-gcp` para renderizar qualquer ícone pelo nome. O tamanho padrão é 24x24 com preenchimentos inline.

...
[GCP Architecture Icons](https://cloud.google.com/icons) fornece 216 ícones coloridos de serviços para documentar infraestrutura do Google Cloud. Use o componente `Icon` de `@f5xc-salesdemos/icons-gcp` para renderizar qualquer ícone pelo nome. O tamanho padrão é 24x24 com preenchimentos inline.
...
Para a lista completa de 216 Ícones de Arquitetura GCP, visite a página [Google Cloud Architecture Icons](https://cloud.google.com/icons).

...
[GCP Architecture Icons](https://cloud.google.com/icons) fornece 216 ícones coloridos de serviços para documentação de infraestrutura Google Cloud. Use o componente `Icon` de `@f5xc-salesdemos/icons-gcp` para renderizar qualquer ícone pelo nome. O tamanho padrão é 24x24 com preenchimentos inline.
...
Esses ícones usam as cores originais do fornecedor (não `currentColor`). As cores são incorporadas na marcação SVG e preservadas nos modos claro e escuro.

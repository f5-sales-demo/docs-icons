---
title: Ícones de Arquitetura GCP
description: >-
  Referência selecionada para Ícones de Arquitetura GCP — 216 ícones coloridos
...
[GCP Architecture Icons](https://cloud.google.com/icons) fornece 216 ícones coloridos de serviços para documentar a infraestrutura do Google Cloud. Utilize o componente `Icon` do pacote `@f5-sales-demo/icons-gcp` para renderizar qualquer ícone pelo nome. O tamanho padrão é 24x24 com preenchimentos inline.
...
Estes ícones utilizam as cores originais do fornecedor (não `currentColor`). As cores estão incorporadas na marcação SVG e são preservadas nos modos claro e escuro.
...
Para a lista completa dos 216 Ícones de Arquitetura GCP, acesse a página [Google Cloud Architecture Icons](https://cloud.google.com/icons).

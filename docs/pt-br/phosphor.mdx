...
description: >-
  ...
  flexíveis disponíveis através do componente Icon.
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) oferece 9.161 ícones com opções de peso flexíveis — regular, bold, duotone, fill, light e thin. Use o componente `Icon` de `@f5xc-salesdemos/icons-phosphor` para renderizar qualquer ícone pelo nome.
...
Os ícones Phosphor vêm em seis pesos. O peso regular usa o nome base (ex.: `globe`). Outros pesos adicionam um sufixo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Os exemplos abaixo mostram o peso regular.
:::

...
description: >-
  ...
  peso flexíveis disponíveis via o componente Icon.
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) oferece 9.161 ícones com opções flexíveis de peso — regular, bold, duotone, fill, light e thin. Use o componente `Icon` de `@f5xc-salesdemos/icons-phosphor` para renderizar qualquer ícone pelo nome.
...
Os ícones Phosphor estão disponíveis em seis pesos. O peso regular utiliza o nome base (ex.: `globe`). Os demais pesos adicionam um sufixo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Os exemplos abaixo exibem o peso regular.
:::
...
Para a lista completa dos 9.161 Phosphor Icons (em todas as variantes de peso), visite o [explorador Iconify Phosphor](https://icon-sets.iconify.design/ph/).

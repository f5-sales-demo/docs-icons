...
description: >-
  Referência selecionada para Phosphor Icons — 9.161 ícones com variantes de
  peso flexíveis disponíveis através do componente Icon.
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) fornece 9.161 ícones com opções flexíveis de peso — regular, bold, duotone, fill, light e thin. Use o componente `Icon` de `@f5-sales-demo/icons-phosphor` para renderizar qualquer ícone pelo nome.
...
Os ícones Phosphor estão disponíveis em seis pesos. O peso regular utiliza o nome base (ex.: `globe`). Os demais pesos adicionam um sufixo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Os exemplos abaixo mostram o peso regular.
:::
...
## Navegar por Todos os Ícones

Para a lista completa dos 9.161 Phosphor Icons (em todas as variantes de peso), visite o [explorador Phosphor no Iconify](https://icon-sets.iconify.design/ph/).

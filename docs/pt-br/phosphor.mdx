...
description: >-
  Referência curada para Phosphor Icons — 9.161 ícones com variantes de peso
...
Os ícones Phosphor estão disponíveis em seis pesos. O peso regular usa o nome base (ex.: `globe`). Os outros pesos adicionam um sufixo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Os exemplos abaixo mostram o peso regular.
:::
...
Para a lista completa de 9.161 Phosphor Icons (em todas as variantes de peso), visite o [explorador Phosphor do Iconify](https://icon-sets.iconify.design/ph/).

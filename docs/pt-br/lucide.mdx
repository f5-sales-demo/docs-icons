...
title: Ícones Lucide
description: >-
  Referência selecionada de ícones Lucide — mais de 1.600 ícones modernos de
  traço disponíveis via o componente Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
O [Lucide](https://lucide.dev/) oferece aproximadamente 1.600 ícones modernos e consistentes de traço. Utilize o componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar qualquer ícone pelo nome.
...
Os ícones são renderizados como SVGs inline utilizando `currentColor` — eles se adaptam automaticamente aos modos claro e escuro.
...
Para a lista completa de aproximadamente 1.600 ícones Lucide, visite [lucide.dev/icons](https://lucide.dev/icons/).

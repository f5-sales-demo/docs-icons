...
description: >-
  ...
  disponíveis via o componente Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) fornece aproximadamente 1.600 ícones modernos e consistentes com traço. Use o componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar qualquer ícone pelo nome.

...
O [Lucide](https://lucide.dev/) fornece aproximadamente 1.600 ícones modernos e consistentes de traço. Utilize o componente `Icon` de `@f5-sales-demo/icons-lucide` para renderizar qualquer ícone pelo nome.

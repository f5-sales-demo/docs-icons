...
O [Lucide](https://lucide.dev/) fornece aproximadamente 1.600 ícones modernos e consistentes de traço. Utilize o componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar qualquer ícone pelo nome.
...
Os ícones são renderizados como SVGs inline usando `currentColor` — eles se adaptam automaticamente ao modo claro e escuro.
...
Para a lista completa de aproximadamente 1.600 ícones Lucide, acesse [lucide.dev/icons](https://lucide.dev/icons/).

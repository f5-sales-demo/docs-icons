...
title: Ícones Carbon
description: >-
  Referência curada para Ícones Carbon — 2.582 ícones de nível empresarial da
  linguagem de design da IBM disponíveis através do componente Icon.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornece 2.582 ícones limpos e com contorno da linguagem de design empresarial da IBM. Use o componente `Icon` de `@f5xc-salesdemos/icons-carbon` para renderizar qualquer ícone pelo nome.
...
Para a lista completa de 2.582 Ícones Carbon, visite o [explorador Carbon do Iconify](https://icon-sets.iconify.design/carbon/).

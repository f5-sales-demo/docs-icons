...
title: Ícones Carbon
description: >-
  Referência selecionada para Ícones Carbon — 2.582 ícones de nível empresarial
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornece 2.582 ícones limpos e delineados da linguagem de design empresarial da IBM. Use o componente `Icon` de `@f5xc-salesdemos/icons-carbon` para renderizar qualquer ícone pelo nome.
...
Para a lista completa com 2.582 Ícones Carbon, visite o [explorador Carbon do Iconify](https://icon-sets.iconify.design/carbon/).

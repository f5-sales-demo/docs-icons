...
title: Carbon Icons
description: >-
  Referência selecionada para Carbon Icons — 2.582 ícones de nível empresarial
  da linguagem de design da IBM disponíveis via o componente Icon.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) fornece 2.582 ícones limpos e delineados da linguagem de design empresarial da IBM. Use o componente `Icon` de `@f5-sales-demo/icons-carbon` para renderizar qualquer ícone pelo nome.
...
Para a lista completa de 2.582 Carbon Icons, visite o [explorador Carbon do Iconify](https://icon-sets.iconify.design/carbon/).

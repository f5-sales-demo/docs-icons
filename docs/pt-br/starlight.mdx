...
Importe o componente e passe o nome de um ícone:
...
| `size` | `string` | `"1em"` | Valor CSS de tamanho aplicado à largura e altura. |
| `color` | `string` | `"currentColor"` | Valor CSS de cor. |
| `class` | `string` | — | Classes CSS adicionais. |

:::tip[Acessibilidade]
Adicione a prop `label` quando um ícone transmite significado (ex.: um ícone de link). Omita `label` para ícones puramente decorativos — o Starlight os ocultará automaticamente das tecnologias assistivas.
:::

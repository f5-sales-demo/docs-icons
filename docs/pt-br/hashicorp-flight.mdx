---
title: Ícones HashiCorp Flight
description: >-
  Referência visual para todos os 672 ícones HashiCorp Flight do pacote
...
Referência visual completa para todos os ícones do pacote [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). Os ícones são renderizados pelo componente `Icon` e organizados por categoria.
...
Os ícones são renderizados como SVGs inline usando `currentColor` — ícones monocromáticos se adaptam automaticamente aos modos claro e escuro. Variantes coloridas preservam suas cores originais.

:::note[Modo Escuro]
Ícones monocromáticos usam `currentColor` e se adaptam automaticamente. Variantes coloridas (ícones com sufixo `-color`) preservam suas cores originais através da classe `no-invert`.
:::

---
title: Ícones de Arquitetura AWS
description: >-
  Referência selecionada de Ícones de Arquitetura AWS — 885 ícones coloridos de
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) fornece 885 ícones coloridos de serviços para documentar infraestrutura AWS. Use o componente `Icon` de `@f5-sales-demo/icons-aws` para renderizar qualquer ícone pelo nome. O tamanho padrão é 48x48 com substituições de tamanho por ícone.
...
Esses ícones utilizam as cores originais do fornecedor (não `currentColor`). As cores estão incorporadas na marcação SVG e preservadas nos modos claro e escuro.
...
Para a lista completa dos 885 Ícones de Arquitetura AWS, visite [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

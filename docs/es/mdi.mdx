...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) proporciona 7.638 iconos con variantes rellenas y de contorno que cubren prácticamente todos los casos de uso. Use el componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar cualquier icono por nombre.

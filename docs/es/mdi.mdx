...
description: >-
  Referencia seleccionada de Material Design Icons — 7.638 iconos rellenos y
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) proporciona 7.638 iconos con variantes rellenas y delineadas que cubren prácticamente todos los casos de uso. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar cualquier icono por nombre.
...
Para la lista completa de 7.638 Material Design Icons, visite el [explorador Iconify MDI](https://icon-sets.iconify.design/mdi/).

...
description: >-
  Referencia curada de Material Design Icons — 7.638 iconos rellenos y con
  contorno disponibles mediante el componente Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) proporciona 7.638 iconos con variantes rellenas y de contorno que cubren prácticamente todos los casos de uso. Use el componente `Icon` de `@f5-sales-demo/icons-mdi` para renderizar cualquier icono por nombre.
...
Para la lista completa de los 7.638 Material Design Icons, visite el [explorador de Iconify MDI](https://icon-sets.iconify.design/mdi/).

---
title: Íconos de Material Design
description: >-
  Referencia curada de Material Design Icons — 7.638 íconos rellenos y con
  contorno disponibles a través del componente Icon.
sidebar:
...
[Material Design Icons](https://icon-sets.iconify.design/mdi/) proporciona 7.638 íconos con variantes rellenas y con contorno que cubren prácticamente cualquier caso de uso. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-mdi` para renderizar cualquier ícono por nombre.
...
Para la lista completa de 7.638 íconos de Material Design, visite el [explorador MDI de Iconify](https://icon-sets.iconify.design/mdi/).

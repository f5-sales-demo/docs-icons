...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) proporciona 885 iconos de servicios en color para documentar infraestructura AWS. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-aws` para renderizar cualquier icono por nombre. El tamaño predeterminado es 48x48 con opciones de tamaño por icono.

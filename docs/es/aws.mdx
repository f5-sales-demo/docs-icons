...
description: >-
  Referencia curada de los Iconos de Arquitectura de AWS — 885 iconos de
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) proporciona 885 iconos de servicios a color para documentar infraestructura de AWS. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-aws` para renderizar cualquier icono por nombre. El tamaño predeterminado es 48x48 con sobrecargas de tamaño por icono.
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están incrustados en el marcado SVG y se conservan tanto en el modo claro como en el modo oscuro.

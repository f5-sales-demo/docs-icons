---
title: Iconos de Arquitectura AWS
description: >-
  Referencia organizada de Iconos de Arquitectura AWS — 885 iconos de servicios
  en color para diagramas de infraestructura en la nube y documentación.
sidebar:
  label: AWS
  order: 14
i18n:
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) proporciona 885 iconos de servicios en color para documentar infraestructura AWS. Utilice el componente `Icon` de `@f5-sales-demo/icons-aws` para renderizar cualquier icono por nombre. El tamaño predeterminado es 48x48 con opciones de tamaño por icono.
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están integrados en el marcado SVG y se conservan tanto en el modo claro como en el oscuro.
...
Para la lista completa de los 885 Iconos de Arquitectura AWS, visite [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

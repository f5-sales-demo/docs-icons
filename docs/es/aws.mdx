...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) proporciona 885 iconos de servicios a color para documentar infraestructura de AWS. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-aws` para renderizar cualquier icono por nombre. El tamaño predeterminado es 48x48 con anulaciones de tamaño por icono.
...
Para obtener la lista completa de los 885 Iconos de Arquitectura de AWS, visite [AWS Icons for Architecture Diagrams](https://aws.amazon.com/architecture/icons/).

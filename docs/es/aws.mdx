---
title: Iconos de Arquitectura de AWS
description: >-
  Referencia curada para los Iconos de Arquitectura de AWS — 885 iconos de
...
[AWS Architecture Icons](https://aws.amazon.com/architecture/icons/) proporciona 885 iconos de servicios a color para documentar infraestructura de AWS. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-aws` para renderizar cualquier icono por nombre. El tamaño predeterminado es 48x48 con posibilidad de sobrescribir el tamaño por icono.
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están integrados en el marcado SVG y se preservan tanto en modo claro como oscuro.
...
Para la lista completa de 885 Iconos de Arquitectura de AWS, visite [Iconos de AWS para diagramas de arquitectura](https://aws.amazon.com/architecture/icons/).

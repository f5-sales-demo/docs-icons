...
description: >-
  Referencia curada para Phosphor Icons — 9.161 iconos con variantes de peso
...
Los iconos de Phosphor vienen en seis pesos. El peso regular utiliza el nombre base (por ejemplo, `globe`). Los otros pesos añaden un sufijo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Los ejemplos a continuación muestran el peso regular.
:::
...
Para la lista completa de 9.161 iconos de Phosphor (en todas las variantes de peso), visite el [explorador Phosphor de Iconify](https://icon-sets.iconify.design/ph/).

...
description: >-
  Referencia curada de Phosphor Icons — 9.161 iconos con variantes de peso
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) proporciona 9.161 iconos con opciones de peso flexibles — regular, bold, duotone, fill, light y thin. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-phosphor` para renderizar cualquier icono por nombre.
...
Los iconos Phosphor vienen en seis pesos. El peso regular usa el nombre base (por ejemplo, `globe`). Los otros pesos añaden un sufijo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Los ejemplos a continuación muestran el peso regular.
:::
...
Para la lista completa de 9.161 iconos Phosphor (en todas las variantes de peso), visite el [explorador Phosphor de Iconify](https://icon-sets.iconify.design/ph/).

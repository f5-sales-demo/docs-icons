---
title: Iconos Phosphor
description: >-
  Referencia curada para Iconos Phosphor — 9.161 iconos con variantes de grosor
  flexibles disponibles a través del componente Icon.
sidebar:
  label: Phosphor
  order: 8
i18n:
...
[Iconos Phosphor](https://icon-sets.iconify.design/ph/) proporciona 9.161 iconos con opciones de grosor flexibles — regular, negrita, duotono, relleno, ligero y fino. Use el componente `Icon` de `@f5xc-salesdemos/icons-phosphor` para renderizar cualquier icono por nombre.
...
:::note[Variantes de grosor]
Los iconos Phosphor vienen en seis grosores. El grosor regular usa el nombre base (p. ej. `globe`). Los demás grosores añaden un sufijo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Los ejemplos a continuación muestran el grosor regular.
:::
...
Para la lista completa de 9.161 Iconos Phosphor (en todas las variantes de grosor), visite el [explorador Iconify Phosphor](https://icon-sets.iconify.design/ph/).

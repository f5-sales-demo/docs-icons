---
title: Íconos Phosphor
description: >-
  Referencia curada de Phosphor Icons — 9,161 íconos con variantes de peso
...
[Phosphor Icons](https://icon-sets.iconify.design/ph/) proporciona 9,161 íconos con opciones de peso flexibles — regular, bold, duotone, fill, light y thin. Use el componente `Icon` de `@f5xc-salesdemos/icons-phosphor` para renderizar cualquier ícono por nombre.
...
Los íconos se renderizan como SVGs en línea usando `currentColor` — se adaptan automáticamente al modo claro y oscuro.

:::note[Variantes de peso]
Los íconos Phosphor vienen en seis pesos. El peso regular usa el nombre base (p. ej. `globe`). Los otros pesos añaden un sufijo: `globe-bold`, `globe-duotone`, `globe-fill`, `globe-light`, `globe-thin`. Los ejemplos a continuación muestran el peso regular.
:::
...
Para la lista completa de 9,161 íconos Phosphor (en todas las variantes de peso), visite el [explorador Phosphor de Iconify](https://icon-sets.iconify.design/ph/).

...
title: Simple Icons
description: >-
  Más de 3.200 iconos de marcas para empresas populares, servicios y tecnologías
...
Simple Icons proporciona más de 3.200 iconos SVG gratuitos para marcas populares, incluyendo proveedores de redes, proveedores de nube, empresas de telecomunicaciones y servicios tecnológicos. Todos los iconos utilizan un viewBox estándar de 24x24.
...
Explorar los más de 3.200 iconos: [Sitio web de Simple Icons](https://simpleicons.org/) | [Explorador de Iconify](https://icon-sets.iconify.design/simple-icons/)

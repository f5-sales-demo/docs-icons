...
[Lucide](https://lucide.dev/) proporciona ~1.600 iconos de trazo modernos y consistentes. Utilice el componente `Icon` de `@f5-sales-demo/icons-lucide` para renderizar cualquier icono por nombre.

...
title: Iconos Lucide
description: >-
  Referencia seleccionada de iconos Lucide — más de 1.600 iconos de trazo
...
[Lucide](https://lucide.dev/) proporciona ~1.600 iconos de trazo modernos y consistentes. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar cualquier icono por nombre.
...
Para ver la lista completa de ~1.600 iconos de Lucide, visite [lucide.dev/icons](https://lucide.dev/icons/).

...
title: Iconos Lucide
description: >-
  Referencia curada de iconos Lucide — más de 1600 iconos modernos de trazo
  disponibles a través del componente Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) proporciona ~1600 iconos modernos y consistentes de trazo. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar cualquier icono por nombre.
...
Para la lista completa de ~1600 iconos de Lucide, visite [lucide.dev/icons](https://lucide.dev/icons/).

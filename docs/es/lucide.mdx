...
title: Íconos Lucide
description: >-
  Referencia seleccionada de íconos Lucide — más de 1,600 íconos de trazo
  modernos disponibles mediante el componente Icon.
sidebar:
  label: Lucide
  order: 5
i18n:
...
[Lucide](https://lucide.dev/) proporciona ~1,600 íconos de trazo modernos y consistentes. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar cualquier ícono por nombre.
...
Los íconos se renderizan como SVG en línea usando `currentColor` — se adaptan automáticamente al modo claro y oscuro.
...
## Explorar todos los íconos

Para la lista completa de ~1,600 íconos Lucide, visite [lucide.dev/icons](https://lucide.dev/icons/).

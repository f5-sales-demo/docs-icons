...
title: Iconos Lucide
description: >-
  Referencia curada de iconos Lucide — más de 1.600 iconos modernos de trazo
...
[Lucide](https://lucide.dev/) proporciona ~1.600 iconos modernos y consistentes de trazo. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-lucide` para renderizar cualquier icono por nombre.
...
Para la lista completa de ~1.600 iconos de Lucide, visite [lucide.dev/icons](https://lucide.dev/icons/).

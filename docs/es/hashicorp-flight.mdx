...
description: >-
  Referencia visual de los 672 iconos HashiCorp Flight de
...
Referencia visual completa de cada icono del paquete [`@f5-sales-demo/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5-sales-demo/icons-hashicorp-flight). Los iconos se renderizan mediante el componente `Icon` y están organizados por categoría.
...
Los iconos se renderizan como SVGs en línea usando `currentColor` — los iconos monocromáticos se adaptan automáticamente al modo claro y oscuro. Las variantes de color conservan sus colores originales.

:::note[Modo oscuro]
Los iconos monocromáticos usan `currentColor` y se adaptan automáticamente. Las variantes de color (iconos que terminan en `-color`) conservan sus colores originales mediante la clase `no-invert`.
:::
...
## Iconos de interfaz de usuario (428)

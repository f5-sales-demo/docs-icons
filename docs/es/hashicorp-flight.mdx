...
Referencia visual completa de cada icono en el paquete [`@f5xc-salesdemos/icons-hashicorp-flight`](https://www.npmjs.com/package/@f5xc-salesdemos/icons-hashicorp-flight). Los iconos se renderizan mediante el componente `Icon` y están organizados por categoría.
...
Los iconos se renderizan como SVGs en línea usando `currentColor` — los iconos monocromáticos se adaptan automáticamente al modo claro y oscuro. Las variantes a color preservan sus colores originales.

:::note[Modo oscuro]
Los iconos monocromáticos usan `currentColor` y se adaptan automáticamente. Las variantes a color (iconos que terminan en `-color`) preservan sus colores originales mediante la clase `no-invert`.
:::

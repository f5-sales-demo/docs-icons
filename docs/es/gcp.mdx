---
title: Iconos de Arquitectura GCP
description: >-
  Referencia curada de los Iconos de Arquitectura GCP — 216 iconos de servicios
  a color para diagramas de infraestructura en la nube y documentación.
sidebar:
  label: GCP
  order: 16
i18n:
...
Para la lista completa de 216 Iconos de Arquitectura GCP, visite la página de [Google Cloud Architecture Icons](https://cloud.google.com/icons).

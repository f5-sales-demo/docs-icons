---
title: Iconos de arquitectura de GCP
description: >-
  Referencia seleccionada de iconos de arquitectura de GCP — 216 iconos de
...
import Icon from '@f5-sales-demo/icons-gcp/Icon.astro';

[GCP Architecture Icons](https://cloud.google.com/icons) proporciona 216 iconos de servicios en color para documentar la infraestructura de Google Cloud. Utilice el componente `Icon` de `@f5-sales-demo/icons-gcp` para renderizar cualquier icono por nombre. El tamaño predeterminado es 24x24 con rellenos en línea.
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están integrados en el marcado SVG y se conservan tanto en el modo claro como en el modo oscuro.
...
Para la lista completa de los 216 iconos de arquitectura de GCP, visite la página de [Google Cloud Architecture Icons](https://cloud.google.com/icons).

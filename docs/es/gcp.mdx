...
description: >-
  Referencia seleccionada de iconos de arquitectura GCP — 216 iconos de
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están incorporados en el marcado SVG y se preservan tanto en el modo claro como en el oscuro.
...
Para la lista completa de 216 iconos de arquitectura GCP, visite la página [Google Cloud Architecture Icons](https://cloud.google.com/icons).

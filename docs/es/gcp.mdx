...
description: >-
  Referencia curada de los Iconos de Arquitectura de GCP — 216 iconos de
...
[GCP Architecture Icons](https://cloud.google.com/icons) proporciona 216 iconos de servicios a color para documentar infraestructura de Google Cloud. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-gcp` para renderizar cualquier icono por nombre. El tamaño predeterminado es 24x24 con rellenos en línea.
...
Para consultar la lista completa de los 216 Iconos de Arquitectura de GCP, visite la página de [Google Cloud Architecture Icons](https://cloud.google.com/icons).

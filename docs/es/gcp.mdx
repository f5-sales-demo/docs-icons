...
[GCP Architecture Icons](https://cloud.google.com/icons) proporciona 216 iconos de servicios en color para documentar la infraestructura de Google Cloud. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-gcp` para renderizar cualquier icono por nombre. El tamaño predeterminado es 24x24 con rellenos en línea.

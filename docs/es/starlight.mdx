---
title: Iconos incorporados de Starlight
description: >-
  Referencia completa de los más de 200 iconos incorporados de Starlight
  disponibles a través del componente Icon.
sidebar:
  label: Incorporados de Starlight
  order: 3
i18n:
...
Starlight incluye más de 200 iconos incorporados disponibles a través del componente `<Icon>` — sin necesidad de instalación. El plugin `starlight-plugin-icons` ya está configurado en el tema, por lo que estos iconos funcionan en cualquier repositorio de contenido.

## Uso del componente Icon

Importe el componente y pase un nombre de icono:
...
|------|------|---------|-------------|
| `name` | `string` | — | **Requerido.** El nombre del icono de las tablas a continuación. |
| `label` | `string` | — | Etiqueta accesible para lectores de pantalla. Úsela para iconos con significado; omítala para los decorativos. |
| `size` | `string` | `"1em"` | Valor de tamaño CSS aplicado al ancho y alto. |
| `color` | `string` | `"currentColor"` | Valor de color CSS. |
| `class` | `string` | — | Clases CSS adicionales. |

:::tip[Accesibilidad]
Agregue una prop `label` cuando un icono transmita significado (por ejemplo, un icono de enlace). Omita `label` para iconos puramente decorativos — Starlight los ocultará automáticamente de la tecnología asistiva.
:::
...
## Iconos sociales y de comunidad
...
## Iconos de tecnología y frameworks
...
## Iconos de archivos Seti

Los iconos Seti usan el prefijo `seti:` y están diseñados para la representación de tipos de archivo. Funcionan en el componente `<Icon>` y en el componente `<FileTree>`.

...
title: Tabler Icons
description: >-
  Referencia curada para Tabler Icons — 6,034 iconos de línea nítidos con un
  ancho de trazo consistente disponibles a través del componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) proporciona 6,034 iconos de línea nítidos con un ancho de trazo consistente de 2px. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-tabler` para renderizar cualquier icono por nombre.

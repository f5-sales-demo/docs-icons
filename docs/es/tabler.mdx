...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) proporciona 6,034 iconos de línea nítidos con un grosor de trazo uniforme de 2px. Use el componente `Icon` de `@f5xc-salesdemos/icons-tabler` para renderizar cualquier icono por nombre.

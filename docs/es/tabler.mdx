...
title: Tabler Icons
description: >-
  Referencia seleccionada de Tabler Icons — 6,034 iconos de línea nítidos con
  grosor de trazo uniforme disponibles mediante el componente Icon.
sidebar:
  label: Tabler
  order: 9
i18n:
...
[Tabler Icons](https://icon-sets.iconify.design/tabler/) proporciona 6,034 iconos de línea nítidos con un grosor de trazo uniforme de 2px. Use el componente `Icon` de `@f5-sales-demo/icons-tabler` para renderizar cualquier icono por nombre.
...
Para la lista completa de 6,034 Tabler Icons, visite el [explorador de Tabler en Iconify](https://icon-sets.iconify.design/tabler/).

...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) proporciona 2.582 iconos limpios y con contorno del lenguaje de diseño empresarial de IBM. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-carbon` para renderizar cualquier icono por nombre.

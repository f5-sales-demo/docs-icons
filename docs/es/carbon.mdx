...
title: Iconos Carbon
description: >-
  Referencia seleccionada de Iconos Carbon — 2.582 iconos de nivel empresarial
  del lenguaje de diseño de IBM disponibles mediante el componente Icon.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) ofrece 2.582 iconos limpios y delineados del lenguaje de diseño empresarial de IBM. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-carbon` para renderizar cualquier icono por nombre.
...
Para obtener la lista completa de los 2.582 Iconos Carbon, visite el [explorador Iconify Carbon](https://icon-sets.iconify.design/carbon/).

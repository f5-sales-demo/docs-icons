...
title: Iconos Carbon
description: >-
  Referencia curada de los Iconos Carbon — 2.582 iconos de nivel empresarial del
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) proporciona 2.582 iconos limpios y delineados del lenguaje de diseño empresarial de IBM. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-carbon` para renderizar cualquier icono por nombre.
...
Para la lista completa de 2.582 Iconos Carbon, visite el [explorador Carbon de Iconify](https://icon-sets.iconify.design/carbon/).

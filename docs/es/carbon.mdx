...
title: Carbon Icons
description: >-
  Referencia curada de Carbon Icons — 2.582 iconos de nivel empresarial del
  lenguaje de diseño de IBM disponibles a través del componente Icon.
sidebar:
  label: Carbon
  order: 7
i18n:
...
[Carbon Icons](https://icon-sets.iconify.design/carbon/) proporciona 2.582 iconos limpios y delineados del lenguaje de diseño empresarial de IBM. Utilice el componente `Icon` de `@f5-sales-demo/icons-carbon` para renderizar cualquier icono por nombre.
...
Para la lista completa de 2.582 Carbon Icons, visite el [explorador de Iconify Carbon](https://icon-sets.iconify.design/carbon/).

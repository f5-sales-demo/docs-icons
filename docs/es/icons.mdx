...
El tema de documentación proporciona acceso a miles de iconos de múltiples paquetes. Todos los paquetes utilizan el mismo patrón: importe el componente `Icon.astro` del paquete y haga referencia a los iconos por nombre.

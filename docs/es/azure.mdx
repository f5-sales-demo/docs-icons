...
description: >-
  ...
  servicios a color para diagramas de infraestructura en la nube y
  documentación.
sidebar:
  label: Azure
  order: 15
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) proporciona 606 iconos de servicios a color para documentar infraestructura de Azure. Utilice el componente `Icon` de `@f5xc-salesdemos/icons-azure` para renderizar cualquier icono por nombre. El tamaño predeterminado es 18x18 con rellenos de degradado.
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están incrustados en el marcado SVG y se preservan tanto en modo claro como oscuro.

---
title: Iconos de arquitectura de Azure
description: >-
  Referencia seleccionada de iconos de arquitectura de Azure — 606 iconos de
  servicios en color para diagramas de infraestructura en la nube y
  documentación.
sidebar:
  label: Azure
  order: 15
...
[Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/) proporciona 606 iconos de servicios en color para documentar infraestructura de Azure. Use el componente `Icon` de `@f5-sales-demo/icons-azure` para renderizar cualquier icono por nombre. El tamaño predeterminado es 18x18 con rellenos de gradiente.
...
Estos iconos utilizan los colores originales del proveedor (no `currentColor`). Los colores están integrados en el marcado SVG y se conservan tanto en modo claro como en modo oscuro.
...
Para obtener la lista completa de los 606 iconos de arquitectura de Azure, visite la página de [Microsoft Azure Architecture Icons](https://learn.microsoft.com/en-us/azure/architecture/icons/).
